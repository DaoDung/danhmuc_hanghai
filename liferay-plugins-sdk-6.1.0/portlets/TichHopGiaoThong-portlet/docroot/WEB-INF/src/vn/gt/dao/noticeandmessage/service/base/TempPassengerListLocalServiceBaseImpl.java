...
/**
 * The base implementation of the temp passenger list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPassengerListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempPassengerListLocalServiceBaseImpl
	implements TempPassengerListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempPassengerList addTempPassengerList(
		...
		tempPassengerList = tempPassengerListPersistence.update(tempPassengerList,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempPassengerList);
			}
	...
	public TempPassengerList createTempPassengerList(long id) {
		return tempPassengerListPersistence.create(id);
	}
	...
	public void deleteTempPassengerList(long id)
		...
		TempPassengerList tempPassengerList = tempPassengerListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempPassengerList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempPassengerList(TempPassengerList tempPassengerList)
		...
		tempPassengerListPersistence.remove(tempPassengerList);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPassengerListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPassengerListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempPassengerList fetchTempPassengerList(long id)
		throws SystemException {
		return tempPassengerListPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempPassengerList getTempPassengerList(long id)
		throws PortalException, SystemException {
		return tempPassengerListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempPassengerListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempPassengerList> getTempPassengerLists(int start, int end)
		throws SystemException {
		return tempPassengerListPersistence.findAll(start, end);
	}
	...
	public int getTempPassengerListsCount() throws SystemException {
		return tempPassengerListPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempPassengerList",
			tempPassengerListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempPassengerList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempPassengerListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempPassengerListLocalServiceBaseImpl.class);
