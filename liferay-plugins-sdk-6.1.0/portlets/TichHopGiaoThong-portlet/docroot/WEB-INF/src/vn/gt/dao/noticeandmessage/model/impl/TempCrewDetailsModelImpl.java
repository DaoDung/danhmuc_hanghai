...
public class TempCrewDetailsModelImpl extends BaseModelImpl<TempCrewDetails>
	...
	public static long GIVENNAME_COLUMN_BITMASK = 2L;
	public static long PASSPORTNUMBER_COLUMN_BITMASK = 4L;
	...
	public void setGivenName(String givenName) {
		_columnBitmask |= GIVENNAME_COLUMN_BITMASK;

		if (_originalGivenName == null) {
			_originalGivenName = _givenName;
		}
	...
	public String getOriginalGivenName() {
		return GetterUtil.getString(_originalGivenName);
	}
	...
	public void setPassportNumber(String passportNumber) {
		_columnBitmask |= PASSPORTNUMBER_COLUMN_BITMASK;

		if (_originalPassportNumber == null) {
			_originalPassportNumber = _passportNumber;
		}

		_passportNumber = passportNumber;
	}

	public String getOriginalPassportNumber() {
		return GetterUtil.getString(_originalPassportNumber);
	}
	...
	public void resetOriginalValues() {
		...
		tempCrewDetailsModelImpl._originalGivenName = tempCrewDetailsModelImpl._givenName;

		tempCrewDetailsModelImpl._originalPassportNumber = tempCrewDetailsModelImpl._passportNumber;
	...
	private String _originalGivenName;
