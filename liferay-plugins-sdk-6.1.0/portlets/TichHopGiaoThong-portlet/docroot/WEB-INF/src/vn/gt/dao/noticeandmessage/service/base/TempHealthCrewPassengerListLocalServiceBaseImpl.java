...
/**
 * The base implementation of the temp health crew passenger list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempHealthCrewPassengerListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempHealthCrewPassengerListLocalServiceBaseImpl
	implements TempHealthCrewPassengerListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public TempHealthCrewPassengerList addTempHealthCrewPassengerList(
		TempHealthCrewPassengerList tempHealthCrewPassengerList)
		throws SystemException {
		tempHealthCrewPassengerList.setNew(true);

		tempHealthCrewPassengerList = tempHealthCrewPassengerListPersistence.update(tempHealthCrewPassengerList,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempHealthCrewPassengerList);
			}
	 ...
	 */
	public TempHealthCrewPassengerList createTempHealthCrewPassengerList(
		long id) {
		return tempHealthCrewPassengerListPersistence.create(id);
	}
	...
	public void deleteTempHealthCrewPassengerList(long id)
		...
		TempHealthCrewPassengerList tempHealthCrewPassengerList = tempHealthCrewPassengerListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempHealthCrewPassengerList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempHealthCrewPassengerList(
		TempHealthCrewPassengerList tempHealthCrewPassengerList)
		throws SystemException {
		tempHealthCrewPassengerListPersistence.remove(tempHealthCrewPassengerList);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempHealthCrewPassengerListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempHealthCrewPassengerListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempHealthCrewPassengerList fetchTempHealthCrewPassengerList(long id)
		throws SystemException {
		return tempHealthCrewPassengerListPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempHealthCrewPassengerList getTempHealthCrewPassengerList(long id)
		throws PortalException, SystemException {
		return tempHealthCrewPassengerListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempHealthCrewPassengerListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempHealthCrewPassengerList> getTempHealthCrewPassengerLists(
		...
		return tempHealthCrewPassengerListPersistence.findAll(start, end);
	}
	...
	public int getTempHealthCrewPassengerListsCount() throws SystemException {
		return tempHealthCrewPassengerListPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempHealthCrewPassengerList updateTempHealthCrewPassengerList(
		TempHealthCrewPassengerList tempHealthCrewPassengerList)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempHealthCrewPassengerList",
			tempHealthCrewPassengerListLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempHealthCrewPassengerListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempHealthCrewPassengerListLocalServiceBaseImpl.class);
