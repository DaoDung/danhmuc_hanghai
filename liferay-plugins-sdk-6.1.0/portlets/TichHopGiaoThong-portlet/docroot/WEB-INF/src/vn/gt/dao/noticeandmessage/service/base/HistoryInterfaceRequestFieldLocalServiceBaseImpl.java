...
/**
 * The base implementation of the history interface request field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.HistoryInterfaceRequestFieldLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.HistoryInterfaceRequestFieldLocalServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.HistoryInterfaceRequestFieldLocalServiceUtil
 * @generated
 */
public abstract class HistoryInterfaceRequestFieldLocalServiceBaseImpl
	implements HistoryInterfaceRequestFieldLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.HistoryInterfaceRequestFieldLocalServiceUtil} to access the history interface request field local service.
	 */
	 ...
	 */
	public HistoryInterfaceRequestField addHistoryInterfaceRequestField(
		HistoryInterfaceRequestField historyInterfaceRequestField)
		throws SystemException {
		historyInterfaceRequestField.setNew(true);

		historyInterfaceRequestField = historyInterfaceRequestFieldPersistence.update(historyInterfaceRequestField,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(historyInterfaceRequestField);
			}
	 ...
	 */
	public HistoryInterfaceRequestField createHistoryInterfaceRequestField(
		long id) {
		return historyInterfaceRequestFieldPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHistoryInterfaceRequestField(long id)
		throws PortalException, SystemException {
		HistoryInterfaceRequestField historyInterfaceRequestField = historyInterfaceRequestFieldPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(historyInterfaceRequestField);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHistoryInterfaceRequestField(
		HistoryInterfaceRequestField historyInterfaceRequestField)
		throws SystemException {
		historyInterfaceRequestFieldPersistence.remove(historyInterfaceRequestField);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyInterfaceRequestFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyInterfaceRequestFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public HistoryInterfaceRequestField fetchHistoryInterfaceRequestField(
		long id) throws SystemException {
		return historyInterfaceRequestFieldPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryInterfaceRequestField getHistoryInterfaceRequestField(long id)
		throws PortalException, SystemException {
		return historyInterfaceRequestFieldPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return historyInterfaceRequestFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HistoryInterfaceRequestField> getHistoryInterfaceRequestFields(
		int start, int end) throws SystemException {
		return historyInterfaceRequestFieldPersistence.findAll(start, end);
	}
	...
	public int getHistoryInterfaceRequestFieldsCount()
		throws SystemException {
		return historyInterfaceRequestFieldPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryInterfaceRequestField updateHistoryInterfaceRequestField(
		HistoryInterfaceRequestField historyInterfaceRequestField)
		throws SystemException {
		return updateHistoryInterfaceRequestField(historyInterfaceRequestField,
			true);
	}
	 ...
	 *
	 * @param historyInterfaceRequestField the history interface request field
	 * @param merge whether to merge the history interface request field with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the history interface request field that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryInterfaceRequestField updateHistoryInterfaceRequestField(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.HistoryInterfaceRequestField",
			historyInterfaceRequestFieldLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = historyInterfaceRequestFieldPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HistoryInterfaceRequestFieldLocalServiceBaseImpl.class);
