...
/**
 * The base implementation of the issue port clearance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssuePortClearanceLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssuePortClearanceLocalServiceBaseImpl
	implements IssuePortClearanceLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssuePortClearanceLocalServiceUtil} to access the issue port clearance local service.
	 */
	 ...
	 */
	public IssuePortClearance addIssuePortClearance(
		IssuePortClearance issuePortClearance) throws SystemException {
		issuePortClearance.setNew(true);

		issuePortClearance = issuePortClearancePersistence.update(issuePortClearance,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issuePortClearance);
			}
	...
	public IssuePortClearance createIssuePortClearance(long id) {
		return issuePortClearancePersistence.create(id);
	}
	...
	public void deleteIssuePortClearance(long id)
		...
		IssuePortClearance issuePortClearance = issuePortClearancePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issuePortClearance);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteIssuePortClearance(IssuePortClearance issuePortClearance)
		throws SystemException {
		issuePortClearancePersistence.remove(issuePortClearance);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issuePortClearancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issuePortClearancePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssuePortClearance fetchIssuePortClearance(long id)
		throws SystemException {
		return issuePortClearancePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssuePortClearance getIssuePortClearance(long id)
		throws PortalException, SystemException {
		return issuePortClearancePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issuePortClearancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssuePortClearance> getIssuePortClearances(int start, int end)
		throws SystemException {
		return issuePortClearancePersistence.findAll(start, end);
	}
	...
	public int getIssuePortClearancesCount() throws SystemException {
		return issuePortClearancePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssuePortClearance updateIssuePortClearance(
		IssuePortClearance issuePortClearance) throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssuePortClearance",
			issuePortClearanceLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssuePortClearance");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issuePortClearancePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssuePortClearanceLocalServiceBaseImpl.class);
