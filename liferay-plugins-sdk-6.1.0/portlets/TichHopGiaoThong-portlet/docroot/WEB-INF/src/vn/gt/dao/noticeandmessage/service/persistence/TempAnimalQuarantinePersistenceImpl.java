...
import vn.gt.dao.noticeandmessage.NoSuchTempAnimalQuarantineException;
...
import vn.gt.dao.noticeandmessage.model.impl.TempAnimalQuarantineModelImpl;
...
public class TempAnimalQuarantinePersistenceImpl extends BasePersistenceImpl<TempAnimalQuarantine>
	...
	protected TempAnimalQuarantine removeImpl(
		...
		try {
			...
			BatchSessionUtil.delete(session, tempAnimalQuarantine);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public TempAnimalQuarantine updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, tempAnimalQuarantine, merge);
		...
		if (isNew || !TempAnimalQuarantineModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((tempAnimalQuarantineModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempAnimalQuarantineModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getOriginalDocumentYear())
					};
				...
				args = new Object[] {
						Long.valueOf(tempAnimalQuarantineModelImpl.getDocumentName()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getDocumentYear())
					};
			...
			if ((tempAnimalQuarantineModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempAnimalQuarantineModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getOriginalDocumentYear()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getOriginalRequestState())
					};
				...
				args = new Object[] {
						Long.valueOf(tempAnimalQuarantineModelImpl.getDocumentName()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getDocumentYear()),
						Integer.valueOf(tempAnimalQuarantineModelImpl.getRequestState())
					};
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a temp animal quarantine with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public TempAnimalQuarantine fetchByPrimaryKey(long id)
		...
		TempAnimalQuarantine tempAnimalQuarantine = (TempAnimalQuarantine)EntityCacheUtil.getResult(TempAnimalQuarantineModelImpl.ENTITY_CACHE_ENABLED,
				TempAnimalQuarantineImpl.class, id);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.gt.dao.noticeandmessage.model.TempAnimalQuarantine")));
