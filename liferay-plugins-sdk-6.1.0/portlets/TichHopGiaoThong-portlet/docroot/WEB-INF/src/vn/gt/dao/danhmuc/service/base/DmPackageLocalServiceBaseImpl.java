...
/**
 * The base implementation of the dm package local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPackageLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPackageLocalServiceBaseImpl
	implements DmPackageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmPackage addDmPackage(DmPackage dmPackage)
		...
		dmPackage = dmPackagePersistence.update(dmPackage, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPackage);
			}
	...
	public DmPackage createDmPackage(int id) {
		return dmPackagePersistence.create(id);
	}
	...
	public void deleteDmPackage(int id) throws PortalException, SystemException {
		DmPackage dmPackage = dmPackagePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPackage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPackagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmPackagePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPackagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPackage fetchDmPackage(int id) throws SystemException {
		return dmPackagePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPackage getDmPackage(int id)
		...
		return dmPackagePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPackagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmPackage> getDmPackages(int start, int end)
		throws SystemException {
		return dmPackagePersistence.findAll(start, end);
	}
	...
	public int getDmPackagesCount() throws SystemException {
		return dmPackagePersistence.countAll();
	}
	...
	public DmPackage updateDmPackage(DmPackage dmPackage, boolean merge)
		...
		dmPackage = dmPackagePersistence.update(dmPackage, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPackage",
			dmPackageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPackage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPackagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPackageLocalServiceBaseImpl.class);
