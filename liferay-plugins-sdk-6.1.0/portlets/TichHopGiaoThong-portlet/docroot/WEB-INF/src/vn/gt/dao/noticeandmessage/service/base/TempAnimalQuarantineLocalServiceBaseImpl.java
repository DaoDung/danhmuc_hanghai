...
/**
 * The base implementation of the temp animal quarantine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempAnimalQuarantineLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempAnimalQuarantineLocalServiceBaseImpl
	implements TempAnimalQuarantineLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempAnimalQuarantineLocalServiceUtil} to access the temp animal quarantine local service.
	 */
	 ...
	 */
	public TempAnimalQuarantine addTempAnimalQuarantine(
		TempAnimalQuarantine tempAnimalQuarantine) throws SystemException {
		tempAnimalQuarantine.setNew(true);

		tempAnimalQuarantine = tempAnimalQuarantinePersistence.update(tempAnimalQuarantine,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempAnimalQuarantine);
			}
	...
	public TempAnimalQuarantine createTempAnimalQuarantine(long id) {
		return tempAnimalQuarantinePersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempAnimalQuarantine(long id)
		throws PortalException, SystemException {
		TempAnimalQuarantine tempAnimalQuarantine = tempAnimalQuarantinePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempAnimalQuarantine);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempAnimalQuarantine(
		TempAnimalQuarantine tempAnimalQuarantine) throws SystemException {
		tempAnimalQuarantinePersistence.remove(tempAnimalQuarantine);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempAnimalQuarantinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempAnimalQuarantinePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempAnimalQuarantine fetchTempAnimalQuarantine(long id)
		throws SystemException {
		return tempAnimalQuarantinePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempAnimalQuarantine getTempAnimalQuarantine(long id)
		throws PortalException, SystemException {
		return tempAnimalQuarantinePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempAnimalQuarantinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempAnimalQuarantine> getTempAnimalQuarantines(int start,
		int end) throws SystemException {
		return tempAnimalQuarantinePersistence.findAll(start, end);
	}
	...
	public int getTempAnimalQuarantinesCount() throws SystemException {
		return tempAnimalQuarantinePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempAnimalQuarantine updateTempAnimalQuarantine(
		TempAnimalQuarantine tempAnimalQuarantine) throws SystemException {
	 ...
	 *
	 * @param tempAnimalQuarantine the temp animal quarantine
	 * @param merge whether to merge the temp animal quarantine with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the temp animal quarantine that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public TempAnimalQuarantine updateTempAnimalQuarantine(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempAnimalQuarantine",
			tempAnimalQuarantineLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempAnimalQuarantine");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempAnimalQuarantinePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempAnimalQuarantineLocalServiceBaseImpl.class);
