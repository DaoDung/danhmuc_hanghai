...
/**
 * The base implementation of the temp unit general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempUnitGeneralLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempUnitGeneralLocalServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempUnitGeneralLocalServiceUtil
 * @generated
 */
public abstract class TempUnitGeneralLocalServiceBaseImpl
	implements TempUnitGeneralLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempUnitGeneralLocalServiceUtil} to access the temp unit general local service.
	 */
	 ...
	 */
	public TempUnitGeneral addTempUnitGeneral(TempUnitGeneral tempUnitGeneral)
		throws SystemException {
		tempUnitGeneral.setNew(true);

		tempUnitGeneral = tempUnitGeneralPersistence.update(tempUnitGeneral,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempUnitGeneral);
			}
	 ...
	 */
	public TempUnitGeneral createTempUnitGeneral(long id) {
		return tempUnitGeneralPersistence.create(id);
	}
	...
	public void deleteTempUnitGeneral(long id)
		...
		TempUnitGeneral tempUnitGeneral = tempUnitGeneralPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempUnitGeneral);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempUnitGeneral(TempUnitGeneral tempUnitGeneral)
		throws SystemException {
		tempUnitGeneralPersistence.remove(tempUnitGeneral);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempUnitGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempUnitGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempUnitGeneral fetchTempUnitGeneral(long id)
		throws SystemException {
		return tempUnitGeneralPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempUnitGeneral getTempUnitGeneral(long id)
		throws PortalException, SystemException {
		return tempUnitGeneralPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempUnitGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempUnitGeneral> getTempUnitGenerals(int start, int end)
		throws SystemException {
		return tempUnitGeneralPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTempUnitGeneralsCount() throws SystemException {
		return tempUnitGeneralPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempUnitGeneral updateTempUnitGeneral(
		TempUnitGeneral tempUnitGeneral) throws SystemException {
		return updateTempUnitGeneral(tempUnitGeneral, true);
	}
	 ...
	 */
	public TempUnitGeneral updateTempUnitGeneral(
		TempUnitGeneral tempUnitGeneral, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempUnitGeneral",
			tempUnitGeneralLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempUnitGeneral");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempUnitGeneralPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempUnitGeneralLocalServiceBaseImpl.class);
