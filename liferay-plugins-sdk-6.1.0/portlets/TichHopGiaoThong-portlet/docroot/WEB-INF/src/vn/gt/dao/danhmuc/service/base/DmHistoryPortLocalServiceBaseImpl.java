...
/**
 * The base implementation of the dm history port local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPortLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryPortLocalServiceBaseImpl
	implements DmHistoryPortLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPort addDmHistoryPort(DmHistoryPort dmHistoryPort)
		...
		dmHistoryPort = dmHistoryPortPersistence.update(dmHistoryPort, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPort);
			}
	...
	public DmHistoryPort createDmHistoryPort(int id) {
		return dmHistoryPortPersistence.create(id);
	}
	...
	public void deleteDmHistoryPort(int id)
		...
		DmHistoryPort dmHistoryPort = dmHistoryPortPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPort);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPort fetchDmHistoryPort(int id) throws SystemException {
		return dmHistoryPortPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPort getDmHistoryPort(int id)
		throws PortalException, SystemException {
		return dmHistoryPortPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPortPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPort> getDmHistoryPorts(int start, int end)
		throws SystemException {
		return dmHistoryPortPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPortsCount() throws SystemException {
		return dmHistoryPortPersistence.countAll();
	}
	...
	public DmHistoryPort updateDmHistoryPort(DmHistoryPort dmHistoryPort,
		...
		dmHistoryPort = dmHistoryPortPersistence.update(dmHistoryPort, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPort",
			dmHistoryPortLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPort");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPortPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPortLocalServiceBaseImpl.class);
