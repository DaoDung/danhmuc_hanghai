 ...
 * @author win_64
 */
public class InterfaceRequestFieldClp extends BaseModelImpl<InterfaceRequestField>
	implements InterfaceRequestField {
	public InterfaceRequestFieldClp() {
	}
	...
	public InterfaceRequestField toEscapedModel() {
		return (InterfaceRequestField)Proxy.newProxyInstance(InterfaceRequestField.class.getClassLoader(),
			new Class[] { InterfaceRequestField.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		InterfaceRequestFieldClp clone = new InterfaceRequestFieldClp();
	...
	public boolean equals(Object obj) {
		...
		InterfaceRequestFieldClp interfaceRequestField = null;

		try {
			interfaceRequestField = (InterfaceRequestFieldClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("vn.gt.dao.noticeandmessage.model.InterfaceRequestField");
