...
public class TT9TichHopMessageUtils {

	private static Log _log = LogFactoryUtil.getLog(TT9TichHopMessageUtils.class);
	...
	public static boolean message_99_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.TAU_RA, function, MessageType.HO_SO,
	...
	public static boolean message_99_30(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.TAU_RA, function, MessageType.TYPE_THONG_BAO_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_99_31(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.TAU_RA, function, MessageType.TYPE_THONG_BAO_XAC_NHAN_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_10_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.TAU_RA, function,
