...
public class TT16JSONProvider {

	private static Log _log = LogFactoryUtil.getLog(TT16JSONProvider.class);
...
//						}
			...
			resultShow = CheckBusinessUtil.checkRoleDisplayButton(ChuyenDichTrangThaiUtils.TAU_THUYEN_NHAP_CANH_6, messageType, vaiTro, temp, requestCode,
					actionRequest);
