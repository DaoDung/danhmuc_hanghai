...
/**
 * The base implementation of the temp crew effects declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCrewEffectsDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCrewEffectsDeclarationLocalServiceBaseImpl
	implements TempCrewEffectsDeclarationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCrewEffectsDeclarationLocalServiceUtil} to access the temp crew effects declaration local service.
	 */
	...
	public TempCrewEffectsDeclaration addTempCrewEffectsDeclaration(
		...
		tempCrewEffectsDeclaration = tempCrewEffectsDeclarationPersistence.update(tempCrewEffectsDeclaration,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempCrewEffectsDeclaration);
			}
	...
	public TempCrewEffectsDeclaration createTempCrewEffectsDeclaration(long id) {
		return tempCrewEffectsDeclarationPersistence.create(id);
	}
	...
	public void deleteTempCrewEffectsDeclaration(long id)
		...
		TempCrewEffectsDeclaration tempCrewEffectsDeclaration = tempCrewEffectsDeclarationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCrewEffectsDeclaration);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempCrewEffectsDeclaration(
		TempCrewEffectsDeclaration tempCrewEffectsDeclaration)
		throws SystemException {
		tempCrewEffectsDeclarationPersistence.remove(tempCrewEffectsDeclaration);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewEffectsDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewEffectsDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCrewEffectsDeclaration fetchTempCrewEffectsDeclaration(long id)
		throws SystemException {
		return tempCrewEffectsDeclarationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewEffectsDeclaration getTempCrewEffectsDeclaration(long id)
		throws PortalException, SystemException {
		return tempCrewEffectsDeclarationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCrewEffectsDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempCrewEffectsDeclaration> getTempCrewEffectsDeclarations(
		...
		return tempCrewEffectsDeclarationPersistence.findAll(start, end);
	}
	...
	public int getTempCrewEffectsDeclarationsCount() throws SystemException {
		return tempCrewEffectsDeclarationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCrewEffectsDeclaration",
			tempCrewEffectsDeclarationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCrewEffectsDeclaration");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCrewEffectsDeclarationPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCrewEffectsDeclarationLocalServiceBaseImpl.class);
