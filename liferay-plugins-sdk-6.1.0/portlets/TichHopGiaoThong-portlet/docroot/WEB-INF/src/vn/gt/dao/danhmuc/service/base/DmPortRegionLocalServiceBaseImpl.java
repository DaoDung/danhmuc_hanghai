...
/**
 * The base implementation of the dm port region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPortRegionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPortRegionLocalServiceBaseImpl
	implements DmPortRegionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmPortRegionLocalServiceUtil} to access the dm port region local service.
	 */
	...
	public DmPortRegion addDmPortRegion(DmPortRegion dmPortRegion)
		...
		dmPortRegion = dmPortRegionPersistence.update(dmPortRegion, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPortRegion);
			}
	...
	public DmPortRegion createDmPortRegion(int id) {
		return dmPortRegionPersistence.create(id);
	}
	...
	public void deleteDmPortRegion(int id)
		...
		DmPortRegion dmPortRegion = dmPortRegionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPortRegion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPortRegion fetchDmPortRegion(int id) throws SystemException {
		return dmPortRegionPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPortRegion getDmPortRegion(int id)
		throws PortalException, SystemException {
		return dmPortRegionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPortRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmPortRegion> getDmPortRegions(int start, int end)
		throws SystemException {
		return dmPortRegionPersistence.findAll(start, end);
	}
	...
	public int getDmPortRegionsCount() throws SystemException {
		return dmPortRegionPersistence.countAll();
	}
	...
	public DmPortRegion updateDmPortRegion(DmPortRegion dmPortRegion,
		...
		dmPortRegion = dmPortRegionPersistence.update(dmPortRegion, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPortRegion",
			dmPortRegionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPortRegion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPortRegionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPortRegionLocalServiceBaseImpl.class);
