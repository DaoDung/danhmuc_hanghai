...
public class TempNoTiceShipMessageModelImpl extends BaseModelImpl<TempNoTiceShipMessage>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "NumberCargoDeclaration", Types.INTEGER },
			{ "NumberShipStoreDeclaration", Types.INTEGER },
			{ "NumberCrewList", Types.INTEGER },
			{ "NumberPassengerList", Types.INTEGER },
			{ "NumberCrewEffectsDeclaration", Types.INTEGER },
			{ "NumberHealthMaritimeDeclaration", Types.INTEGER },
	...
	public static TempNoTiceShipMessage toModel(
		...
		model.setNumberCrewEffectsDeclaration(soapModel.getNumberCrewEffectsDeclaration());
		model.setNumberHealthMaritimeDeclaration(soapModel.getNumberHealthMaritimeDeclaration());
	...
	public Object clone() {
		...
		tempNoTiceShipMessageImpl.setDocumentReference(getDocumentReference());
		tempNoTiceShipMessageImpl.setIsArrival(getIsArrival());
		tempNoTiceShipMessageImpl.setVoyageNumber(getVoyageNumber());
		tempNoTiceShipMessageImpl.setNetTonnage(getNetTonnage());
		tempNoTiceShipMessageImpl.setNetTonnageUnit(getNetTonnageUnit());
		tempNoTiceShipMessageImpl.setPositionOfShipInPort(getPositionOfShipInPort());
		tempNoTiceShipMessageImpl.setBriefParticularsOfVoyage(getBriefParticularsOfVoyage());
		tempNoTiceShipMessageImpl.setPreviousPortsOfCall(getPreviousPortsOfCall());
		tempNoTiceShipMessageImpl.setSubsequentPortsOfCall(getSubsequentPortsOfCall());
		tempNoTiceShipMessageImpl.setDischargedPorts(getDischargedPorts());
		tempNoTiceShipMessageImpl.setRemainingCargo(getRemainingCargo());
		tempNoTiceShipMessageImpl.setShipRequirementsInTermsOfWaste(getShipRequirementsInTermsOfWaste());
		tempNoTiceShipMessageImpl.setNumberCargoDeclaration(getNumberCargoDeclaration());
		tempNoTiceShipMessageImpl.setNumberShipStoreDeclaration(getNumberShipStoreDeclaration());
		tempNoTiceShipMessageImpl.setNumberCrewList(getNumberCrewList());
		tempNoTiceShipMessageImpl.setNumberPassengerList(getNumberPassengerList());
		tempNoTiceShipMessageImpl.setNumberCrewEffectsDeclaration(getNumberCrewEffectsDeclaration());
		tempNoTiceShipMessageImpl.setNumberHealthMaritimeDeclaration(getNumberHealthMaritimeDeclaration());
		tempNoTiceShipMessageImpl.setPortClearanceNo(getPortClearanceNo());
		tempNoTiceShipMessageImpl.setTimeOfPORTArrival(getTimeOfPORTArrival());
		tempNoTiceShipMessageImpl.setTimeOfPilotOnBoard(getTimeOfPilotOnBoard());
		tempNoTiceShipMessageImpl.setTugBoat(getTugBoat());
		tempNoTiceShipMessageImpl.setDo_(getDo_());
		tempNoTiceShipMessageImpl.setFo(getFo());
		tempNoTiceShipMessageImpl.setFw(getFw());
		tempNoTiceShipMessageImpl.setPlaceOfReception(getPlaceOfReception());
	...
	public CacheModel<TempNoTiceShipMessage> toCacheModel() {
		...
		tempNoTiceShipMessageCacheModel.documentReference = getDocumentReference();

		tempNoTiceShipMessageCacheModel.isArrival = getIsArrival();

		tempNoTiceShipMessageCacheModel.voyageNumber = getVoyageNumber();

		String voyageNumber = tempNoTiceShipMessageCacheModel.voyageNumber;

		if ((voyageNumber != null) && (voyageNumber.length() == 0)) {
			tempNoTiceShipMessageCacheModel.voyageNumber = null;
		}

		tempNoTiceShipMessageCacheModel.netTonnage = getNetTonnage();

		tempNoTiceShipMessageCacheModel.netTonnageUnit = getNetTonnageUnit();

		String netTonnageUnit = tempNoTiceShipMessageCacheModel.netTonnageUnit;

		if ((netTonnageUnit != null) && (netTonnageUnit.length() == 0)) {
			tempNoTiceShipMessageCacheModel.netTonnageUnit = null;
		}

		tempNoTiceShipMessageCacheModel.positionOfShipInPort = getPositionOfShipInPort();

		String positionOfShipInPort = tempNoTiceShipMessageCacheModel.positionOfShipInPort;

		if ((positionOfShipInPort != null) &&
				(positionOfShipInPort.length() == 0)) {
			tempNoTiceShipMessageCacheModel.positionOfShipInPort = null;
		}

		tempNoTiceShipMessageCacheModel.briefParticularsOfVoyage = getBriefParticularsOfVoyage();

		String briefParticularsOfVoyage = tempNoTiceShipMessageCacheModel.briefParticularsOfVoyage;

		if ((briefParticularsOfVoyage != null) &&
				(briefParticularsOfVoyage.length() == 0)) {
			tempNoTiceShipMessageCacheModel.briefParticularsOfVoyage = null;
		}

		tempNoTiceShipMessageCacheModel.previousPortsOfCall = getPreviousPortsOfCall();

		String previousPortsOfCall = tempNoTiceShipMessageCacheModel.previousPortsOfCall;

		if ((previousPortsOfCall != null) &&
				(previousPortsOfCall.length() == 0)) {
			tempNoTiceShipMessageCacheModel.previousPortsOfCall = null;
		}

		tempNoTiceShipMessageCacheModel.subsequentPortsOfCall = getSubsequentPortsOfCall();

		String subsequentPortsOfCall = tempNoTiceShipMessageCacheModel.subsequentPortsOfCall;

		if ((subsequentPortsOfCall != null) &&
				(subsequentPortsOfCall.length() == 0)) {
			tempNoTiceShipMessageCacheModel.subsequentPortsOfCall = null;
		}

		tempNoTiceShipMessageCacheModel.dischargedPorts = getDischargedPorts();

		String dischargedPorts = tempNoTiceShipMessageCacheModel.dischargedPorts;

		if ((dischargedPorts != null) && (dischargedPorts.length() == 0)) {
			tempNoTiceShipMessageCacheModel.dischargedPorts = null;
		}

		tempNoTiceShipMessageCacheModel.remainingCargo = getRemainingCargo();

		String remainingCargo = tempNoTiceShipMessageCacheModel.remainingCargo;

		if ((remainingCargo != null) && (remainingCargo.length() == 0)) {
			tempNoTiceShipMessageCacheModel.remainingCargo = null;
		}

		tempNoTiceShipMessageCacheModel.shipRequirementsInTermsOfWaste = getShipRequirementsInTermsOfWaste();

		String shipRequirementsInTermsOfWaste = tempNoTiceShipMessageCacheModel.shipRequirementsInTermsOfWaste;

		if ((shipRequirementsInTermsOfWaste != null) &&
				(shipRequirementsInTermsOfWaste.length() == 0)) {
			tempNoTiceShipMessageCacheModel.shipRequirementsInTermsOfWaste = null;
		}

		tempNoTiceShipMessageCacheModel.numberCargoDeclaration = getNumberCargoDeclaration();

		tempNoTiceShipMessageCacheModel.numberShipStoreDeclaration = getNumberShipStoreDeclaration();

		tempNoTiceShipMessageCacheModel.numberCrewList = getNumberCrewList();

		tempNoTiceShipMessageCacheModel.numberPassengerList = getNumberPassengerList();

		tempNoTiceShipMessageCacheModel.numberCrewEffectsDeclaration = getNumberCrewEffectsDeclaration();

		tempNoTiceShipMessageCacheModel.numberHealthMaritimeDeclaration = getNumberHealthMaritimeDeclaration();

		tempNoTiceShipMessageCacheModel.portClearanceNo = getPortClearanceNo();

		String portClearanceNo = tempNoTiceShipMessageCacheModel.portClearanceNo;

		if ((portClearanceNo != null) && (portClearanceNo.length() == 0)) {
			tempNoTiceShipMessageCacheModel.portClearanceNo = null;
		}

		Date timeOfPORTArrival = getTimeOfPORTArrival();

		if (timeOfPORTArrival != null) {
			tempNoTiceShipMessageCacheModel.timeOfPORTArrival = timeOfPORTArrival.getTime();
		}
		else {
			tempNoTiceShipMessageCacheModel.timeOfPORTArrival = Long.MIN_VALUE;
		}

		Date timeOfPilotOnBoard = getTimeOfPilotOnBoard();

		if (timeOfPilotOnBoard != null) {
			tempNoTiceShipMessageCacheModel.timeOfPilotOnBoard = timeOfPilotOnBoard.getTime();
		}
		else {
			tempNoTiceShipMessageCacheModel.timeOfPilotOnBoard = Long.MIN_VALUE;
		}

		tempNoTiceShipMessageCacheModel.tugBoat = getTugBoat();

		String tugBoat = tempNoTiceShipMessageCacheModel.tugBoat;

		if ((tugBoat != null) && (tugBoat.length() == 0)) {
			tempNoTiceShipMessageCacheModel.tugBoat = null;
		}

		tempNoTiceShipMessageCacheModel.do_ = getDo_();

		String do_ = tempNoTiceShipMessageCacheModel.do_;

		if ((do_ != null) && (do_.length() == 0)) {
			tempNoTiceShipMessageCacheModel.do_ = null;
		}

		tempNoTiceShipMessageCacheModel.fo = getFo();

		String fo = tempNoTiceShipMessageCacheModel.fo;

		if ((fo != null) && (fo.length() == 0)) {
			tempNoTiceShipMessageCacheModel.fo = null;
		}

		tempNoTiceShipMessageCacheModel.fw = getFw();

		String fw = tempNoTiceShipMessageCacheModel.fw;

		if ((fw != null) && (fw.length() == 0)) {
			tempNoTiceShipMessageCacheModel.fw = null;
		}

		tempNoTiceShipMessageCacheModel.placeOfReception = getPlaceOfReception();

		String placeOfReception = tempNoTiceShipMessageCacheModel.placeOfReception;

		if ((placeOfReception != null) && (placeOfReception.length() == 0)) {
			tempNoTiceShipMessageCacheModel.placeOfReception = null;
		}
