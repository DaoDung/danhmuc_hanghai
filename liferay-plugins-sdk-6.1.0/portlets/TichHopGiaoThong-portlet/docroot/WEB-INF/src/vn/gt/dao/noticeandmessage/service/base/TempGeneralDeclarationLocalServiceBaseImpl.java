...
/**
 * The base implementation of the temp general declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempGeneralDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempGeneralDeclarationLocalServiceBaseImpl
	implements TempGeneralDeclarationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempGeneralDeclarationLocalServiceUtil} to access the temp general declaration local service.
	 */
	...
	public TempGeneralDeclaration addTempGeneralDeclaration(
		...
		tempGeneralDeclaration = tempGeneralDeclarationPersistence.update(tempGeneralDeclaration,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempGeneralDeclaration);
			}
	...
	public TempGeneralDeclaration createTempGeneralDeclaration(long id) {
		return tempGeneralDeclarationPersistence.create(id);
	}
	...
	public void deleteTempGeneralDeclaration(long id)
		...
		TempGeneralDeclaration tempGeneralDeclaration = tempGeneralDeclarationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempGeneralDeclaration);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempGeneralDeclaration(
		TempGeneralDeclaration tempGeneralDeclaration)
		throws SystemException {
		tempGeneralDeclarationPersistence.remove(tempGeneralDeclaration);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempGeneralDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempGeneralDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempGeneralDeclaration fetchTempGeneralDeclaration(long id)
		throws SystemException {
		return tempGeneralDeclarationPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempGeneralDeclaration getTempGeneralDeclaration(long id)
		throws PortalException, SystemException {
		return tempGeneralDeclarationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempGeneralDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempGeneralDeclaration> getTempGeneralDeclarations(int start,
		...
		return tempGeneralDeclarationPersistence.findAll(start, end);
	}
	...
	public int getTempGeneralDeclarationsCount() throws SystemException {
		return tempGeneralDeclarationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration",
			tempGeneralDeclarationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempGeneralDeclarationPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempGeneralDeclarationLocalServiceBaseImpl.class);
