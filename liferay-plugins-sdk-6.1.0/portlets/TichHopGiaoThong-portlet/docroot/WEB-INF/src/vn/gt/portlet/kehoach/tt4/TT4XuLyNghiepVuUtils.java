...
public class TT4XuLyNghiepVuUtils {
	...
	public static int doActionHoSo(long documentName, int documentYear, int actionType, int orginStatus,
		...
		try {
			...
			if (desStatus == ChuyenDichTrangThaiUtils.KE_HOACH_CHO_CAP_LENH_DIEU_DONG) {
				...
				TT4TichHopMessageUtils.message_99_21(user.getEmailAddress(), uploadPortletRequest, actionRequest,
				...
				boolean resultMethod = TT4TichHopMessageUtils.message_99_22(user.getEmailAddress(),
				...
				if (desStatus == TrangThaiBanKhaiNhapCanh.CHO_TIEP_NHAN
					...
					boolean resultMethod = TT4TichHopMessageUtils.message_99_27(user.getEmailAddress(),
							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT4TichHopMessageUtils.message_99_28(user.getEmailAddress(),
						uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT4TichHopMessageUtils.message_99_24(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT4TichHopMessageUtils.message_99_25(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				TT4TichHopMessageUtils.message_99_23(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
	...
	public static int doActionBanKhai(long documentName, int documentYear, int actionType, int orginStatus,
		...
		try {
			...
			if (messageType == MessageType.BAN_KHAI_AN_NINH_TAU_BIEN) {
				BanKhaiAnNinhTauBienUtils action = new BanKhaiAnNinhTauBienUtils();

				result = action._banKhaiAnNinhTauBien(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);

			} else if (messageType == MessageType.BAN_KHAI_HANG_HOA) {

				BanKhaiHangHoaUtils action = new BanKhaiHangHoaUtils();

				result = action._banKhaiHangHoa(requestCode, documentName, documentYear, messageType, desStatus, user,
				...
				result = action._thongBao(requestCode, documentName, documentYear, messageType, desStatus, user,
						uploadPortletRequest, actionRequest);
				...
				result = action._xacBao(requestCode, documentName, documentYear, messageType, desStatus, user,
						uploadPortletRequest, actionRequest);
				...
				result = action._xacNhanHoanThanhThuTuc(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiDanhSachThuyenVien(requestCode, documentName, documentYear, messageType,
						desStatus, user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiDanhSachHanhKhach(requestCode, documentName, documentYear, messageType,
						desStatus, user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiDanhSachHangHoaNguyHiem(requestCode, documentName, documentYear, messageType,
						desStatus, user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiDuTruCuaTau(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiHanhLyThuyenVien(requestCode, documentName, documentYear, messageType,
						desStatus, user, uploadPortletRequest, actionRequest);
				...
				result = action._banKhaiBaoYTeHangHai(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);
				// Tich hop send message
				...
				result = action._banKhaiKiemDichThucVat(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);
				// Tich hop send message
				...
				result = action._banKhaiKiemDichDongVat(requestCode, documentName, documentYear, messageType, desStatus,
						user, uploadPortletRequest, actionRequest);
				// Tich hop send message
				...
				result = action._cacGiayToXuatTrinh(requestCode, documentName, documentYear, actionType, messageType,
						desStatus, user, uploadPortletRequest, actionRequest);
			}
	...
	private static int thayDoiTrangThaiBanKhaiKeHoach(long documentName, int documentYear, int orginStatus,
		...
		_log.info("THAY DOI TRANG THAI TOAN BO BAN KHAI KHI TIEP NHAN HO SO: documentName= " + documentName
