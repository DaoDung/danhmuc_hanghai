...
/**
 * The base implementation of the dm history maritime local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryMaritimeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryMaritimeLocalServiceBaseImpl
	implements DmHistoryMaritimeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryMaritime addDmHistoryMaritime(
		...
		dmHistoryMaritime = dmHistoryMaritimePersistence.update(dmHistoryMaritime,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryMaritime);
			}
	...
	public DmHistoryMaritime createDmHistoryMaritime(int id) {
		return dmHistoryMaritimePersistence.create(id);
	}
	...
	public void deleteDmHistoryMaritime(int id)
		...
		DmHistoryMaritime dmHistoryMaritime = dmHistoryMaritimePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryMaritime);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryMaritimePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryMaritimePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryMaritime fetchDmHistoryMaritime(int id)
		throws SystemException {
		return dmHistoryMaritimePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryMaritime getDmHistoryMaritime(int id)
		throws PortalException, SystemException {
		return dmHistoryMaritimePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryMaritimePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryMaritime> getDmHistoryMaritimes(int start, int end)
		throws SystemException {
		return dmHistoryMaritimePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryMaritimesCount() throws SystemException {
		return dmHistoryMaritimePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryMaritime",
			dmHistoryMaritimeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryMaritime");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryMaritimePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryMaritimeLocalServiceBaseImpl.class);
