...
/**
 * The persistence utility for the document general service. This utility wraps {@link DocumentGeneralPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class DocumentGeneralUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(DocumentGeneral documentGeneral) {
		getPersistence().clearCache(documentGeneral);
	}
	 ...
	 */
	public static List<DocumentGeneral> findWithDynamicQuery(
	...
	public static DocumentGeneral update(DocumentGeneral documentGeneral,
		...
		return getPersistence().update(documentGeneral, merge);
	}
	...
	public static DocumentGeneral update(DocumentGeneral documentGeneral,
		...
		return getPersistence().update(documentGeneral, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(documentGeneral);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(documentGenerals);
	}
	...
	*/
	public static vn.gt.dao.nhapcanh.model.DocumentGeneral create(long id) {
	...
	*/
	public static vn.gt.dao.nhapcanh.model.DocumentGeneral remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.gt.dao.nhapcanh.NoSuchDocumentGeneralException {
		return getPersistence().remove(id);
	}

	public static vn.gt.dao.nhapcanh.model.DocumentGeneral updateImpl(
		vn.gt.dao.nhapcanh.model.DocumentGeneral documentGeneral, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(documentGeneral, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.DocumentGeneral findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.gt.dao.nhapcanh.NoSuchDocumentGeneralException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.DocumentGeneral fetchByPrimaryKey(
	...
	*/
	...
	public static DocumentGeneralPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DocumentGeneralPersistence)PortletBeanLocatorUtil.locate(vn.gt.dao.nhapcanh.service.ClpSerializer.getServletContextName(),
					DocumentGeneralPersistence.class.getName());

			ReferenceRegistry.registerReference(DocumentGeneralUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(DocumentGeneralPersistence persistence) {
	...
	private static DocumentGeneralPersistence _persistence;
}