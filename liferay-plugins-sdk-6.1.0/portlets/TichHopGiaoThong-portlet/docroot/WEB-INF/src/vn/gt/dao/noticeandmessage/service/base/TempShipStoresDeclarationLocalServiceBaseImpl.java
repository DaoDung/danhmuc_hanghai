...
/**
 * The base implementation of the temp ship stores declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempShipStoresDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempShipStoresDeclarationLocalServiceBaseImpl
	implements TempShipStoresDeclarationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempShipStoresDeclaration addTempShipStoresDeclaration(
		...
		tempShipStoresDeclaration = tempShipStoresDeclarationPersistence.update(tempShipStoresDeclaration,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempShipStoresDeclaration);
			}
	...
	public TempShipStoresDeclaration createTempShipStoresDeclaration(long id) {
		return tempShipStoresDeclarationPersistence.create(id);
	}
	...
	public void deleteTempShipStoresDeclaration(long id)
		...
		TempShipStoresDeclaration tempShipStoresDeclaration = tempShipStoresDeclarationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempShipStoresDeclaration);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempShipStoresDeclaration(
		TempShipStoresDeclaration tempShipStoresDeclaration)
		throws SystemException {
		tempShipStoresDeclarationPersistence.remove(tempShipStoresDeclaration);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipStoresDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipStoresDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempShipStoresDeclaration fetchTempShipStoresDeclaration(long id)
		throws SystemException {
		return tempShipStoresDeclarationPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempShipStoresDeclaration getTempShipStoresDeclaration(long id)
		throws PortalException, SystemException {
		return tempShipStoresDeclarationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempShipStoresDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempShipStoresDeclaration> getTempShipStoresDeclarations(
		...
		return tempShipStoresDeclarationPersistence.findAll(start, end);
	}
	...
	public int getTempShipStoresDeclarationsCount() throws SystemException {
		return tempShipStoresDeclarationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempShipStoresDeclaration",
			tempShipStoresDeclarationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempShipStoresDeclaration");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempShipStoresDeclarationPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempShipStoresDeclarationLocalServiceBaseImpl.class);
