...
import vn.gt.dao.danhmuc.model.impl.DmUnitGeneralImpl;
import vn.gt.dao.danhmuc.model.impl.DmUnitGeneralModelImpl;
...
public class DmUnitGeneralPersistenceImpl extends BasePersistenceImpl<DmUnitGeneral>
	...
	protected DmUnitGeneral removeImpl(DmUnitGeneral dmUnitGeneral)
		...
		try {
			...
			BatchSessionUtil.delete(session, dmUnitGeneral);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public DmUnitGeneral updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, dmUnitGeneral, merge);
		...
		if (dmUnitGeneral == null) {
			...
			try {
				...
				if (dmUnitGeneral != null) {
					...
					EntityCacheUtil.putResult(DmUnitGeneralModelImpl.ENTITY_CACHE_ENABLED,
						DmUnitGeneralImpl.class, id, _nullDmUnitGeneral);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.gt.dao.danhmuc.model.DmUnitGeneral")));
