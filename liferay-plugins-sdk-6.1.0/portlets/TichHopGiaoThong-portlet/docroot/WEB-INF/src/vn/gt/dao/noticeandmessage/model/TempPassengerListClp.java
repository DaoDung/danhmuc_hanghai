...
public class TempPassengerListClp extends BaseModelImpl<TempPassengerList>
	...
	public Object clone() {
		...
		clone.setNumberOfLeftPassengers(getNumberOfLeftPassengers());
		clone.setNumberOfVNmeses(getNumberOfVNmeses());
		clone.setNumberOfForeigners(getNumberOfForeigners());
		clone.setTotalPassengers(getTotalPassengers());
