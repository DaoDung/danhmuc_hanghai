...
import vn.gt.dao.noticeandmessage.NoSuchTempDeclarationForPlantQuarantineException;
...
import vn.gt.dao.noticeandmessage.model.impl.TempDeclarationForPlantQuarantineModelImpl;
...
public class TempDeclarationForPlantQuarantinePersistenceImpl
	...
	protected TempDeclarationForPlantQuarantine removeImpl(
		...
		try {
			...
			BatchSessionUtil.delete(session, tempDeclarationForPlantQuarantine);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public TempDeclarationForPlantQuarantine updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, tempDeclarationForPlantQuarantine,
				merge);
		...
		if (isNew ||
			...
			if ((tempDeclarationForPlantQuarantineModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempDeclarationForPlantQuarantineModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getOriginalDocumentYear())
					};
				...
				args = new Object[] {
						Long.valueOf(tempDeclarationForPlantQuarantineModelImpl.getDocumentName()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getDocumentYear())
					};
			...
			if ((tempDeclarationForPlantQuarantineModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempDeclarationForPlantQuarantineModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getOriginalDocumentYear()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getOriginalRequestState())
					};
				...
				args = new Object[] {
						Long.valueOf(tempDeclarationForPlantQuarantineModelImpl.getDocumentName()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getDocumentYear()),
						Integer.valueOf(tempDeclarationForPlantQuarantineModelImpl.getRequestState())
					};
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a temp declaration for plant quarantine with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public TempDeclarationForPlantQuarantine fetchByPrimaryKey(long id)
		...
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine = (TempDeclarationForPlantQuarantine)EntityCacheUtil.getResult(TempDeclarationForPlantQuarantineModelImpl.ENTITY_CACHE_ENABLED,
				TempDeclarationForPlantQuarantineImpl.class, id);
		...
		if (tempDeclarationForPlantQuarantine == null) {
			...
			try {
				...
				if (tempDeclarationForPlantQuarantine != null) {
					...
					EntityCacheUtil.putResult(TempDeclarationForPlantQuarantineModelImpl.ENTITY_CACHE_ENABLED,
						TempDeclarationForPlantQuarantineImpl.class, id,
						_nullTempDeclarationForPlantQuarantine);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.gt.dao.noticeandmessage.model.TempDeclarationForPlantQuarantine")));
