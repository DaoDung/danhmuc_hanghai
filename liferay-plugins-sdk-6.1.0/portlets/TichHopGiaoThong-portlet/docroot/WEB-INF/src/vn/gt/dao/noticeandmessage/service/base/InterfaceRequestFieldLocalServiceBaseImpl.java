...
/**
 * The base implementation of the interface request field local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.InterfaceRequestFieldLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.InterfaceRequestFieldLocalServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.InterfaceRequestFieldLocalServiceUtil
 * @generated
 */
public abstract class InterfaceRequestFieldLocalServiceBaseImpl
	implements InterfaceRequestFieldLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.InterfaceRequestFieldLocalServiceUtil} to access the interface request field local service.
	 */
	 ...
	 */
	public InterfaceRequestField addInterfaceRequestField(
		InterfaceRequestField interfaceRequestField) throws SystemException {
		interfaceRequestField.setNew(true);

		interfaceRequestField = interfaceRequestFieldPersistence.update(interfaceRequestField,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(interfaceRequestField);
			}
	 ...
	 */
	public InterfaceRequestField createInterfaceRequestField(long id) {
		return interfaceRequestFieldPersistence.create(id);
	}
	...
	public void deleteInterfaceRequestField(long id)
		...
		InterfaceRequestField interfaceRequestField = interfaceRequestFieldPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(interfaceRequestField);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteInterfaceRequestField(
		InterfaceRequestField interfaceRequestField) throws SystemException {
		interfaceRequestFieldPersistence.remove(interfaceRequestField);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return interfaceRequestFieldPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return interfaceRequestFieldPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public InterfaceRequestField fetchInterfaceRequestField(long id)
		throws SystemException {
		return interfaceRequestFieldPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InterfaceRequestField getInterfaceRequestField(long id)
		throws PortalException, SystemException {
		return interfaceRequestFieldPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return interfaceRequestFieldPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<InterfaceRequestField> getInterfaceRequestFields(int start,
		int end) throws SystemException {
		return interfaceRequestFieldPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getInterfaceRequestFieldsCount() throws SystemException {
		return interfaceRequestFieldPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InterfaceRequestField updateInterfaceRequestField(
		InterfaceRequestField interfaceRequestField) throws SystemException {
		return updateInterfaceRequestField(interfaceRequestField, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.InterfaceRequestField",
			interfaceRequestFieldLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.InterfaceRequestField");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = interfaceRequestFieldPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(InterfaceRequestFieldLocalServiceBaseImpl.class);
