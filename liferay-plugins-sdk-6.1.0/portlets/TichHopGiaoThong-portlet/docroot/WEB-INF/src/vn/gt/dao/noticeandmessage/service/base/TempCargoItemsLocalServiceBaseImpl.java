...
/**
 * The base implementation of the temp cargo items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCargoItemsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCargoItemsLocalServiceBaseImpl
	implements TempCargoItemsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCargoItemsLocalServiceUtil} to access the temp cargo items local service.
	 */
	 ...
	 */
	public TempCargoItems addTempCargoItems(TempCargoItems tempCargoItems)
		throws SystemException {
		tempCargoItems.setNew(true);

		tempCargoItems = tempCargoItemsPersistence.update(tempCargoItems, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempCargoItems);
			}
	...
	public TempCargoItems createTempCargoItems(long id) {
		return tempCargoItemsPersistence.create(id);
	}
	...
	public void deleteTempCargoItems(long id)
		...
		TempCargoItems tempCargoItems = tempCargoItemsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCargoItems);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempCargoItems(TempCargoItems tempCargoItems)
		throws SystemException {
		tempCargoItemsPersistence.remove(tempCargoItems);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCargoItemsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCargoItemsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCargoItems fetchTempCargoItems(long id)
		throws SystemException {
		return tempCargoItemsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems getTempCargoItems(long id)
		throws PortalException, SystemException {
		return tempCargoItemsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCargoItemsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempCargoItems> getTempCargoItemses(int start, int end)
		throws SystemException {
		return tempCargoItemsPersistence.findAll(start, end);
	}
	...
	public int getTempCargoItemsesCount() throws SystemException {
		return tempCargoItemsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems updateTempCargoItems(TempCargoItems tempCargoItems)
		throws SystemException {
	 ...
	 *
	 * @param tempCargoItems the temp cargo items
	 * @param merge whether to merge the temp cargo items with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the temp cargo items that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems updateTempCargoItems(TempCargoItems tempCargoItems,
		...
		tempCargoItems = tempCargoItemsPersistence.update(tempCargoItems, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCargoItems",
			tempCargoItemsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCargoItems");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCargoItemsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCargoItemsLocalServiceBaseImpl.class);
