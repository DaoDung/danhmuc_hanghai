...
import vn.gt.dao.common.service.UserSignLocalService;
...
import vn.gt.dao.common.service.persistence.UserSignPersistence;
 ...
 * @generated
 */
public abstract class LogMessageValidationLocalServiceBaseImpl
	implements LogMessageValidationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.common.service.LogMessageValidationLocalServiceUtil} to access the log message validation local service.
	 */
	...
	public LogMessageValidation addLogMessageValidation(
		...
		logMessageValidation = logMessageValidationPersistence.update(logMessageValidation,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(logMessageValidation);
			}
	...
	public LogMessageValidation createLogMessageValidation(long id) {
		return logMessageValidationPersistence.create(id);
	}
	...
	public void deleteLogMessageValidation(long id)
		...
		LogMessageValidation logMessageValidation = logMessageValidationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(logMessageValidation);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return logMessageValidationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return logMessageValidationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public LogMessageValidation fetchLogMessageValidation(long id)
		throws SystemException {
		return logMessageValidationPersistence.fetchByPrimaryKey(id);
	}
	...
	public LogMessageValidation getLogMessageValidation(long id)
		throws PortalException, SystemException {
		return logMessageValidationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return logMessageValidationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LogMessageValidation> getLogMessageValidations(int start,
		...
		return logMessageValidationPersistence.findAll(start, end);
	}
	...
	public int getLogMessageValidationsCount() throws SystemException {
		return logMessageValidationPersistence.countAll();
	}
	 ...
	 *
	 * @param logMessageValidation the log message validation
	 * @param merge whether to merge the log message validation with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the log message validation that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public LogMessageValidation updateLogMessageValidation(
	...
	/**
	 * Returns the user sign local service.
	 *
	 * @return the user sign local service
	 */
	public UserSignLocalService getUserSignLocalService() {
		return userSignLocalService;
	}

	/**
	 * Sets the user sign local service.
	 *
	 * @param userSignLocalService the user sign local service
	 */
	public void setUserSignLocalService(
		UserSignLocalService userSignLocalService) {
		this.userSignLocalService = userSignLocalService;
	}

	/**
	 * Returns the user sign persistence.
	 *
	 * @return the user sign persistence
	 */
	public UserSignPersistence getUserSignPersistence() {
		return userSignPersistence;
	}

	/**
	 * Sets the user sign persistence.
	 *
	 * @param userSignPersistence the user sign persistence
	 */
	public void setUserSignPersistence(UserSignPersistence userSignPersistence) {
		this.userSignPersistence = userSignPersistence;
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.common.model.LogMessageValidation",
			logMessageValidationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.common.model.LogMessageValidation");
	}
	...
	@BeanReference(type = UserSignLocalService.class)
	protected UserSignLocalService userSignLocalService;
	...
	private static Log _log = LogFactoryUtil.getLog(LogMessageValidationLocalServiceBaseImpl.class);
