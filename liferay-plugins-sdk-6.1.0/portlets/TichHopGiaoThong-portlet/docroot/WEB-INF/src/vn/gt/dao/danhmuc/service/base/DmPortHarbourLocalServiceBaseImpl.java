...
/**
 * The base implementation of the dm port harbour local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPortHarbourLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPortHarbourLocalServiceBaseImpl
	implements DmPortHarbourLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmPortHarbour addDmPortHarbour(DmPortHarbour dmPortHarbour)
		...
		dmPortHarbour = dmPortHarbourPersistence.update(dmPortHarbour, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPortHarbour);
			}
	...
	public DmPortHarbour createDmPortHarbour(int id) {
		return dmPortHarbourPersistence.create(id);
	}
	...
	public void deleteDmPortHarbour(int id)
		...
		DmPortHarbour dmPortHarbour = dmPortHarbourPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPortHarbour);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteDmPortHarbour(DmPortHarbour dmPortHarbour)
		throws SystemException {
		dmPortHarbourPersistence.remove(dmPortHarbour);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortHarbourPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortHarbourPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPortHarbour fetchDmPortHarbour(int id) throws SystemException {
		return dmPortHarbourPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPortHarbour getDmPortHarbour(int id)
		throws PortalException, SystemException {
		return dmPortHarbourPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPortHarbourPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmPortHarbour> getDmPortHarbours(int start, int end)
		throws SystemException {
		return dmPortHarbourPersistence.findAll(start, end);
	}
	...
	public int getDmPortHarboursCount() throws SystemException {
		return dmPortHarbourPersistence.countAll();
	}
	...
	public DmPortHarbour updateDmPortHarbour(DmPortHarbour dmPortHarbour,
		...
		dmPortHarbour = dmPortHarbourPersistence.update(dmPortHarbour, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPortHarbour",
			dmPortHarbourLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPortHarbour");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPortHarbourPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPortHarbourLocalServiceBaseImpl.class);
