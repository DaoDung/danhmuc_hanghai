...
/**
 * The base implementation of the dm state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmStateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmStateLocalServiceBaseImpl implements DmStateLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmState addDmState(DmState dmState) throws SystemException {
		...
		dmState = dmStatePersistence.update(dmState, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmState);
			}
	...
	public DmState createDmState(int id) {
		return dmStatePersistence.create(id);
	}
	...
	public void deleteDmState(int id) throws PortalException, SystemException {
		DmState dmState = dmStatePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmState);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmStatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmStatePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return dmStatePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmStatePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmState fetchDmState(int id) throws SystemException {
		return dmStatePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmState getDmState(int id) throws PortalException, SystemException {
		return dmStatePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmStatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmState> getDmStates(int start, int end)
		throws SystemException {
		return dmStatePersistence.findAll(start, end);
	}
	...
	public int getDmStatesCount() throws SystemException {
		return dmStatePersistence.countAll();
	}
	...
	public DmState updateDmState(DmState dmState, boolean merge)
		...
		dmState = dmStatePersistence.update(dmState, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmState",
			dmStateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmState");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmStatePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmStateLocalServiceBaseImpl.class);
