...
/**
 * The base implementation of the issue shifting order chanel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssueShiftingOrderChanelLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssueShiftingOrderChanelLocalServiceBaseImpl
	implements IssueShiftingOrderChanelLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssueShiftingOrderChanelLocalServiceUtil} to access the issue shifting order chanel local service.
	 */
	 ...
	 */
	public IssueShiftingOrderChanel addIssueShiftingOrderChanel(
		IssueShiftingOrderChanel issueShiftingOrderChanel)
		throws SystemException {
		issueShiftingOrderChanel.setNew(true);

		issueShiftingOrderChanel = issueShiftingOrderChanelPersistence.update(issueShiftingOrderChanel,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issueShiftingOrderChanel);
			}
	...
	public IssueShiftingOrderChanel createIssueShiftingOrderChanel(
		...
		return issueShiftingOrderChanelPersistence.create(issueShiftingOrderChanelPK);
	}
	...
	public void deleteIssueShiftingOrderChanel(
		...
		IssueShiftingOrderChanel issueShiftingOrderChanel = issueShiftingOrderChanelPersistence.remove(issueShiftingOrderChanelPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issueShiftingOrderChanel);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteIssueShiftingOrderChanel(
		IssueShiftingOrderChanel issueShiftingOrderChanel)
		throws SystemException {
		issueShiftingOrderChanelPersistence.remove(issueShiftingOrderChanel);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueShiftingOrderChanelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueShiftingOrderChanelPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssueShiftingOrderChanel fetchIssueShiftingOrderChanel(
		IssueShiftingOrderChanelPK issueShiftingOrderChanelPK)
		throws SystemException {
		return issueShiftingOrderChanelPersistence.fetchByPrimaryKey(issueShiftingOrderChanelPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueShiftingOrderChanel getIssueShiftingOrderChanel(
		IssueShiftingOrderChanelPK issueShiftingOrderChanelPK)
		throws PortalException, SystemException {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueShiftingOrderChanelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssueShiftingOrderChanel> getIssueShiftingOrderChanels(
		int start, int end) throws SystemException {
		return issueShiftingOrderChanelPersistence.findAll(start, end);
	}
	...
	public int getIssueShiftingOrderChanelsCount() throws SystemException {
		return issueShiftingOrderChanelPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueShiftingOrderChanel updateIssueShiftingOrderChanel(
		IssueShiftingOrderChanel issueShiftingOrderChanel)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssueShiftingOrderChanel",
			issueShiftingOrderChanelLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssueShiftingOrderChanel");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueShiftingOrderChanelPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssueShiftingOrderChanelLocalServiceBaseImpl.class);
