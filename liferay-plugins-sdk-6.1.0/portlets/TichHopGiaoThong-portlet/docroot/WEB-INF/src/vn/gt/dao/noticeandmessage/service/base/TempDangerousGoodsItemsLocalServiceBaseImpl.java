...
/**
 * The base implementation of the temp dangerous goods items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDangerousGoodsItemsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDangerousGoodsItemsLocalServiceBaseImpl
	implements TempDangerousGoodsItemsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDangerousGoodsItemsLocalServiceUtil} to access the temp dangerous goods items local service.
	 */
	 ...
	 */
	public TempDangerousGoodsItems addTempDangerousGoodsItems(
		TempDangerousGoodsItems tempDangerousGoodsItems)
		throws SystemException {
		tempDangerousGoodsItems.setNew(true);

		tempDangerousGoodsItems = tempDangerousGoodsItemsPersistence.update(tempDangerousGoodsItems,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempDangerousGoodsItems);
			}
	...
	public TempDangerousGoodsItems createTempDangerousGoodsItems(long id) {
		return tempDangerousGoodsItemsPersistence.create(id);
	}
	...
	public void deleteTempDangerousGoodsItems(long id)
		...
		TempDangerousGoodsItems tempDangerousGoodsItems = tempDangerousGoodsItemsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDangerousGoodsItems);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempDangerousGoodsItems(
		TempDangerousGoodsItems tempDangerousGoodsItems)
		throws SystemException {
		tempDangerousGoodsItemsPersistence.remove(tempDangerousGoodsItems);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDangerousGoodsItemsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDangerousGoodsItemsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDangerousGoodsItems fetchTempDangerousGoodsItems(long id)
		throws SystemException {
		return tempDangerousGoodsItemsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDangerousGoodsItems getTempDangerousGoodsItems(long id)
		throws PortalException, SystemException {
		return tempDangerousGoodsItemsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDangerousGoodsItemsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempDangerousGoodsItems> getTempDangerousGoodsItemses(
		...
		return tempDangerousGoodsItemsPersistence.findAll(start, end);
	}
	...
	public int getTempDangerousGoodsItemsesCount() throws SystemException {
		return tempDangerousGoodsItemsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDangerousGoodsItems updateTempDangerousGoodsItems(
		TempDangerousGoodsItems tempDangerousGoodsItems)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempDangerousGoodsItems",
			tempDangerousGoodsItemsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempDangerousGoodsItems");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDangerousGoodsItemsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDangerousGoodsItemsLocalServiceBaseImpl.class);
