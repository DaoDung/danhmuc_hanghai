...
/**
 * The base implementation of the temp declaration of health local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDeclarationOfHealthLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDeclarationOfHealthLocalServiceBaseImpl
	implements TempDeclarationOfHealthLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDeclarationOfHealthLocalServiceUtil} to access the temp declaration of health local service.
	 */
	 ...
	 */
	public TempDeclarationOfHealth addTempDeclarationOfHealth(
		TempDeclarationOfHealth tempDeclarationOfHealth)
		throws SystemException {
		tempDeclarationOfHealth.setNew(true);

		tempDeclarationOfHealth = tempDeclarationOfHealthPersistence.update(tempDeclarationOfHealth,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempDeclarationOfHealth);
			}
	...
	public TempDeclarationOfHealth createTempDeclarationOfHealth(long id) {
		return tempDeclarationOfHealthPersistence.create(id);
	}
	...
	public void deleteTempDeclarationOfHealth(long id)
		...
		TempDeclarationOfHealth tempDeclarationOfHealth = tempDeclarationOfHealthPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDeclarationOfHealth);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempDeclarationOfHealth(
		TempDeclarationOfHealth tempDeclarationOfHealth)
		throws SystemException {
		tempDeclarationOfHealthPersistence.remove(tempDeclarationOfHealth);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDeclarationOfHealthPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDeclarationOfHealthPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDeclarationOfHealth fetchTempDeclarationOfHealth(long id)
		throws SystemException {
		return tempDeclarationOfHealthPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDeclarationOfHealth getTempDeclarationOfHealth(long id)
		throws PortalException, SystemException {
		return tempDeclarationOfHealthPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDeclarationOfHealthPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempDeclarationOfHealth> getTempDeclarationOfHealths(
		...
		return tempDeclarationOfHealthPersistence.findAll(start, end);
	}
	...
	public int getTempDeclarationOfHealthsCount() throws SystemException {
		return tempDeclarationOfHealthPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDeclarationOfHealth updateTempDeclarationOfHealth(
		TempDeclarationOfHealth tempDeclarationOfHealth)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempDeclarationOfHealth",
			tempDeclarationOfHealthLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempDeclarationOfHealth");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDeclarationOfHealthPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDeclarationOfHealthLocalServiceBaseImpl.class);
