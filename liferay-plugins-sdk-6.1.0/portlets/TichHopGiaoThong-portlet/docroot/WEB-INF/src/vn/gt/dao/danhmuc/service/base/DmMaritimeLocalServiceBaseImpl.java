...
/**
 * The base implementation of the dm maritime local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmMaritimeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmMaritimeLocalServiceBaseImpl
	implements DmMaritimeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmMaritime addDmMaritime(DmMaritime dmMaritime)
		...
		dmMaritime = dmMaritimePersistence.update(dmMaritime, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmMaritime);
			}
	...
	public DmMaritime createDmMaritime(int id) {
		return dmMaritimePersistence.create(id);
	}
	...
	public void deleteDmMaritime(int id)
		...
		DmMaritime dmMaritime = dmMaritimePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmMaritime);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMaritimePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmMaritimePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMaritimePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmMaritime fetchDmMaritime(int id) throws SystemException {
		return dmMaritimePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmMaritime getDmMaritime(int id)
		throws PortalException, SystemException {
		return dmMaritimePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmMaritimePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public int getDmMaritimesCount() throws SystemException {
		return dmMaritimePersistence.countAll();
	}
	...
	public DmMaritime updateDmMaritime(DmMaritime dmMaritime, boolean merge)
		...
		dmMaritime = dmMaritimePersistence.update(dmMaritime, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmMaritime",
			dmMaritimeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmMaritime");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmMaritimePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmMaritimeLocalServiceBaseImpl.class);
