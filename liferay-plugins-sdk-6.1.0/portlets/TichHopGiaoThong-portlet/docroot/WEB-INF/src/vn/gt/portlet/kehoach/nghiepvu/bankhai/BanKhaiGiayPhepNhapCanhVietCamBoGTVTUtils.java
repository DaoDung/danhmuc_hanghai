...
public class BanKhaiGiayPhepNhapCanhVietCamBoGTVTUtils {
	...
	public static JSONObject buildThanhPhan(ThemeDisplay themeDisplay, long documentName, int documentYear) {
		...
		result.put("name", "Gi\u1EA5y ph\u00E9p v\u00E0o c\u1EA3ng");
	...
	public int _giayPhepRoiCangGTVT(String requestCode, long documentName, int documentYear, int messageType,
		...
		try {
			...
			ServiceContext serviceContext = ServiceContextFactory.getInstance(IssuePortClearance.class.getName(), actionRequest);
...
//				issuePortClearance.setAttachedFile(0);
...
//					boolean resultMethod = TT2TichHopMessageUtils.message_60_01(user.getEmailAddress(),
...
//					boolean resultMethod = TT7TichHopMessageUtils.message_60_01(user.getEmailAddress(),
//							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject, requestCode,
//							0, issuePortClearance2.getVersionNo());
//				} else if (tempDocument.getDocumentTypeCode()
//						.equalsIgnoreCase(ChuyenDichTrangThaiUtils.TAU_THUYEN_ROI_CANG)) {
//					boolean resultMethod = TT9TichHopMessageUtils.message_60_01(user.getEmailAddress(),
//							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject, requestCode,
//							0, issuePortClearance2.getVersionNo());
//				} else if (tempDocument.getDocumentTypeCode()
//						.equalsIgnoreCase(ChuyenDichTrangThaiUtils.CHUYEN_CANG_ROI)) {
//					boolean resultMethod = TT11TichHopMessageUtils.message_60_01(user.getEmailAddress(),
//							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject, requestCode,
//							0, issuePortClearance2.getVersionNo());
//				} else if (tempDocument.getDocumentTypeCode()
//						.equalsIgnoreCase(ChuyenDichTrangThaiUtils.XUAT_CANH_DAU_KHI)) {
//					boolean resultMethod = TT5TichHopMessageUtils.message_60_01(user.getEmailAddress(),
//							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject, requestCode,
//							0, issuePortClearance2.getVersionNo());
//				}
				...
				if (portClearance != null) {
					...
					if (tempDocument.getDocumentStatusCode() != TrangThaiBanKhaiXuatCanh.PHE_DUYET_HOAN_THANH_THU_TUC) {
						...
						if (tempDocument.getDocumentTypeCode().equalsIgnoreCase("XC")) {
							...
							boolean resultMethod = TT17TichHopMessageUtils.message_60_01(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
									requestCode, 0, issuePortClearance.getVersionNo());
						} else if (tempDocument.getDocumentTypeCode().equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_NHAP_CANH)) {
							boolean resultMethod = TT14TichHopMessageUtils.message_60_01(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
									requestCode, 0, issuePortClearance.getVersionNo());
						} else if (tempDocument.getDocumentTypeCode().equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_XUAT_CANH)) {
							boolean resultMethod = TT15TichHopMessageUtils.message_60_01(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
									requestCode, 0, issuePortClearance.getVersionNo());
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.ROI_CANH_DAU_KHI)) {
					...
					if (Validator.isNotNull(issuePortClearance.getRequestState())) {
						...
						try {
							...
							System.out.println("BanKhaiGiayPhepRoiCangBoGTVTUtils._giayPhepRoiCangGTVT()" + pathFileSub + tenFileExport);
							...
							System.out.println("BanKhaiGiayPhepRoiCangBoGTVTUtils._giayPhepRoiCangGTVT()" + fileEntry);
...
//					PortClearance xmlPortClearanceDD = portClearance2XmlDD.convertXMLPortClearance(requestCode);
//
//					if (xmlPortClearanceDD != null) {
//						if (xmlPortClearanceDD.getPortofAuthority() != null
//								&& xmlPortClearanceDD.getPortofAuthority().length() > 0) {
//							DmMaritime dmMaritime = DmMaritimeLocalServiceUtil
//									.getByMaritimeCode(xmlPortClearanceDD.getPortofAuthority());
//							if (dmMaritime != null) {
//								xmlPortClearanceDD.setPortofAuthority(dmMaritime.getMaritimeReference());
//							}
//						}
...
//					}
					...
					if (Validator.isNotNull(tempDebitNote) && tempDebitNote.getTotalpayment() > 0) {
						...
						if (tempDocument.getDocumentTypeCode().equalsIgnoreCase("XC")) {
							boolean resultMethod = TT2TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_NHAP_CANH)) {
							boolean resultMethod = TT14TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_XUAT_CANH)) {
							boolean resultMethod = TT15TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.ROI_CANH_DAU_KHI)) {
							boolean resultMethod = TT7TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.TAU_THUYEN_ROI_CANG)) {
							boolean resultMethod = TT9TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.CHUYEN_CANG_ROI)) {
							boolean resultMethod = TT11TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						} else if (tempDocument.getDocumentTypeCode()
								.equalsIgnoreCase(ChuyenDichTrangThaiUtils.XUAT_CANH_DAU_KHI)) {
							boolean resultMethod = TT5TichHopMessageUtils.message_99_30(user.getEmailAddress(),
									uploadPortletRequest, actionRequest, documentName, documentYear);
						}
					}
				}
			...
			case PageType.ACTION_TYPE_HUY:
				...
				if (lissuePortClearances != null && lissuePortClearances.size() > 0) {
					...
					if (tempDocument.getDocumentTypeCode().equalsIgnoreCase("XC")) {
						boolean resultMethod = TT2TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode().equalsIgnoreCase(ChuyenDichTrangThaiUtils.TAU_THUYEN_XUAT_CANH_7)) {
						boolean resultMethod = TT7TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode().equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_NHAP_CANH)) {
						boolean resultMethod = TT14TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode().equalsIgnoreCase(ChuyenDichTrangThaiUtils.VIET_CAM_XUAT_CANH)) {
						boolean resultMethod = TT15TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode()
							.equalsIgnoreCase(ChuyenDichTrangThaiUtils.ROI_CANH_DAU_KHI)) {
						boolean resultMethod = TT7TichHopMessageUtils.message_62_03(user.getEmailAddress(),
							...
							.equalsIgnoreCase(ChuyenDichTrangThaiUtils.TAU_THUYEN_ROI_CANG)) {
						boolean resultMethod = TT9TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode()
							.equalsIgnoreCase(ChuyenDichTrangThaiUtils.CHUYEN_CANG_ROI)) {
						boolean resultMethod = TT11TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					} else if (tempDocument.getDocumentTypeCode()
							.equalsIgnoreCase(ChuyenDichTrangThaiUtils.XUAT_CANH_DAU_KHI)) {
						boolean resultMethod = TT5TichHopMessageUtils.message_62_03(user.getEmailAddress(),
								uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject,
								requestCode, 0);
					}
		...
		try {
			...
			for (int i = 0; i < detail_clearance_array.length(); i++) {
				...
				if (Validator.isNull(current.getString("requestCode")) && current.getLong("idXoa") == 0) {
					...
					cargoItem = new TempCargoItemsImpl();
...
//					 }
					...
					_log.info("UPDATE TempCargoItems");
