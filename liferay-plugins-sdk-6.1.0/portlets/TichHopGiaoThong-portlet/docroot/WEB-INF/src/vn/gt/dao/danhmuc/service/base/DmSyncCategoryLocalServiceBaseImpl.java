...
/**
 * The base implementation of the dm sync category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmSyncCategoryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmSyncCategoryLocalServiceBaseImpl
	implements DmSyncCategoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmSyncCategory addDmSyncCategory(DmSyncCategory dmSyncCategory)
		...
		dmSyncCategory = dmSyncCategoryPersistence.update(dmSyncCategory, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmSyncCategory);
			}
	...
	public DmSyncCategory createDmSyncCategory(long id) {
		return dmSyncCategoryPersistence.create(id);
	}
	...
	public void deleteDmSyncCategory(long id)
		...
		DmSyncCategory dmSyncCategory = dmSyncCategoryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmSyncCategory);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmSyncCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmSyncCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmSyncCategory fetchDmSyncCategory(long id)
		throws SystemException {
		return dmSyncCategoryPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmSyncCategory getDmSyncCategory(long id)
		throws PortalException, SystemException {
		return dmSyncCategoryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmSyncCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmSyncCategory> getDmSyncCategories(int start, int end)
		throws SystemException {
		return dmSyncCategoryPersistence.findAll(start, end);
	}
	...
	public int getDmSyncCategoriesCount() throws SystemException {
		return dmSyncCategoryPersistence.countAll();
	}
	...
	public DmSyncCategory updateDmSyncCategory(DmSyncCategory dmSyncCategory,
		...
		dmSyncCategory = dmSyncCategoryPersistence.update(dmSyncCategory, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmSyncCategory",
			dmSyncCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmSyncCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmSyncCategoryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmSyncCategoryLocalServiceBaseImpl.class);
