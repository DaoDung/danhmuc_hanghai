...
/**
 * The base implementation of the result certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultCertificateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ResultCertificateLocalServiceBaseImpl
	implements ResultCertificateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public ResultCertificate addResultCertificate(
		...
		resultCertificate = resultCertificatePersistence.update(resultCertificate,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(resultCertificate);
			}
	...
	public ResultCertificate createResultCertificate(long id) {
		return resultCertificatePersistence.create(id);
	}
	...
	public void deleteResultCertificate(long id)
		...
		ResultCertificate resultCertificate = resultCertificatePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resultCertificate);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ResultCertificate fetchResultCertificate(long id)
		throws SystemException {
		return resultCertificatePersistence.fetchByPrimaryKey(id);
	}
	...
	public ResultCertificate getResultCertificate(long id)
		throws PortalException, SystemException {
		return resultCertificatePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return resultCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ResultCertificate> getResultCertificates(int start, int end)
		throws SystemException {
		return resultCertificatePersistence.findAll(start, end);
	}
	...
	public int getResultCertificatesCount() throws SystemException {
		return resultCertificatePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.ResultCertificate",
			resultCertificateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.ResultCertificate");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = resultCertificatePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ResultCertificateLocalServiceBaseImpl.class);
