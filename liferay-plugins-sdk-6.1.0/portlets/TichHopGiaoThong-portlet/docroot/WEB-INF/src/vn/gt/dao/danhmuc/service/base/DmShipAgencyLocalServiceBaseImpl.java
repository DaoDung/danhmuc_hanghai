...
/**
 * The base implementation of the dm ship agency local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmShipAgencyLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmShipAgencyLocalServiceBaseImpl
	implements DmShipAgencyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmShipAgency addDmShipAgency(DmShipAgency dmShipAgency)
		...
		dmShipAgency = dmShipAgencyPersistence.update(dmShipAgency, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmShipAgency);
			}
	...
	public DmShipAgency createDmShipAgency(int id) {
		return dmShipAgencyPersistence.create(id);
	}
	...
	public void deleteDmShipAgency(int id)
		...
		DmShipAgency dmShipAgency = dmShipAgencyPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmShipAgency);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmShipAgencyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmShipAgencyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmShipAgency fetchDmShipAgency(int id) throws SystemException {
		return dmShipAgencyPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmShipAgency getDmShipAgency(int id)
		throws PortalException, SystemException {
		return dmShipAgencyPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmShipAgencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmShipAgency> getDmShipAgencies(int start, int end)
		throws SystemException {
		return dmShipAgencyPersistence.findAll(start, end);
	}
	...
	public int getDmShipAgenciesCount() throws SystemException {
		return dmShipAgencyPersistence.countAll();
	}
	...
	public DmShipAgency updateDmShipAgency(DmShipAgency dmShipAgency,
		...
		dmShipAgency = dmShipAgencyPersistence.update(dmShipAgency, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmShipAgency",
			dmShipAgencyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmShipAgency");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmShipAgencyPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmShipAgencyLocalServiceBaseImpl.class);
