 ...
 * @author win_64
 */
public class DmStateClp extends BaseModelImpl<DmState> implements DmState {
	public DmStateClp() {
	}
	...
	public DmState toEscapedModel() {
		return (DmState)Proxy.newProxyInstance(DmState.class.getClassLoader(),
			new Class[] { DmState.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DmStateClp clone = new DmStateClp();
	...
	public boolean equals(Object obj) {
		...
		DmStateClp dmState = null;

		try {
			dmState = (DmStateClp)obj;
		}
