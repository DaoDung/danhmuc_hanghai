...
/**
 * The base implementation of the dm history state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryStateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryStateLocalServiceBaseImpl
	implements DmHistoryStateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryState addDmHistoryState(DmHistoryState dmHistoryState)
		...
		dmHistoryState = dmHistoryStatePersistence.update(dmHistoryState, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryState);
			}
	...
	public DmHistoryState createDmHistoryState(int id) {
		return dmHistoryStatePersistence.create(id);
	}
	...
	public void deleteDmHistoryState(int id)
		...
		DmHistoryState dmHistoryState = dmHistoryStatePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryState);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryStatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryStatePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryState fetchDmHistoryState(int id) throws SystemException {
		return dmHistoryStatePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryState getDmHistoryState(int id)
		throws PortalException, SystemException {
		return dmHistoryStatePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryStatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryState> getDmHistoryStates(int start, int end)
		throws SystemException {
		return dmHistoryStatePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryStatesCount() throws SystemException {
		return dmHistoryStatePersistence.countAll();
	}
	...
	public DmHistoryState updateDmHistoryState(DmHistoryState dmHistoryState,
		...
		dmHistoryState = dmHistoryStatePersistence.update(dmHistoryState, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryState",
			dmHistoryStateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryState");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryStatePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryStateLocalServiceBaseImpl.class);
