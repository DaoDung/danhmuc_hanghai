...
public class TT17JSONProvider {

	private static Log _log = LogFactoryUtil.getLog(TT17JSONProvider.class);
...
//		}
	...
	public static JSONObject checkThanhPhanActionButton(ThemeDisplay themeDisplay, long documentName, int documentYear,
		...
		try {
			...
			resultShow = CheckBusinessUtil.checkRoleDisplayButton(ChuyenDichTrangThaiUtils.TAU_THUYEN_XUAT_CANH_7,
