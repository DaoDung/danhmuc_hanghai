...
/**
 * The base implementation of the temp dangerous goods nanifest local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDangerousGoodsNanifestLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDangerousGoodsNanifestLocalServiceBaseImpl
	implements TempDangerousGoodsNanifestLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDangerousGoodsNanifestLocalServiceUtil} to access the temp dangerous goods nanifest local service.
	 */
	 ...
	 */
	public TempDangerousGoodsNanifest addTempDangerousGoodsNanifest(
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest)
		throws SystemException {
		tempDangerousGoodsNanifest.setNew(true);

		tempDangerousGoodsNanifest = tempDangerousGoodsNanifestPersistence.update(tempDangerousGoodsNanifest,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempDangerousGoodsNanifest);
			}
	 ...
	 */
	public TempDangerousGoodsNanifest createTempDangerousGoodsNanifest(long id) {
		return tempDangerousGoodsNanifestPersistence.create(id);
	}
	...
	public void deleteTempDangerousGoodsNanifest(long id)
		...
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest = tempDangerousGoodsNanifestPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDangerousGoodsNanifest);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempDangerousGoodsNanifest(
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest)
		throws SystemException {
		tempDangerousGoodsNanifestPersistence.remove(tempDangerousGoodsNanifest);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDangerousGoodsNanifestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDangerousGoodsNanifestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDangerousGoodsNanifest fetchTempDangerousGoodsNanifest(long id)
		throws SystemException {
		return tempDangerousGoodsNanifestPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDangerousGoodsNanifest getTempDangerousGoodsNanifest(long id)
		throws PortalException, SystemException {
		return tempDangerousGoodsNanifestPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDangerousGoodsNanifestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempDangerousGoodsNanifest> getTempDangerousGoodsNanifests(
		int start, int end) throws SystemException {
		return tempDangerousGoodsNanifestPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTempDangerousGoodsNanifestsCount() throws SystemException {
		return tempDangerousGoodsNanifestPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDangerousGoodsNanifest updateTempDangerousGoodsNanifest(
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest)
		throws SystemException {
		return updateTempDangerousGoodsNanifest(tempDangerousGoodsNanifest, true);
	}
	 ...
	 */
	public TempDangerousGoodsNanifest updateTempDangerousGoodsNanifest(
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempDangerousGoodsNanifest",
			tempDangerousGoodsNanifestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempDangerousGoodsNanifest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDangerousGoodsNanifestPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDangerousGoodsNanifestLocalServiceBaseImpl.class);
