...
public class TT8JSONProvider {

	private static Log _log = LogFactoryUtil.getLog(TT8JSONProvider.class);
	...
	public static JSONObject exportPDFDetailThanhPhan(Locale locale, int documentName, int documentYear,
		...
		try {
			...
			long nanoTime = ReportsBusinessUtils.actionExport(requestCode, documentName, documentYear, messageType,
					ChuyenDichTrangThaiUtils.TAU_THUYEN_VAO_CANG);
...
//						}
			...
			resultShow = CheckBusinessUtil.checkRoleDisplayButton(ChuyenDichTrangThaiUtils.TAU_THUYEN_VAO_CANG, messageType, vaiTro, temp, requestCode,
					actionRequest);
