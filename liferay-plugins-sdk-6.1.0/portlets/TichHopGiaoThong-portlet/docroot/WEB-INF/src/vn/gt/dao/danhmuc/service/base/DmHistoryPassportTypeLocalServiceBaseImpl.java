...
/**
 * The base implementation of the dm history passport type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPassportTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryPassportTypeLocalServiceBaseImpl
	implements DmHistoryPassportTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPassportType addDmHistoryPassportType(
		...
		dmHistoryPassportType = dmHistoryPassportTypePersistence.update(dmHistoryPassportType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPassportType);
			}
	...
	public DmHistoryPassportType createDmHistoryPassportType(int id) {
		return dmHistoryPassportTypePersistence.create(id);
	}
	...
	public void deleteDmHistoryPassportType(int id)
		...
		DmHistoryPassportType dmHistoryPassportType = dmHistoryPassportTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPassportType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryPassportTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPassportTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPassportType fetchDmHistoryPassportType(int id)
		throws SystemException {
		return dmHistoryPassportTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPassportType getDmHistoryPassportType(int id)
		throws PortalException, SystemException {
		return dmHistoryPassportTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPassportTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPassportType> getDmHistoryPassportTypes(int start,
		...
		return dmHistoryPassportTypePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPassportTypesCount() throws SystemException {
		return dmHistoryPassportTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPassportType",
			dmHistoryPassportTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPassportType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPassportTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPassportTypeLocalServiceBaseImpl.class);
