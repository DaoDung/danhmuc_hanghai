...
/**
 * The base implementation of the temp passenger details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPassengerDetailsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempPassengerDetailsLocalServiceBaseImpl
	implements TempPassengerDetailsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempPassengerDetailsLocalServiceUtil} to access the temp passenger details local service.
	 */
	 ...
	 */
	public TempPassengerDetails addTempPassengerDetails(
		TempPassengerDetails tempPassengerDetails) throws SystemException {
		tempPassengerDetails.setNew(true);

		tempPassengerDetails = tempPassengerDetailsPersistence.update(tempPassengerDetails,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempPassengerDetails);
			}
	 ...
	 */
	public TempPassengerDetails createTempPassengerDetails(long id) {
		return tempPassengerDetailsPersistence.create(id);
	}
	...
	public void deleteTempPassengerDetails(long id)
		...
		TempPassengerDetails tempPassengerDetails = tempPassengerDetailsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempPassengerDetails);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempPassengerDetails(
		TempPassengerDetails tempPassengerDetails) throws SystemException {
		tempPassengerDetailsPersistence.remove(tempPassengerDetails);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempPassengerDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPassengerDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempPassengerDetails fetchTempPassengerDetails(long id)
		throws SystemException {
		return tempPassengerDetailsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempPassengerDetails getTempPassengerDetails(long id)
		throws PortalException, SystemException {
		return tempPassengerDetailsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempPassengerDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempPassengerDetails> getTempPassengerDetailses(int start,
		int end) throws SystemException {
		return tempPassengerDetailsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTempPassengerDetailsesCount() throws SystemException {
		return tempPassengerDetailsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempPassengerDetails updateTempPassengerDetails(
		TempPassengerDetails tempPassengerDetails) throws SystemException {
		return updateTempPassengerDetails(tempPassengerDetails, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempPassengerDetails",
			tempPassengerDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempPassengerDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempPassengerDetailsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempPassengerDetailsLocalServiceBaseImpl.class);
