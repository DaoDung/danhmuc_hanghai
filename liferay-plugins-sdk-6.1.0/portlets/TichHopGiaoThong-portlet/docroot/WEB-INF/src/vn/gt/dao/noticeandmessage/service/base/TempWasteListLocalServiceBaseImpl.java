...
/**
 * The base implementation of the temp waste list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempWasteListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempWasteListLocalServiceBaseImpl
	implements TempWasteListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempWasteList addTempWasteList(TempWasteList tempWasteList)
		...
		tempWasteList = tempWasteListPersistence.update(tempWasteList, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempWasteList);
			}
	...
	public TempWasteList createTempWasteList(long id) {
		return tempWasteListPersistence.create(id);
	}
	...
	public void deleteTempWasteList(long id)
		...
		TempWasteList tempWasteList = tempWasteListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempWasteList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempWasteList(TempWasteList tempWasteList)
		throws SystemException {
		tempWasteListPersistence.remove(tempWasteList);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempWasteListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempWasteListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempWasteList fetchTempWasteList(long id) throws SystemException {
		return tempWasteListPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempWasteList getTempWasteList(long id)
		throws PortalException, SystemException {
		return tempWasteListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempWasteListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempWasteList> getTempWasteLists(int start, int end)
		throws SystemException {
		return tempWasteListPersistence.findAll(start, end);
	}
	...
	public int getTempWasteListsCount() throws SystemException {
		return tempWasteListPersistence.countAll();
	}
	...
	public TempWasteList updateTempWasteList(TempWasteList tempWasteList,
		...
		tempWasteList = tempWasteListPersistence.update(tempWasteList, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempWasteList",
			tempWasteListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempWasteList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempWasteListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempWasteListLocalServiceBaseImpl.class);
