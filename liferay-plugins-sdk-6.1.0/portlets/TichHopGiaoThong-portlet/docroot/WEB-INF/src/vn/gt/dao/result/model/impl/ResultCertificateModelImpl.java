...
public class ResultCertificateModelImpl extends BaseModelImpl<ResultCertificate>
	...
	public static long CERTIFICATENO_COLUMN_BITMASK = 2L;
	public static long COMMENT_COLUMN_BITMASK = 4L;
	public static long DOCUMENTNAME_COLUMN_BITMASK = 8L;
	public static long DOCUMENTYEAR_COLUMN_BITMASK = 16L;
	public static long MARITIMECODE_COLUMN_BITMASK = 32L;
	...
	public void setCertificateNo(String certificateNo) {
		_columnBitmask |= CERTIFICATENO_COLUMN_BITMASK;

		if (_originalCertificateNo == null) {
			_originalCertificateNo = _certificateNo;
		}
	...
	public String getOriginalCertificateNo() {
		return GetterUtil.getString(_originalCertificateNo);
	}
	...
	public String getOriginalComment() {
		return GetterUtil.getString(_originalComment);
	}
	...
	public Object clone() {
		...
		resultCertificateImpl.setDescription(getDescription());
		resultCertificateImpl.setComment(getComment());
	...
	public void resetOriginalValues() {
		...
		resultCertificateModelImpl._originalCertificateNo = resultCertificateModelImpl._certificateNo;

		resultCertificateModelImpl._originalComment = resultCertificateModelImpl._comment;
	...
	public CacheModel<ResultCertificate> toCacheModel() {
		...
		resultCertificateCacheModel.description = getDescription();

		String description = resultCertificateCacheModel.description;

		if ((description != null) && (description.length() == 0)) {
			resultCertificateCacheModel.description = null;
		}

		resultCertificateCacheModel.comment = getComment();

		String comment = resultCertificateCacheModel.comment;

		if ((comment != null) && (comment.length() == 0)) {
			resultCertificateCacheModel.comment = null;
		}
	...
	private String _originalCertificateNo;
