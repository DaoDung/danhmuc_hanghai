...
/**
 * The base implementation of the temp crew details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCrewDetailsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCrewDetailsLocalServiceBaseImpl
	implements TempCrewDetailsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCrewDetailsLocalServiceUtil} to access the temp crew details local service.
	 */
	 ...
	 */
	public TempCrewDetails addTempCrewDetails(TempCrewDetails tempCrewDetails)
		throws SystemException {
		tempCrewDetails.setNew(true);

		tempCrewDetails = tempCrewDetailsPersistence.update(tempCrewDetails,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempCrewDetails);
			}
	...
	public TempCrewDetails createTempCrewDetails(long id) {
		return tempCrewDetailsPersistence.create(id);
	}
	...
	public void deleteTempCrewDetails(long id)
		...
		TempCrewDetails tempCrewDetails = tempCrewDetailsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCrewDetails);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempCrewDetails(TempCrewDetails tempCrewDetails)
		throws SystemException {
		tempCrewDetailsPersistence.remove(tempCrewDetails);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCrewDetails fetchTempCrewDetails(long id)
		throws SystemException {
		return tempCrewDetailsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewDetails getTempCrewDetails(long id)
		throws PortalException, SystemException {
		return tempCrewDetailsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCrewDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempCrewDetails> getTempCrewDetailses(int start, int end)
		throws SystemException {
		return tempCrewDetailsPersistence.findAll(start, end);
	}
	...
	public int getTempCrewDetailsesCount() throws SystemException {
		return tempCrewDetailsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewDetails updateTempCrewDetails(
		TempCrewDetails tempCrewDetails) throws SystemException {
	 ...
	 */
	public TempCrewDetails updateTempCrewDetails(
		TempCrewDetails tempCrewDetails, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCrewDetails",
			tempCrewDetailsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCrewDetails");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCrewDetailsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCrewDetailsLocalServiceBaseImpl.class);
