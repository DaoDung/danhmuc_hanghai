...
public class TT4TichHopMessageUtils {

	private static Log _log = LogFactoryUtil.getLog(TT4TichHopMessageUtils.class);
		...
		try {
			...
			if (requestCodeDocument != null) {
				...
				if (actionType == PageType.ACTION_TYPE_DUYET) {
					...
					Header header = null;
					header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI, function,
					...
					Header header = null;
					header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI,
	...
	public static boolean message_99_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI, function, MessageType.HO_SO,
	...
	public static boolean message_99_30(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI, function, MessageType.TYPE_THONG_BAO_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_99_31(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI, function, MessageType.TYPE_THONG_BAO_XAC_NHAN_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_10_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.NHAP_CANG_DAU_KHI, function,
