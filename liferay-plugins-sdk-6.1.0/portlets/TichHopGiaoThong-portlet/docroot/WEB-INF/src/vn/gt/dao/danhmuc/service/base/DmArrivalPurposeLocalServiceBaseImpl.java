...
/**
 * The base implementation of the dm arrival purpose local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmArrivalPurposeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmArrivalPurposeLocalServiceBaseImpl
	implements DmArrivalPurposeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmArrivalPurposeLocalServiceUtil} to access the dm arrival purpose local service.
	 */
	 ...
	 */
	public DmArrivalPurpose addDmArrivalPurpose(
		DmArrivalPurpose dmArrivalPurpose) throws SystemException {
		dmArrivalPurpose.setNew(true);

		dmArrivalPurpose = dmArrivalPurposePersistence.update(dmArrivalPurpose,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmArrivalPurpose);
			}
	...
	public DmArrivalPurpose createDmArrivalPurpose(int id) {
		return dmArrivalPurposePersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmArrivalPurpose(int id)
		throws PortalException, SystemException {
		DmArrivalPurpose dmArrivalPurpose = dmArrivalPurposePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmArrivalPurpose);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmArrivalPurpose(DmArrivalPurpose dmArrivalPurpose)
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmArrivalPurposePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmArrivalPurposePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmArrivalPurpose fetchDmArrivalPurpose(int id)
		throws SystemException {
		return dmArrivalPurposePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmArrivalPurpose getDmArrivalPurpose(int id)
		throws PortalException, SystemException {
		return dmArrivalPurposePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmArrivalPurposePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DmArrivalPurpose> getDmArrivalPurposes(int start, int end)
		throws SystemException {
		return dmArrivalPurposePersistence.findAll(start, end);
	}
	...
	public int getDmArrivalPurposesCount() throws SystemException {
		return dmArrivalPurposePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmArrivalPurpose updateDmArrivalPurpose(
		DmArrivalPurpose dmArrivalPurpose) throws SystemException {
	 ...
	 *
	 * @param dmArrivalPurpose the dm arrival purpose
	 * @param merge whether to merge the dm arrival purpose with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm arrival purpose that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmArrivalPurpose updateDmArrivalPurpose(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmArrivalPurpose",
			dmArrivalPurposeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmArrivalPurpose");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmArrivalPurposePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmArrivalPurposeLocalServiceBaseImpl.class);
