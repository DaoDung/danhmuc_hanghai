...
/**
 * The base implementation of the temp maritime payment config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempMaritimePaymentConfigLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempMaritimePaymentConfigLocalServiceBaseImpl
	implements TempMaritimePaymentConfigLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempMaritimePaymentConfig addTempMaritimePaymentConfig(
		...
		tempMaritimePaymentConfig = tempMaritimePaymentConfigPersistence.update(tempMaritimePaymentConfig,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempMaritimePaymentConfig);
			}
	...
	public TempMaritimePaymentConfig createTempMaritimePaymentConfig(long id) {
		return tempMaritimePaymentConfigPersistence.create(id);
	}
	...
	public void deleteTempMaritimePaymentConfig(long id)
		...
		TempMaritimePaymentConfig tempMaritimePaymentConfig = tempMaritimePaymentConfigPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempMaritimePaymentConfig);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempMaritimePaymentConfig(
		TempMaritimePaymentConfig tempMaritimePaymentConfig)
		throws SystemException {
		tempMaritimePaymentConfigPersistence.remove(tempMaritimePaymentConfig);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempMaritimePaymentConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempMaritimePaymentConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempMaritimePaymentConfig fetchTempMaritimePaymentConfig(long id)
		throws SystemException {
		return tempMaritimePaymentConfigPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempMaritimePaymentConfig getTempMaritimePaymentConfig(long id)
		throws PortalException, SystemException {
		return tempMaritimePaymentConfigPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempMaritimePaymentConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempMaritimePaymentConfig> getTempMaritimePaymentConfigs(
		...
		return tempMaritimePaymentConfigPersistence.findAll(start, end);
	}
	...
	public int getTempMaritimePaymentConfigsCount() throws SystemException {
		return tempMaritimePaymentConfigPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempMaritimePaymentConfig",
			tempMaritimePaymentConfigLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempMaritimePaymentConfig");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempMaritimePaymentConfigPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempMaritimePaymentConfigLocalServiceBaseImpl.class);
