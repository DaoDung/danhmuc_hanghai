...
/**
 * The base implementation of the user sign local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.common.service.impl.UserSignLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class UserSignLocalServiceBaseImpl
	implements UserSignLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public UserSign addUserSign(UserSign userSign) throws SystemException {
		...
		userSign = userSignPersistence.update(userSign, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(userSign);
			}
	...
	public UserSign createUserSign(long id) {
		return userSignPersistence.create(id);
	}
	...
	public void deleteUserSign(long id) throws PortalException, SystemException {
		UserSign userSign = userSignPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(userSign);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userSignPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userSignPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return userSignPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSignPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserSign fetchUserSign(long id) throws SystemException {
		return userSignPersistence.fetchByPrimaryKey(id);
	}
	...
	public UserSign getUserSign(long id)
		...
		return userSignPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userSignPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserSign> getUserSigns(int start, int end)
		throws SystemException {
		return userSignPersistence.findAll(start, end);
	}
	...
	public int getUserSignsCount() throws SystemException {
		return userSignPersistence.countAll();
	}
	...
	public UserSign updateUserSign(UserSign userSign, boolean merge)
		...
		userSign = userSignPersistence.update(userSign, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.common.model.UserSign",
			userSignLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.common.model.UserSign");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userSignPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(UserSignLocalServiceBaseImpl.class);
