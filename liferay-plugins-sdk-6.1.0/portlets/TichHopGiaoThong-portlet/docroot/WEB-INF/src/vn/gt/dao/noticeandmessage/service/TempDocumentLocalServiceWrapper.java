...
public class TempDocumentLocalServiceWrapper implements TempDocumentLocalService,
	...
	*/
	...
	public long countTempDocumentCompletionForStatisticsReport(
		...
		java.lang.String dateTo, java.lang.String documentTypeCode,
		java.lang.String requestState, java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentCompletionForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, documentStatusCode);
	}
	...
	public long countTempDocumentJoinIssueAcceptanceForStatisticsReport(
		...
		java.lang.String requestState, java.lang.String issRequestState,
		java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentJoinIssueAcceptanceForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, issRequestState,
			documentStatusCode);
	}
	...
	public long countTempDocumentSignedIssueShiftingOrderForStatisticsReport(
		...
		java.lang.String requestState, java.lang.String issRequestState,
		java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentSignedIssueShiftingOrderForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, issRequestState,
			documentStatusCode);
	}
	...
	public long countTempDocumentSignedIssuePermissionTransitForStatisticsReport(
		...
		java.lang.String requestState, java.lang.String issRequestState,
		java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentSignedIssuePermissionTransitForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, issRequestState,
			documentStatusCode);
	}
	...
	public long countTempDocumentSignedIssuePortClearanceForStatisticsReport(
		...
		java.lang.String requestState, java.lang.String issRequestState,
		java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentSignedIssuePortClearanceForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, issRequestState,
			documentStatusCode);
	}
	...
	public long countTempDocumentSignedIssueAcceptanceForStatisticsReport(
		...
		java.lang.String requestState, java.lang.String issRequestState,
		java.lang.String documentStatusCode) {
		return _tempDocumentLocalService.countTempDocumentSignedIssueAcceptanceForStatisticsReport(maritimeCode,
			dateFrom, dateTo, documentTypeCode, requestState, issRequestState,
			documentStatusCode);
	}
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempDocument> findTempDocumentByKeHoach(
		...
		return _tempDocumentLocalService.findTempDocumentByKeHoach(requestState,
			...
			portRegionCode, mabankhai, stateCode, shipDateFromStart,
			shipDateFromEnd, shipDateToStart, shipDateToEnd, callSign, imo,
			ngayLamThuTucFrom, ngayLamThuTucTo, nameOfShipownersAgents,
			portRegionCodeNext, start, end);
	}
	...
	public vn.gt.dao.noticeandmessage.model.TempDocument fetchByF_B_N_Y_TYPE(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.fetchByF_B_N_Y_TYPE(documentName,
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempDocument> findByTempDocumentByShipNameSMSAndDocumentTypeCode(
		...
		java.lang.String documentTypeCode) {
		return _tempDocumentLocalService.findByTempDocumentByShipNameSMSAndDocumentTypeCode(shipName,
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempDocument> findDanhSachHoSoVanThuChoDongDau(
		...
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.findDanhSachHoSoVanThuChoDongDau(documentTypeCode,
			maritimeCode, portCode, lastPortCode, shipName, stateCode,
			callSign, imo, shipPosition, shipDateFromStart, shipDateFromEnd,
			shipDateToStart, shipDateToEnd, documentStatusCode,
			arrivalShipAgency, nameArrivalShipAgency, departureShipAgency,
	...
	public int countDanhSachHoSoVanThuChoDongDau(
		...
		java.lang.String ngayLamThuTucTo, java.lang.String maBanKhai)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.countDanhSachHoSoVanThuChoDongDau(documentTypeCode,
			maritimeCode, portCode, lastPortCode, shipName, stateCode,
			callSign, imo, shipPosition, shipDateFromStart, shipDateFromEnd,
			shipDateToStart, shipDateToEnd, documentStatusCode,
			arrivalShipAgency, nameArrivalShipAgency, departureShipAgency,
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempDocument> findDanhSachHoSoLanhDaoChoKySo(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.findDanhSachHoSoLanhDaoChoKySo(documentTypeCode,
			maritimeCode, portCode, lastPortCode, shipName, stateCode,
			callSign, imo, shipPosition, shipDateFromStart, shipDateFromEnd,
			shipDateToStart, shipDateToEnd, documentStatusCode,
			arrivalShipAgency, nameArrivalShipAgency, departureShipAgency,
	...
	public int countDanhSachHoSoLanhDaoChoKySo(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.countDanhSachHoSoLanhDaoChoKySo(documentTypeCode,
			maritimeCode, portCode, lastPortCode, shipName, stateCode,
			callSign, imo, shipPosition, shipDateFromStart, shipDateFromEnd,
			shipDateToStart, shipDateToEnd, documentStatusCode,
			arrivalShipAgency, nameArrivalShipAgency, departureShipAgency,
	...
	public long countByF_documentTypeCode_maritimeCode(
		java.lang.String documentTypeCode, java.lang.String maritimeCode) {
		return _tempDocumentLocalService.countByF_documentTypeCode_maritimeCode(documentTypeCode,
			maritimeCode);
	}
	...
	public long countByF_documentTypeCode_maritimeCodeFinder(
		...
		return _tempDocumentLocalService.countByF_documentTypeCode_maritimeCodeFinder(documentTypeCode,
	...
	public java.util.List<vn.gt.dao.result.model.TempDebitNote> findTempDebitNote(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.findTempDebitNote(maritimeCode,
			positionCode, portRegionCode, mabankhai, stateCode, imo,
			markasdelted, lastPortCode, start, end, shipName, callSign);
	}
	...
	public long countTempDebitNote(java.lang.String maritimeCode,
		...
		java.lang.String shipName, java.lang.String callSign)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.countTempDebitNote(maritimeCode,
			positionCode, portRegionCode, mabankhai, stateCode, imo,
			markasdelted, lastPortCode, start, end, shipName, callSign);
	}
	...
	public boolean isValid_ShipAgencyCode_IMO_MaritimeCode(long documentName,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempDocumentLocalService.isValid_ShipAgencyCode_IMO_MaritimeCode(documentName,
