...
/**
 * The base implementation of the dm data item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmDataItemLocalServiceImpl}.
 * </p>
 *
 * @author win_64
...
public abstract class DmDataItemLocalServiceBaseImpl
	implements DmDataItemLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmDataItemLocalServiceUtil} to access the dm data item local service.
	 */
	...
	public DmDataItem addDmDataItem(DmDataItem dmDataItem)
		...
		dmDataItem = dmDataItemPersistence.update(dmDataItem, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmDataItem);
			}
	...
	public void deleteDmDataItem(long Id)
		...
		DmDataItem dmDataItem = dmDataItemPersistence.remove(Id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmDataItem);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmDataItem(DmDataItem dmDataItem)
		throws SystemException {
	 ...
	 *
	 * @param dmDataItem the dm data item
	 * @param merge whether to merge the dm data item with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm data item that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmDataItem updateDmDataItem(DmDataItem dmDataItem, boolean merge)
		throws SystemException {
		dmDataItem.setNew(false);

		dmDataItem = dmDataItemPersistence.update(dmDataItem, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmDataItem",
			dmDataItemLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmDataItem");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(DmDataItemLocalServiceBaseImpl.class);
