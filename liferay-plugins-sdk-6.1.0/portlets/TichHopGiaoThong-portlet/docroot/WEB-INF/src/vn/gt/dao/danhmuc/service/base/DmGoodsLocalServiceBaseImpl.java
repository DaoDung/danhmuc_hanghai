...
/**
 * The base implementation of the dm goods local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmGoodsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGoodsLocalServiceBaseImpl implements DmGoodsLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmGoodsLocalServiceUtil} to access the dm goods local service.
	 */
	 ...
	 */
	public DmGoods addDmGoods(DmGoods dmGoods) throws SystemException {
		dmGoods.setNew(true);

		dmGoods = dmGoodsPersistence.update(dmGoods, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmGoods);
			}
	 ...
	 */
	public DmGoods createDmGoods(int id) {
		return dmGoodsPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmGoods(int id) throws PortalException, SystemException {
		DmGoods dmGoods = dmGoodsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGoods);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmGoods(DmGoods dmGoods) throws SystemException {
		dmGoodsPersistence.remove(dmGoods);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmGoodsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmGoodsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return dmGoodsPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGoodsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGoods fetchDmGoods(int id) throws SystemException {
		return dmGoodsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmGoods getDmGoods(int id) throws PortalException, SystemException {
		return dmGoodsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGoodsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DmGoods> getDmGoodses(int start, int end)
		throws SystemException {
		return dmGoodsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDmGoodsesCount() throws SystemException {
		return dmGoodsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmGoods updateDmGoods(DmGoods dmGoods) throws SystemException {
		return updateDmGoods(dmGoods, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmGoods updateDmGoods(DmGoods dmGoods, boolean merge)
		throws SystemException {
		dmGoods.setNew(false);

		dmGoods = dmGoodsPersistence.update(dmGoods, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmGoods",
			dmGoodsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmGoods");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGoodsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGoodsLocalServiceBaseImpl.class);
