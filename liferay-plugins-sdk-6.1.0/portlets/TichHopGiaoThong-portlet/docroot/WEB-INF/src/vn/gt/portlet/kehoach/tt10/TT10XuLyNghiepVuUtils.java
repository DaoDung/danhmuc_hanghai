...
public class TT10XuLyNghiepVuUtils {
	...
	public static int doActionHoSo(long documentName, int documentYear, int actionType, int orginStatus, int orginDocumentStatusCode, int desStatus, User user,
		...
		try {
			...
			if (desStatus == ChuyenDichTrangThaiUtils.KE_HOACH_CHO_CAP_LENH_DIEU_DONG) {
				...
				TT10TichHopMessageUtils.message_99_21(user.getEmailAddress(), uploadPortletRequest, actionRequest,
				...
				boolean resultMethod = TT10TichHopMessageUtils.message_99_22(user.getEmailAddress(),
				...
				if (desStatus == TrangThaiBanKhaiNhapCanh.CHO_TIEP_NHAN
					...
					boolean resultMethod = TT10TichHopMessageUtils.message_99_27(user.getEmailAddress(),
							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT10TichHopMessageUtils.message_99_28(user.getEmailAddress(),
						uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT10TichHopMessageUtils.message_99_24(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT10TichHopMessageUtils.message_99_25(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				TT10TichHopMessageUtils.message_99_23(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
