...
/**
 * The persistence utility for the crew list service. This utility wraps {@link CrewListPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CrewListUtil {
	 ...
	 */
	public static void clearCache(CrewList crewList) {
		getPersistence().clearCache(crewList);
	}
	 ...
	 */
	public static List<CrewList> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<CrewList> findWithDynamicQuery(
	...
	public static CrewList update(CrewList crewList, boolean merge)
		throws SystemException {
		return getPersistence().update(crewList, merge);
	}
	...
	public static CrewList update(CrewList crewList, boolean merge,
		...
		return getPersistence().update(crewList, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(vn.gt.dao.nhapcanh.model.CrewList crewList) {
		getPersistence().cacheResult(crewList);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(crewLists);
	}
	...
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList create(long id) {
	...
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.gt.dao.nhapcanh.NoSuchCrewListException {
		return getPersistence().remove(id);
	}

	public static vn.gt.dao.nhapcanh.model.CrewList updateImpl(
		vn.gt.dao.nhapcanh.model.CrewList crewList, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(crewList, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList findByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.gt.dao.nhapcanh.NoSuchCrewListException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList fetchByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.nhapcanh.model.CrewList> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CrewListPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CrewListPersistence)PortletBeanLocatorUtil.locate(vn.gt.dao.nhapcanh.service.ClpSerializer.getServletContextName(),
					CrewListPersistence.class.getName());

			ReferenceRegistry.registerReference(CrewListUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(CrewListPersistence persistence) {
		_persistence = persistence;

		ReferenceRegistry.registerReference(CrewListUtil.class, "_persistence");
	}

	private static CrewListPersistence _persistence;
}