...
/**
 * The base implementation of the dm history rank rating local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryRankRatingLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryRankRatingLocalServiceBaseImpl
	implements DmHistoryRankRatingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryRankRating addDmHistoryRankRating(
		...
		dmHistoryRankRating = dmHistoryRankRatingPersistence.update(dmHistoryRankRating,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryRankRating);
			}
	...
	public DmHistoryRankRating createDmHistoryRankRating(int id) {
		return dmHistoryRankRatingPersistence.create(id);
	}
	...
	public void deleteDmHistoryRankRating(int id)
		...
		DmHistoryRankRating dmHistoryRankRating = dmHistoryRankRatingPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryRankRating);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryRankRatingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryRankRatingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryRankRating fetchDmHistoryRankRating(int id)
		throws SystemException {
		return dmHistoryRankRatingPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryRankRating getDmHistoryRankRating(int id)
		throws PortalException, SystemException {
		return dmHistoryRankRatingPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryRankRatingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryRankRating> getDmHistoryRankRatings(int start, int end)
		throws SystemException {
		return dmHistoryRankRatingPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryRankRatingsCount() throws SystemException {
		return dmHistoryRankRatingPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryRankRating",
			dmHistoryRankRatingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryRankRating");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryRankRatingPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryRankRatingLocalServiceBaseImpl.class);
