 ...
 * @generated
 */
public class DmHistoryPortHarbourSoap implements Serializable {
	public static DmHistoryPortHarbourSoap toSoapModel(
		DmHistoryPortHarbour model) {
		DmHistoryPortHarbourSoap soapModel = new DmHistoryPortHarbourSoap();
		...
		soapModel.setPortRegion(model.getPortRegion());
	...
	public static DmHistoryPortHarbourSoap[] toSoapModels(
		DmHistoryPortHarbour[] models) {
		DmHistoryPortHarbourSoap[] soapModels = new DmHistoryPortHarbourSoap[models.length];
	...
	public static DmHistoryPortHarbourSoap[][] toSoapModels(
		DmHistoryPortHarbour[][] models) {
		DmHistoryPortHarbourSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmHistoryPortHarbourSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmHistoryPortHarbourSoap[0][0];
		}
	...
	public static DmHistoryPortHarbourSoap[] toSoapModels(
		List<DmHistoryPortHarbour> models) {
		List<DmHistoryPortHarbourSoap> soapModels = new ArrayList<DmHistoryPortHarbourSoap>(models.size());

		for (DmHistoryPortHarbour model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmHistoryPortHarbourSoap[soapModels.size()]);
	}

	public DmHistoryPortHarbourSoap() {
	}
