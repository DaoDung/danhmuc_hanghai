...
public class DmPortHarbourModelImpl extends BaseModelImpl<DmPortHarbour>
	...
	public static long PORTREGION_COLUMN_BITMASK = 2L;
	public static long PORTREGIONCODE_COLUMN_BITMASK = 4L;
	...
	public void setPortRegion(String portRegion) {
		_columnBitmask |= PORTREGION_COLUMN_BITMASK;

		if (_originalPortRegion == null) {
			_originalPortRegion = _portRegion;
		}

		_portRegion = portRegion;
	}

	public String getOriginalPortRegion() {
		return GetterUtil.getString(_originalPortRegion);
	}
	...
	public Object clone() {
		...
		dmPortHarbourImpl.setPortRegion(getPortRegion());
	...
	public void resetOriginalValues() {
		...
		dmPortHarbourModelImpl._originalPortRegion = dmPortHarbourModelImpl._portRegion;
	...
	public CacheModel<DmPortHarbour> toCacheModel() {
		...
		dmPortHarbourCacheModel.portRegion = getPortRegion();

		String portRegion = dmPortHarbourCacheModel.portRegion;

		if ((portRegion != null) && (portRegion.length() == 0)) {
			dmPortHarbourCacheModel.portRegion = null;
		}
	...
	private String _originalPortRegion;
