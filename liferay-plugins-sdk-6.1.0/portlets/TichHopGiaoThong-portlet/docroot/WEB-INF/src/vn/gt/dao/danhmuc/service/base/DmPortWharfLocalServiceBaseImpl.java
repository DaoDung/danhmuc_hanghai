...
/**
 * The base implementation of the dm port wharf local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPortWharfLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPortWharfLocalServiceBaseImpl
	implements DmPortWharfLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmPortWharf addDmPortWharf(DmPortWharf dmPortWharf)
		...
		dmPortWharf = dmPortWharfPersistence.update(dmPortWharf, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPortWharf);
			}
	...
	public DmPortWharf createDmPortWharf(int id) {
		return dmPortWharfPersistence.create(id);
	}
	...
	public void deleteDmPortWharf(int id)
		...
		DmPortWharf dmPortWharf = dmPortWharfPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPortWharf);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortWharfPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmPortWharfPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortWharfPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPortWharf fetchDmPortWharf(int id) throws SystemException {
		return dmPortWharfPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPortWharf getDmPortWharf(int id)
		throws PortalException, SystemException {
		return dmPortWharfPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPortWharfPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmPortWharf> getDmPortWharfs(int start, int end)
		throws SystemException {
		return dmPortWharfPersistence.findAll(start, end);
	}
	...
	public int getDmPortWharfsCount() throws SystemException {
		return dmPortWharfPersistence.countAll();
	}
	...
	public DmPortWharf updateDmPortWharf(DmPortWharf dmPortWharf, boolean merge)
		...
		dmPortWharf = dmPortWharfPersistence.update(dmPortWharf, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPortWharf",
			dmPortWharfLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPortWharf");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPortWharfPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPortWharfLocalServiceBaseImpl.class);
