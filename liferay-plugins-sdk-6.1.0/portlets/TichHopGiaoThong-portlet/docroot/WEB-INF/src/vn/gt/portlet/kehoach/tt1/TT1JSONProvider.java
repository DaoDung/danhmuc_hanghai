...
//			objectChilds.put("type", "DanhSachKeHoachTauDiChuyen");
//			objectChilds.put("counter", "_ _");
//			childs.put(objectChilds);
//			object.put("items", childs);
//			
	...
	public static JSONObject exportPDFDetailThanhPhan(Locale locale, int documentName, int documentYear,
		...
		try {
			...
			long nanoTime = ReportsBusinessUtils.actionExport(requestCode, documentName, documentYear, messageType,
					ChuyenDichTrangThaiUtils.TAU_THUYEN_NHAP_CANH);
			...
			if (messageType == MessageType.BAN_KHAI_AN_NINH_TAU_BIEN) {
				...
				if ( Validator.isNotNull(issuePortClearance)){
					...
					// lay lai tempdocument tiwf issuePortClearance
...
//						}
			...
			resultShow = CheckBusinessUtil.checkRoleDisplayButton(ChuyenDichTrangThaiUtils.TAU_THUYEN_NHAP_CANH, messageType, vaiTro, temp, requestCode,
					actionRequest);
