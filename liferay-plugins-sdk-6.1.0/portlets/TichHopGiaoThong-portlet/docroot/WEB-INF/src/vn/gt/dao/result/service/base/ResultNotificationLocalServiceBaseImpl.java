...
/**
 * The base implementation of the result notification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultNotificationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ResultNotificationLocalServiceBaseImpl
	implements ResultNotificationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public ResultNotification addResultNotification(
		...
		resultNotification = resultNotificationPersistence.update(resultNotification,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(resultNotification);
			}
	...
	public ResultNotification createResultNotification(long id) {
		return resultNotificationPersistence.create(id);
	}
	...
	public void deleteResultNotification(long id)
		...
		ResultNotification resultNotification = resultNotificationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resultNotification);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultNotificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultNotificationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ResultNotification fetchResultNotification(long id)
		throws SystemException {
		return resultNotificationPersistence.fetchByPrimaryKey(id);
	}
	...
	public ResultNotification getResultNotification(long id)
		throws PortalException, SystemException {
		return resultNotificationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return resultNotificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ResultNotification> getResultNotifications(int start, int end)
		throws SystemException {
		return resultNotificationPersistence.findAll(start, end);
	}
	...
	public int getResultNotificationsCount() throws SystemException {
		return resultNotificationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.ResultNotification",
			resultNotificationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.ResultNotification");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(ResultNotificationLocalServiceBaseImpl.class);
