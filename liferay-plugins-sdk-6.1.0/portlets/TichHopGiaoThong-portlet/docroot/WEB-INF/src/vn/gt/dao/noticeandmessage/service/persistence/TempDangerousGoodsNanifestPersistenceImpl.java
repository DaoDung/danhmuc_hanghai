...
import vn.gt.dao.noticeandmessage.NoSuchTempDangerousGoodsNanifestException;
...
import vn.gt.dao.noticeandmessage.model.impl.TempDangerousGoodsNanifestModelImpl;
...
public class TempDangerousGoodsNanifestPersistenceImpl
	...
	protected TempDangerousGoodsNanifest removeImpl(
		...
		try {
			...
			BatchSessionUtil.delete(session, tempDangerousGoodsNanifest);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public TempDangerousGoodsNanifest updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, tempDangerousGoodsNanifest, merge);
		...
		if (isNew ||
			...
			if ((tempDangerousGoodsNanifestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempDangerousGoodsNanifestModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getOriginalDocumentYear())
					};
				...
				args = new Object[] {
						Long.valueOf(tempDangerousGoodsNanifestModelImpl.getDocumentName()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getDocumentYear())
					};
			...
			if ((tempDangerousGoodsNanifestModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						Long.valueOf(tempDangerousGoodsNanifestModelImpl.getOriginalDocumentName()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getOriginalDocumentYear()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getOriginalRequestState())
					};
				...
				args = new Object[] {
						Long.valueOf(tempDangerousGoodsNanifestModelImpl.getDocumentName()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getDocumentYear()),
						Integer.valueOf(tempDangerousGoodsNanifestModelImpl.getRequestState())
					};
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a temp dangerous goods nanifest with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	...
	public TempDangerousGoodsNanifest findByPrimaryKey(long id)
		throws NoSuchTempDangerousGoodsNanifestException, SystemException {
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest = fetchByPrimaryKey(id);
	...
	public TempDangerousGoodsNanifest fetchByPrimaryKey(long id)
		...
		TempDangerousGoodsNanifest tempDangerousGoodsNanifest = (TempDangerousGoodsNanifest)EntityCacheUtil.getResult(TempDangerousGoodsNanifestModelImpl.ENTITY_CACHE_ENABLED,
				TempDangerousGoodsNanifestImpl.class, id);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.gt.dao.noticeandmessage.model.TempDangerousGoodsNanifest")));
