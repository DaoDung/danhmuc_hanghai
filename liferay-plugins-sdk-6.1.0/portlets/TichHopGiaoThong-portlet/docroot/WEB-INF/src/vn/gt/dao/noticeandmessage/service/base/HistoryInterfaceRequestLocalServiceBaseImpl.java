...
/**
 * The base implementation of the history interface request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.HistoryInterfaceRequestLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class HistoryInterfaceRequestLocalServiceBaseImpl
	implements HistoryInterfaceRequestLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.HistoryInterfaceRequestLocalServiceUtil} to access the history interface request local service.
	 */
	 ...
	 */
	public HistoryInterfaceRequest addHistoryInterfaceRequest(
		HistoryInterfaceRequest historyInterfaceRequest)
		throws SystemException {
		historyInterfaceRequest.setNew(true);

		historyInterfaceRequest = historyInterfaceRequestPersistence.update(historyInterfaceRequest,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(historyInterfaceRequest);
			}
	...
	public HistoryInterfaceRequest createHistoryInterfaceRequest(long id) {
		return historyInterfaceRequestPersistence.create(id);
	}
	...
	public void deleteHistoryInterfaceRequest(long id)
		...
		HistoryInterfaceRequest historyInterfaceRequest = historyInterfaceRequestPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(historyInterfaceRequest);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteHistoryInterfaceRequest(
		HistoryInterfaceRequest historyInterfaceRequest)
		throws SystemException {
		historyInterfaceRequestPersistence.remove(historyInterfaceRequest);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyInterfaceRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyInterfaceRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public HistoryInterfaceRequest fetchHistoryInterfaceRequest(long id)
		throws SystemException {
		return historyInterfaceRequestPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryInterfaceRequest getHistoryInterfaceRequest(long id)
		throws PortalException, SystemException {
		return historyInterfaceRequestPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return historyInterfaceRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HistoryInterfaceRequest> getHistoryInterfaceRequests(
		int start, int end) throws SystemException {
		return historyInterfaceRequestPersistence.findAll(start, end);
	}
	...
	public int getHistoryInterfaceRequestsCount() throws SystemException {
		return historyInterfaceRequestPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryInterfaceRequest updateHistoryInterfaceRequest(
		HistoryInterfaceRequest historyInterfaceRequest)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.HistoryInterfaceRequest",
			historyInterfaceRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.HistoryInterfaceRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = historyInterfaceRequestPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HistoryInterfaceRequestLocalServiceBaseImpl.class);
