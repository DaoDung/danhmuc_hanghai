...
/**
 * The interface for the temp cargo items local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see TempCargoItemsLocalServiceUtil
...
public interface TempCargoItemsLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TempCargoItemsLocalServiceUtil} to access the temp cargo items local service. Add custom service methods to {@link vn.gt.dao.noticeandmessage.service.impl.TempCargoItemsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
