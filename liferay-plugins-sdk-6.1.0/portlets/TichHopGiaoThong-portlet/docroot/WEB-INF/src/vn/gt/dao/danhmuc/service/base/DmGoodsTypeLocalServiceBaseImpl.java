...
/**
 * The base implementation of the dm goods type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmGoodsTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGoodsTypeLocalServiceBaseImpl
	implements DmGoodsTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGoodsType addDmGoodsType(DmGoodsType dmGoodsType)
		...
		dmGoodsType = dmGoodsTypePersistence.update(dmGoodsType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmGoodsType);
			}
	...
	public DmGoodsType createDmGoodsType(int id) {
		return dmGoodsTypePersistence.create(id);
	}
	...
	public void deleteDmGoodsType(int id)
		...
		DmGoodsType dmGoodsType = dmGoodsTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGoodsType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGoodsTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmGoodsTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGoodsTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGoodsType fetchDmGoodsType(int id) throws SystemException {
		return dmGoodsTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGoodsType getDmGoodsType(int id)
		throws PortalException, SystemException {
		return dmGoodsTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGoodsTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGoodsType> getDmGoodsTypes(int start, int end)
		throws SystemException {
		return dmGoodsTypePersistence.findAll(start, end);
	}
	...
	public int getDmGoodsTypesCount() throws SystemException {
		return dmGoodsTypePersistence.countAll();
	}
	...
	public DmGoodsType updateDmGoodsType(DmGoodsType dmGoodsType, boolean merge)
		...
		dmGoodsType = dmGoodsTypePersistence.update(dmGoodsType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmGoodsType",
			dmGoodsTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmGoodsType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGoodsTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGoodsTypeLocalServiceBaseImpl.class);
