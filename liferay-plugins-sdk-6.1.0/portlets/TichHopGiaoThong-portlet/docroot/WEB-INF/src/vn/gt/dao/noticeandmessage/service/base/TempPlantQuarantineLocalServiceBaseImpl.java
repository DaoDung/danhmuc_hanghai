...
/**
 * The base implementation of the temp plant quarantine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPlantQuarantineLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempPlantQuarantineLocalServiceBaseImpl
	implements TempPlantQuarantineLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempPlantQuarantine addTempPlantQuarantine(
		...
		tempPlantQuarantine = tempPlantQuarantinePersistence.update(tempPlantQuarantine,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempPlantQuarantine);
			}
	...
	public TempPlantQuarantine createTempPlantQuarantine(long id) {
		return tempPlantQuarantinePersistence.create(id);
	}
	...
	public void deleteTempPlantQuarantine(long id)
		...
		TempPlantQuarantine tempPlantQuarantine = tempPlantQuarantinePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempPlantQuarantine);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempPlantQuarantine(
		TempPlantQuarantine tempPlantQuarantine) throws SystemException {
		tempPlantQuarantinePersistence.remove(tempPlantQuarantine);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempPlantQuarantinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPlantQuarantinePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempPlantQuarantine fetchTempPlantQuarantine(long id)
		throws SystemException {
		return tempPlantQuarantinePersistence.fetchByPrimaryKey(id);
	}
	...
	public TempPlantQuarantine getTempPlantQuarantine(long id)
		throws PortalException, SystemException {
		return tempPlantQuarantinePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempPlantQuarantinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempPlantQuarantine> getTempPlantQuarantines(int start, int end)
		throws SystemException {
		return tempPlantQuarantinePersistence.findAll(start, end);
	}
	...
	public int getTempPlantQuarantinesCount() throws SystemException {
		return tempPlantQuarantinePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempPlantQuarantine",
			tempPlantQuarantineLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempPlantQuarantine");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempPlantQuarantinePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempPlantQuarantineLocalServiceBaseImpl.class);
