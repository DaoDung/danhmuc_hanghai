...
/**
 * The base implementation of the dm history ship type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryShipTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryShipTypeLocalServiceBaseImpl
	implements DmHistoryShipTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryShipType addDmHistoryShipType(
		...
		dmHistoryShipType = dmHistoryShipTypePersistence.update(dmHistoryShipType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryShipType);
			}
	...
	public DmHistoryShipType createDmHistoryShipType(int id) {
		return dmHistoryShipTypePersistence.create(id);
	}
	...
	public void deleteDmHistoryShipType(int id)
		...
		DmHistoryShipType dmHistoryShipType = dmHistoryShipTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryShipType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryShipTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryShipTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryShipType fetchDmHistoryShipType(int id)
		throws SystemException {
		return dmHistoryShipTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryShipType getDmHistoryShipType(int id)
		throws PortalException, SystemException {
		return dmHistoryShipTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryShipTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryShipType> getDmHistoryShipTypes(int start, int end)
		throws SystemException {
		return dmHistoryShipTypePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryShipTypesCount() throws SystemException {
		return dmHistoryShipTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryShipType",
			dmHistoryShipTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryShipType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryShipTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryShipTypeLocalServiceBaseImpl.class);
