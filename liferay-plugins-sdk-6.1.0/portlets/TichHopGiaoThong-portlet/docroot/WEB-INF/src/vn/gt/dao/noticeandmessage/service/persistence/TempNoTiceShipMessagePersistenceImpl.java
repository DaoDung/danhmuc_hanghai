...
public class TempNoTiceShipMessagePersistenceImpl extends BasePersistenceImpl<TempNoTiceShipMessage>
	...
	protected TempNoTiceShipMessage toUnwrappedModel(
		...
		tempNoTiceShipMessageImpl.setDocumentReference(tempNoTiceShipMessage.getDocumentReference());
		tempNoTiceShipMessageImpl.setIsArrival(tempNoTiceShipMessage.getIsArrival());
		tempNoTiceShipMessageImpl.setVoyageNumber(tempNoTiceShipMessage.getVoyageNumber());
		tempNoTiceShipMessageImpl.setNetTonnage(tempNoTiceShipMessage.getNetTonnage());
		tempNoTiceShipMessageImpl.setNetTonnageUnit(tempNoTiceShipMessage.getNetTonnageUnit());
		tempNoTiceShipMessageImpl.setPositionOfShipInPort(tempNoTiceShipMessage.getPositionOfShipInPort());
		tempNoTiceShipMessageImpl.setBriefParticularsOfVoyage(tempNoTiceShipMessage.getBriefParticularsOfVoyage());
		tempNoTiceShipMessageImpl.setPreviousPortsOfCall(tempNoTiceShipMessage.getPreviousPortsOfCall());
		tempNoTiceShipMessageImpl.setSubsequentPortsOfCall(tempNoTiceShipMessage.getSubsequentPortsOfCall());
		tempNoTiceShipMessageImpl.setDischargedPorts(tempNoTiceShipMessage.getDischargedPorts());
		tempNoTiceShipMessageImpl.setRemainingCargo(tempNoTiceShipMessage.getRemainingCargo());
		tempNoTiceShipMessageImpl.setShipRequirementsInTermsOfWaste(tempNoTiceShipMessage.getShipRequirementsInTermsOfWaste());
		tempNoTiceShipMessageImpl.setNumberCargoDeclaration(tempNoTiceShipMessage.getNumberCargoDeclaration());
		tempNoTiceShipMessageImpl.setNumberShipStoreDeclaration(tempNoTiceShipMessage.getNumberShipStoreDeclaration());
		tempNoTiceShipMessageImpl.setNumberCrewList(tempNoTiceShipMessage.getNumberCrewList());
		tempNoTiceShipMessageImpl.setNumberPassengerList(tempNoTiceShipMessage.getNumberPassengerList());
		tempNoTiceShipMessageImpl.setNumberCrewEffectsDeclaration(tempNoTiceShipMessage.getNumberCrewEffectsDeclaration());
		tempNoTiceShipMessageImpl.setNumberHealthMaritimeDeclaration(tempNoTiceShipMessage.getNumberHealthMaritimeDeclaration());
		tempNoTiceShipMessageImpl.setPortClearanceNo(tempNoTiceShipMessage.getPortClearanceNo());
		tempNoTiceShipMessageImpl.setTimeOfPORTArrival(tempNoTiceShipMessage.getTimeOfPORTArrival());
		tempNoTiceShipMessageImpl.setTimeOfPilotOnBoard(tempNoTiceShipMessage.getTimeOfPilotOnBoard());
		tempNoTiceShipMessageImpl.setTugBoat(tempNoTiceShipMessage.getTugBoat());
		tempNoTiceShipMessageImpl.setDo_(tempNoTiceShipMessage.getDo_());
		tempNoTiceShipMessageImpl.setFo(tempNoTiceShipMessage.getFo());
		tempNoTiceShipMessageImpl.setFw(tempNoTiceShipMessage.getFw());
		tempNoTiceShipMessageImpl.setPlaceOfReception(tempNoTiceShipMessage.getPlaceOfReception());
