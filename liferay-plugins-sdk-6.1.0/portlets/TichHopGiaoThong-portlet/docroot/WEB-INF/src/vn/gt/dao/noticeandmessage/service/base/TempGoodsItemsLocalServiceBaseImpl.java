...
/**
 * The base implementation of the temp goods items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempGoodsItemsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempGoodsItemsLocalServiceBaseImpl
	implements TempGoodsItemsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempGoodsItems addTempGoodsItems(TempGoodsItems tempGoodsItems)
		...
		tempGoodsItems = tempGoodsItemsPersistence.update(tempGoodsItems, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempGoodsItems);
			}
	...
	public TempGoodsItems createTempGoodsItems(long id) {
		return tempGoodsItemsPersistence.create(id);
	}
	...
	public void deleteTempGoodsItems(long id)
		...
		TempGoodsItems tempGoodsItems = tempGoodsItemsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempGoodsItems);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempGoodsItems(TempGoodsItems tempGoodsItems)
		throws SystemException {
		tempGoodsItemsPersistence.remove(tempGoodsItems);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempGoodsItemsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempGoodsItemsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempGoodsItems fetchTempGoodsItems(long id)
		throws SystemException {
		return tempGoodsItemsPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempGoodsItems getTempGoodsItems(long id)
		throws PortalException, SystemException {
		return tempGoodsItemsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempGoodsItemsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempGoodsItems> getTempGoodsItemses(int start, int end)
		throws SystemException {
		return tempGoodsItemsPersistence.findAll(start, end);
	}
	...
	public int getTempGoodsItemsesCount() throws SystemException {
		return tempGoodsItemsPersistence.countAll();
	}
	 ...
	 *
	 * @param tempGoodsItems the temp goods items
	 * @param merge whether to merge the temp goods items with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the temp goods items that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public TempGoodsItems updateTempGoodsItems(TempGoodsItems tempGoodsItems,
		...
		tempGoodsItems = tempGoodsItemsPersistence.update(tempGoodsItems, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempGoodsItems",
			tempGoodsItemsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempGoodsItems");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempGoodsItemsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempGoodsItemsLocalServiceBaseImpl.class);
