...
/**
 * The base implementation of the history rmdc ship local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.HistoryRmdcShipLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.HistoryRmdcShipLocalServiceImpl
 * @see vn.gt.dao.danhmuc.service.HistoryRmdcShipLocalServiceUtil
 * @generated
 */
public abstract class HistoryRmdcShipLocalServiceBaseImpl
	implements HistoryRmdcShipLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.HistoryRmdcShipLocalServiceUtil} to access the history rmdc ship local service.
	 */
	 ...
	 */
	public HistoryRmdcShip addHistoryRmdcShip(HistoryRmdcShip historyRmdcShip)
		throws SystemException {
		historyRmdcShip.setNew(true);

		historyRmdcShip = historyRmdcShipPersistence.update(historyRmdcShip,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(historyRmdcShip);
			}
	 ...
	 */
	public HistoryRmdcShip createHistoryRmdcShip(long id) {
		return historyRmdcShipPersistence.create(id);
	}
	...
	public void deleteHistoryRmdcShip(long id)
		...
		HistoryRmdcShip historyRmdcShip = historyRmdcShipPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(historyRmdcShip);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteHistoryRmdcShip(HistoryRmdcShip historyRmdcShip)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyRmdcShipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return historyRmdcShipPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public HistoryRmdcShip fetchHistoryRmdcShip(long id)
		throws SystemException {
		return historyRmdcShipPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryRmdcShip getHistoryRmdcShip(long id)
		throws PortalException, SystemException {
		return historyRmdcShipPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return historyRmdcShipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<HistoryRmdcShip> getHistoryRmdcShips(int start, int end)
		throws SystemException {
		return historyRmdcShipPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getHistoryRmdcShipsCount() throws SystemException {
		return historyRmdcShipPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public HistoryRmdcShip updateHistoryRmdcShip(
		HistoryRmdcShip historyRmdcShip) throws SystemException {
		return updateHistoryRmdcShip(historyRmdcShip, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.HistoryRmdcShip",
			historyRmdcShipLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.HistoryRmdcShip");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = historyRmdcShipPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HistoryRmdcShipLocalServiceBaseImpl.class);
