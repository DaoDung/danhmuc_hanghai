...
/**
 * The base implementation of the temp debit note local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.TempDebitNoteLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDebitNoteLocalServiceBaseImpl
	implements TempDebitNoteLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempDebitNote addTempDebitNote(TempDebitNote tempDebitNote)
		...
		tempDebitNote = tempDebitNotePersistence.update(tempDebitNote, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempDebitNote);
			}
	...
	public TempDebitNote createTempDebitNote(long id) {
		return tempDebitNotePersistence.create(id);
	}
	...
	public void deleteTempDebitNote(long id)
		...
		TempDebitNote tempDebitNote = tempDebitNotePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDebitNote);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDebitNotePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDebitNotePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDebitNote fetchTempDebitNote(long id) throws SystemException {
		return tempDebitNotePersistence.fetchByPrimaryKey(id);
	}
	...
	public TempDebitNote getTempDebitNote(long id)
		throws PortalException, SystemException {
		return tempDebitNotePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDebitNotePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempDebitNote> getTempDebitNotes(int start, int end)
		throws SystemException {
		return tempDebitNotePersistence.findAll(start, end);
	}
	...
	public int getTempDebitNotesCount() throws SystemException {
		return tempDebitNotePersistence.countAll();
	}
	...
	public TempDebitNote updateTempDebitNote(TempDebitNote tempDebitNote,
		...
		tempDebitNote = tempDebitNotePersistence.update(tempDebitNote, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.TempDebitNote",
			tempDebitNoteLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.TempDebitNote");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDebitNotePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDebitNoteLocalServiceBaseImpl.class);
