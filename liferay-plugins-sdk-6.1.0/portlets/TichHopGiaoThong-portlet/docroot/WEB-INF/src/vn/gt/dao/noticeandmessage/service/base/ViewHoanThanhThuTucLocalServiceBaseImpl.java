...
/**
 * The base implementation of the view hoan thanh thu tuc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.ViewHoanThanhThuTucLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ViewHoanThanhThuTucLocalServiceBaseImpl
	implements ViewHoanThanhThuTucLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.ViewHoanThanhThuTucLocalServiceUtil} to access the view hoan thanh thu tuc local service.
	 */
	 ...
	 */
	public ViewHoanThanhThuTuc addViewHoanThanhThuTuc(
		ViewHoanThanhThuTuc viewHoanThanhThuTuc) throws SystemException {
		viewHoanThanhThuTuc.setNew(true);

		viewHoanThanhThuTuc = viewHoanThanhThuTucPersistence.update(viewHoanThanhThuTuc,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(viewHoanThanhThuTuc);
			}
	 ...
	 */
	public ViewHoanThanhThuTuc createViewHoanThanhThuTuc(String CVHH) {
		return viewHoanThanhThuTucPersistence.create(CVHH);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteViewHoanThanhThuTuc(String CVHH)
		throws PortalException, SystemException {
		ViewHoanThanhThuTuc viewHoanThanhThuTuc = viewHoanThanhThuTucPersistence.remove(CVHH);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(viewHoanThanhThuTuc);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteViewHoanThanhThuTuc(
		ViewHoanThanhThuTuc viewHoanThanhThuTuc) throws SystemException {
		viewHoanThanhThuTucPersistence.remove(viewHoanThanhThuTuc);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return viewHoanThanhThuTucPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return viewHoanThanhThuTucPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ViewHoanThanhThuTuc fetchViewHoanThanhThuTuc(String CVHH)
		throws SystemException {
		return viewHoanThanhThuTucPersistence.fetchByPrimaryKey(CVHH);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViewHoanThanhThuTuc getViewHoanThanhThuTuc(String CVHH)
		throws PortalException, SystemException {
		return viewHoanThanhThuTucPersistence.findByPrimaryKey(CVHH);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return viewHoanThanhThuTucPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ViewHoanThanhThuTuc> getViewHoanThanhThuTucs(int start, int end)
		throws SystemException {
		return viewHoanThanhThuTucPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getViewHoanThanhThuTucsCount() throws SystemException {
		return viewHoanThanhThuTucPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ViewHoanThanhThuTuc updateViewHoanThanhThuTuc(
		ViewHoanThanhThuTuc viewHoanThanhThuTuc) throws SystemException {
		return updateViewHoanThanhThuTuc(viewHoanThanhThuTuc, true);
	}
	 ...
	 */
	public ViewHoanThanhThuTuc updateViewHoanThanhThuTuc(
		ViewHoanThanhThuTuc viewHoanThanhThuTuc, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.ViewHoanThanhThuTuc",
			viewHoanThanhThuTucLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.ViewHoanThanhThuTuc");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = viewHoanThanhThuTucPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ViewHoanThanhThuTucLocalServiceBaseImpl.class);
