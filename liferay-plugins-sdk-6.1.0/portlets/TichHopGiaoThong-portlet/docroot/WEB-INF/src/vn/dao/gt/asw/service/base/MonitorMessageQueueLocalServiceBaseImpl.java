...
/**
 * The base implementation of the monitor message queue local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dao.gt.asw.service.impl.MonitorMessageQueueLocalServiceImpl}.
 * </p>
 *
 * @author win 64
 * @see vn.dao.gt.asw.service.impl.MonitorMessageQueueLocalServiceImpl
 * @see vn.dao.gt.asw.service.MonitorMessageQueueLocalServiceUtil
 * @generated
 */
public abstract class MonitorMessageQueueLocalServiceBaseImpl
	implements MonitorMessageQueueLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dao.gt.asw.service.MonitorMessageQueueLocalServiceUtil} to access the monitor message queue local service.
	 */
	 ...
	 */
	public MonitorMessageQueue addMonitorMessageQueue(
		MonitorMessageQueue monitorMessageQueue) throws SystemException {
		monitorMessageQueue.setNew(true);

		monitorMessageQueue = monitorMessageQueuePersistence.update(monitorMessageQueue,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(monitorMessageQueue);
			}
	 ...
	 */
	public MonitorMessageQueue createMonitorMessageQueue(long id) {
		return monitorMessageQueuePersistence.create(id);
	}
	...
	public void deleteMonitorMessageQueue(long id)
		...
		MonitorMessageQueue monitorMessageQueue = monitorMessageQueuePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(monitorMessageQueue);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteMonitorMessageQueue(
		MonitorMessageQueue monitorMessageQueue) throws SystemException {
		monitorMessageQueuePersistence.remove(monitorMessageQueue);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return monitorMessageQueuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return monitorMessageQueuePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public MonitorMessageQueue fetchMonitorMessageQueue(long id)
		throws SystemException {
		return monitorMessageQueuePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MonitorMessageQueue getMonitorMessageQueue(long id)
		throws PortalException, SystemException {
		return monitorMessageQueuePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return monitorMessageQueuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MonitorMessageQueue> getMonitorMessageQueues(int start, int end)
		throws SystemException {
		return monitorMessageQueuePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getMonitorMessageQueuesCount() throws SystemException {
		return monitorMessageQueuePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MonitorMessageQueue updateMonitorMessageQueue(
		MonitorMessageQueue monitorMessageQueue) throws SystemException {
		return updateMonitorMessageQueue(monitorMessageQueue, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.dao.gt.asw.model.MonitorMessageQueue",
			monitorMessageQueueLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dao.gt.asw.model.MonitorMessageQueue");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = monitorMessageQueuePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(MonitorMessageQueueLocalServiceBaseImpl.class);
