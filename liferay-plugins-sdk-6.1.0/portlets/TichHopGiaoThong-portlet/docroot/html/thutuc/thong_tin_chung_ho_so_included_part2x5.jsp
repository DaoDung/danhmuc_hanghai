...
%>
	...
	<%
	LogFactoryUtil.getLog(LanhDaoAction.class).info("===requestCodethuTuc=========" + requestCodethuTuc + "===resultT===CheckBusinessUtil======" + resultT);
	
	 if (resultT == CheckBusinessUtil.THAO_TAC_BAN_KHAI_CAP_BAN_KHAI_KY_SO) {
		//hien thi giao dien gom nut ky so
			...
			<button class="bt" type="button"  onclick="displayTraLaiHoSo('<%=actionUrlChuyenTraHoSo.toString()%>')"><i class="tiepnhan"></i>Trả lại hồ sơ</button>
			<%    }  %>
			</div>
			<%
	} else if (resultT == CheckBusinessUtil.THAO_TAC_BAN_KHAI_CAP_BAN_KHAI_KY_SO_THU_TUC_XC) {
		//hien thi giao dien gom nut ky so
		...
		<%
	} else if (resultT == CheckBusinessUtil.THAO_TAC_BAN_KHAI_CAP_BAN_KHAI_KY_SO_THU_TUC_QC) {
		//hien thi giao dien gom nut ky so
	...
	} else if (resultT == CheckBusinessUtil.THAO_TAC_BAN_KHAI_CAP_BAN_KHAI_KY_SO_THU_TUC_VC) {
		//hien thi giao dien gom nut ky so
