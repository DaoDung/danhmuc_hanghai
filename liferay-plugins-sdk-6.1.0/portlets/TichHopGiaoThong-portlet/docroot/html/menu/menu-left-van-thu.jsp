...
<div class="wd-sidebar">
                  ...
                  if(childrens != null &&childrens.size() > 0) {
                      for (Layout child : childrens) {
                    	  ...
                    	  if (requestUrl.contains(url)) {
                              ...
                              if (url.contains("danh-sach-tau-thuyen-cho-dong-dau")) {
                            	  portletSession.setAttribute(MessageType.LOAT_THU_TUC, MessageType.LOAT_THU_TUC_CHO_DONG_DAU ,PortletSession.APPLICATION_SCOPE);                              
    ...
    if ((pageType != null && FormatData.convertToInt(pageType.toString()) == PageType.VAN_THU_DETAIL) 
        || (pageType != null && FormatData.convertToInt(pageType.toString()) == PageType.THU_TUC_DETAIL) ){
        %>
