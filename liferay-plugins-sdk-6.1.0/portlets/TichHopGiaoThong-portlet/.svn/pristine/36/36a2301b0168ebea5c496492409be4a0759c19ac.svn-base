...
/**
 * The base implementation of the dm unit general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmUnitGeneralLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmUnitGeneralLocalServiceBaseImpl
	implements DmUnitGeneralLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmUnitGeneral addDmUnitGeneral(DmUnitGeneral dmUnitGeneral)
		...
		dmUnitGeneral = dmUnitGeneralPersistence.update(dmUnitGeneral, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmUnitGeneral);
			}
	...
	public DmUnitGeneral createDmUnitGeneral(int id) {
		return dmUnitGeneralPersistence.create(id);
	}
	...
	public void deleteDmUnitGeneral(int id)
		...
		DmUnitGeneral dmUnitGeneral = dmUnitGeneralPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmUnitGeneral);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmUnitGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmUnitGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmUnitGeneral fetchDmUnitGeneral(int id) throws SystemException {
		return dmUnitGeneralPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmUnitGeneral getDmUnitGeneral(int id)
		throws PortalException, SystemException {
		return dmUnitGeneralPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmUnitGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmUnitGeneral> getDmUnitGenerals(int start, int end)
		throws SystemException {
		return dmUnitGeneralPersistence.findAll(start, end);
	}
	...
	public int getDmUnitGeneralsCount() throws SystemException {
		return dmUnitGeneralPersistence.countAll();
	}
	...
	public DmUnitGeneral updateDmUnitGeneral(DmUnitGeneral dmUnitGeneral,
		...
		dmUnitGeneral = dmUnitGeneralPersistence.update(dmUnitGeneral, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmUnitGeneral",
			dmUnitGeneralLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmUnitGeneral");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmUnitGeneralPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmUnitGeneralLocalServiceBaseImpl.class);
