...
/**
 * The base implementation of the history rmdc ship remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.HistoryRmdcShipServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.HistoryRmdcShipServiceImpl
 * @see vn.gt.dao.danhmuc.service.HistoryRmdcShipServiceUtil
 * @generated
 */
public abstract class HistoryRmdcShipServiceBaseImpl extends PrincipalBean
	implements HistoryRmdcShipService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.HistoryRmdcShipServiceUtil} to access the history rmdc ship remote service.
	 */
