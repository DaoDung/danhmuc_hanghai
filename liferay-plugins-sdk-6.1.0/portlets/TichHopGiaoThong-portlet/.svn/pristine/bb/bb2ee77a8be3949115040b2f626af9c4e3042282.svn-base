...
<%@page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java"%>
 <%
 	...
 	String defaultSearchStr = "Nh&#7853;p m&#227; h&#7891; s&#417;";
  	...
  	portletUrl.setParameter("jspPage", "/html/danhmuc/view-DM_TUYEN_LUONG.jsp");
	...
	portletUrlParam.setParameter("jspPage", "/html/danhmuc/view-DM_TUYEN_LUONG.jsp");
...
<div class="container-user-sign clearfix container-fluid">
			...
			<div >
						...
						<p style="text-align:center"> 
							...
							addCollectionUrl.setParameter("jspPage", "/html/danhmuc/edit_dm_tuyenluong_details.jsp");
		...
		<%
			...
			List<DmDataItem> results = DmDataItemLocalServiceUtil.findByDataGroupIdAndNode1(130, maritimeCode);
			
			//long longTotal = DmMaritimeLocalServiceUtil.getDmMaritimes(-1, -1).size();
			long longTotal = results.size();
	...
	<div class="wd-content-container bgdanhsach">
			...
			%>
							<tr>
								...
								<td class="text-left"><%=category.getNode1()%> </td>
								...
								editUrl.setParameter("jspPage", "/html/danhmuc/edit_dm_tuyenluong_details.jsp");
								editUrl.setParameter("collectionId", String.valueOf(category.getId()));
								...
								markupDeleteUrl.setParameter("jspPage", "/html/danhmuc/edit_dm_tuyenluong_details.jsp");
								markupDeleteUrl.setParameter("collectionId", String.valueOf(category.getId()));
