...
public class IssuePortClearanceModelImpl extends BaseModelImpl<IssuePortClearance>
	...
	public static long NUMBERPORTCLEARANCE_COLUMN_BITMASK = 4L;
	public static long REQUESTCODE_COLUMN_BITMASK = 8L;
	public static long REQUESTSTATE_COLUMN_BITMASK = 16L;
	...
	public void setNumberPortClearance(String numberPortClearance) {
		_columnBitmask |= NUMBERPORTCLEARANCE_COLUMN_BITMASK;

		if (_originalNumberPortClearance == null) {
			_originalNumberPortClearance = _numberPortClearance;
		}

		_numberPortClearance = numberPortClearance;
	}

	public String getOriginalNumberPortClearance() {
		return GetterUtil.getString(_originalNumberPortClearance);
	}
	...
	public Object clone() {
		...
		issuePortClearanceImpl.setCargoDescription(getCargoDescription());
		...
		issuePortClearanceImpl.setNextProvinceCode(getNextProvinceCode());
		issuePortClearanceImpl.setNextPortOfCallCode(getNextPortOfCallCode());
		issuePortClearanceImpl.setMaritimePortCode(getMaritimePortCode());
		issuePortClearanceImpl.setPortCode(getPortCode());
		issuePortClearanceImpl.setPortHarbourCode(getPortHarbourCode());
		...
		issuePortClearanceImpl.setDwt(getDwt());
		issuePortClearanceImpl.setNextMaritimePortCode(getNextMaritimePortCode());
		issuePortClearanceImpl.setNextPortRegionCode(getNextPortRegionCode());
		issuePortClearanceImpl.setNextPortHarbourCode(getNextPortHarbourCode());
		issuePortClearanceImpl.setNextPortWharfCode(getNextPortWharfCode());
	...
	public void resetOriginalValues() {
		...
		issuePortClearanceModelImpl._originalNumberPortClearance = issuePortClearanceModelImpl._numberPortClearance;
	...
	public CacheModel<IssuePortClearance> toCacheModel() {
		...
		issuePortClearanceCacheModel.cargoDescription = getCargoDescription();

		String cargoDescription = issuePortClearanceCacheModel.cargoDescription;

		if ((cargoDescription != null) && (cargoDescription.length() == 0)) {
			issuePortClearanceCacheModel.cargoDescription = null;
		}
		...
		issuePortClearanceCacheModel.nextProvinceCode = getNextProvinceCode();

		String nextProvinceCode = issuePortClearanceCacheModel.nextProvinceCode;

		if ((nextProvinceCode != null) && (nextProvinceCode.length() == 0)) {
			issuePortClearanceCacheModel.nextProvinceCode = null;
		}
		...
		issuePortClearanceCacheModel.maritimePortCode = getMaritimePortCode();

		String maritimePortCode = issuePortClearanceCacheModel.maritimePortCode;

		if ((maritimePortCode != null) && (maritimePortCode.length() == 0)) {
			issuePortClearanceCacheModel.maritimePortCode = null;
		}

		issuePortClearanceCacheModel.portCode = getPortCode();

		String portCode = issuePortClearanceCacheModel.portCode;

		if ((portCode != null) && (portCode.length() == 0)) {
			issuePortClearanceCacheModel.portCode = null;
		}

		issuePortClearanceCacheModel.portHarbourCode = getPortHarbourCode();

		String portHarbourCode = issuePortClearanceCacheModel.portHarbourCode;

		if ((portHarbourCode != null) && (portHarbourCode.length() == 0)) {
			issuePortClearanceCacheModel.portHarbourCode = null;
		}
		...
		issuePortClearanceCacheModel.dwt = getDwt();

		issuePortClearanceCacheModel.nextMaritimePortCode = getNextMaritimePortCode();

		String nextMaritimePortCode = issuePortClearanceCacheModel.nextMaritimePortCode;

		if ((nextMaritimePortCode != null) &&
				(nextMaritimePortCode.length() == 0)) {
			issuePortClearanceCacheModel.nextMaritimePortCode = null;
		}

		issuePortClearanceCacheModel.nextPortRegionCode = getNextPortRegionCode();

		String nextPortRegionCode = issuePortClearanceCacheModel.nextPortRegionCode;

		if ((nextPortRegionCode != null) && (nextPortRegionCode.length() == 0)) {
			issuePortClearanceCacheModel.nextPortRegionCode = null;
		}

		issuePortClearanceCacheModel.nextPortHarbourCode = getNextPortHarbourCode();

		String nextPortHarbourCode = issuePortClearanceCacheModel.nextPortHarbourCode;

		if ((nextPortHarbourCode != null) &&
				(nextPortHarbourCode.length() == 0)) {
			issuePortClearanceCacheModel.nextPortHarbourCode = null;
		}

		issuePortClearanceCacheModel.nextPortWharfCode = getNextPortWharfCode();

		String nextPortWharfCode = issuePortClearanceCacheModel.nextPortWharfCode;

		if ((nextPortWharfCode != null) && (nextPortWharfCode.length() == 0)) {
			issuePortClearanceCacheModel.nextPortWharfCode = null;
		}
	...
	private String _originalNumberPortClearance;
