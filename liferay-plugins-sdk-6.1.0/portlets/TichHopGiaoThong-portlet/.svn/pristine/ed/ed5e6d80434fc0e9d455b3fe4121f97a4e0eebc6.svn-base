...
/**
 * The base implementation of the history sync version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.HistorySyncVersionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class HistorySyncVersionLocalServiceBaseImpl
	implements HistorySyncVersionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public HistorySyncVersion addHistorySyncVersion(
		...
		historySyncVersion = historySyncVersionPersistence.update(historySyncVersion,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(historySyncVersion);
			}
	...
	public HistorySyncVersion createHistorySyncVersion(long id) {
		return historySyncVersionPersistence.create(id);
	}
	...
	public void deleteHistorySyncVersion(long id)
		...
		HistorySyncVersion historySyncVersion = historySyncVersionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(historySyncVersion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return historySyncVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return historySyncVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public HistorySyncVersion fetchHistorySyncVersion(long id)
		throws SystemException {
		return historySyncVersionPersistence.fetchByPrimaryKey(id);
	}
	...
	public HistorySyncVersion getHistorySyncVersion(long id)
		throws PortalException, SystemException {
		return historySyncVersionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return historySyncVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HistorySyncVersion> getHistorySyncVersions(int start, int end)
		throws SystemException {
		return historySyncVersionPersistence.findAll(start, end);
	}
	...
	public int getHistorySyncVersionsCount() throws SystemException {
		return historySyncVersionPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.HistorySyncVersion",
			historySyncVersionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.HistorySyncVersion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = historySyncVersionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(HistorySyncVersionLocalServiceBaseImpl.class);
