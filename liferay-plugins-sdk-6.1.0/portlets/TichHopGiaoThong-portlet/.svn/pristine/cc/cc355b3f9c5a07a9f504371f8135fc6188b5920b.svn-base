...
/**
 * The interface for the temp waste list local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see TempWasteListLocalServiceUtil
...
public interface TempWasteListLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TempWasteListLocalServiceUtil} to access the temp waste list local service. Add custom service methods to {@link vn.gt.dao.noticeandmessage.service.impl.TempWasteListLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
