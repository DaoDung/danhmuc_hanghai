...
/**
 * The base implementation of the dm history port harbour local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPortHarbourLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryPortHarbourLocalServiceBaseImpl
	implements DmHistoryPortHarbourLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPortHarbour addDmHistoryPortHarbour(
		...
		dmHistoryPortHarbour = dmHistoryPortHarbourPersistence.update(dmHistoryPortHarbour,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPortHarbour);
			}
	...
	public DmHistoryPortHarbour createDmHistoryPortHarbour(int id) {
		return dmHistoryPortHarbourPersistence.create(id);
	}
	...
	public void deleteDmHistoryPortHarbour(int id)
		...
		DmHistoryPortHarbour dmHistoryPortHarbour = dmHistoryPortHarbourPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPortHarbour);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryPortHarbourPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortHarbourPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPortHarbour fetchDmHistoryPortHarbour(int id)
		throws SystemException {
		return dmHistoryPortHarbourPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPortHarbour getDmHistoryPortHarbour(int id)
		throws PortalException, SystemException {
		return dmHistoryPortHarbourPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPortHarbourPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPortHarbour> getDmHistoryPortHarbours(int start,
		...
		return dmHistoryPortHarbourPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPortHarboursCount() throws SystemException {
		return dmHistoryPortHarbourPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPortHarbour",
			dmHistoryPortHarbourLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPortHarbour");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPortHarbourPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPortHarbourLocalServiceBaseImpl.class);
