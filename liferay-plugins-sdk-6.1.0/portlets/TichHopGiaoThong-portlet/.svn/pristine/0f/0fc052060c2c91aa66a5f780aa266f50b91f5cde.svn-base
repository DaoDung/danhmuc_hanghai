...
/**
 * The base implementation of the issue acceptance for transit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssueAcceptanceForTransitLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssueAcceptanceForTransitLocalServiceBaseImpl
	implements IssueAcceptanceForTransitLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssueAcceptanceForTransitLocalServiceUtil} to access the issue acceptance for transit local service.
	 */
	 ...
	 */
	public IssueAcceptanceForTransit addIssueAcceptanceForTransit(
		IssueAcceptanceForTransit issueAcceptanceForTransit)
		throws SystemException {
		issueAcceptanceForTransit.setNew(true);

		issueAcceptanceForTransit = issueAcceptanceForTransitPersistence.update(issueAcceptanceForTransit,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issueAcceptanceForTransit);
			}
	 ...
	 */
	public IssueAcceptanceForTransit createIssueAcceptanceForTransit(long id) {
		return issueAcceptanceForTransitPersistence.create(id);
	}
	...
	public void deleteIssueAcceptanceForTransit(long id)
		...
		IssueAcceptanceForTransit issueAcceptanceForTransit = issueAcceptanceForTransitPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issueAcceptanceForTransit);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteIssueAcceptanceForTransit(
		IssueAcceptanceForTransit issueAcceptanceForTransit)
		throws SystemException {
		issueAcceptanceForTransitPersistence.remove(issueAcceptanceForTransit);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueAcceptanceForTransitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueAcceptanceForTransitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssueAcceptanceForTransit fetchIssueAcceptanceForTransit(long id)
		throws SystemException {
		return issueAcceptanceForTransitPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueAcceptanceForTransit getIssueAcceptanceForTransit(long id)
		throws PortalException, SystemException {
		return issueAcceptanceForTransitPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueAcceptanceForTransitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssueAcceptanceForTransit> getIssueAcceptanceForTransits(
		int start, int end) throws SystemException {
		return issueAcceptanceForTransitPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getIssueAcceptanceForTransitsCount() throws SystemException {
		return issueAcceptanceForTransitPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueAcceptanceForTransit updateIssueAcceptanceForTransit(
		IssueAcceptanceForTransit issueAcceptanceForTransit)
		throws SystemException {
		return updateIssueAcceptanceForTransit(issueAcceptanceForTransit, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssueAcceptanceForTransit",
			issueAcceptanceForTransitLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssueAcceptanceForTransit");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueAcceptanceForTransitPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssueAcceptanceForTransitLocalServiceBaseImpl.class);
