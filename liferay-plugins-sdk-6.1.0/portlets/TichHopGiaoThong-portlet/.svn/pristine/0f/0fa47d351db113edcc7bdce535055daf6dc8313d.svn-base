...
public class DmMaritimeLocalServiceWrapper implements DmMaritimeLocalService,
	...
	*/
	...
	public vn.gt.dao.danhmuc.model.DmMaritime getByMaritimeReference(
		...
		return _dmMaritimeLocalService.getByMaritimeReference(maritimeReference);
	}
	...
	*/
	...
	public vn.gt.dao.danhmuc.model.DmMaritime getFirstMaritime() {
		return _dmMaritimeLocalService.getFirstMaritime();
	}

	public vn.gt.dao.danhmuc.model.DmMaritime getLastMaritime() {
		return _dmMaritimeLocalService.getLastMaritime();
	}
	...
	public java.util.List<vn.gt.dao.danhmuc.model.DmMaritime> findDanhSachDmMaritime(
		...
		return _dmMaritimeLocalService.findDanhSachDmMaritime(maritimeCode,
			start, end);
	}

	public int countDanhSachDmMaritime(java.lang.String maritimeCode,
		int start, int end) {
		return _dmMaritimeLocalService.countDanhSachDmMaritime(maritimeCode,
			start, end);
	}
