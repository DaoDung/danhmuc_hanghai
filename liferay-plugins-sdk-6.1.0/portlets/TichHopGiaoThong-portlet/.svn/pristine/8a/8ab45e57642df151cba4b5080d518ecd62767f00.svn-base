...
/**
 * The base implementation of the interface request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.InterfaceRequestLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class InterfaceRequestLocalServiceBaseImpl
	implements InterfaceRequestLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.InterfaceRequestLocalServiceUtil} to access the interface request local service.
	 */
	 ...
	 */
	public InterfaceRequest addInterfaceRequest(
		InterfaceRequest interfaceRequest) throws SystemException {
		interfaceRequest.setNew(true);

		interfaceRequest = interfaceRequestPersistence.update(interfaceRequest,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(interfaceRequest);
			}
	...
	public InterfaceRequest createInterfaceRequest(long id) {
		return interfaceRequestPersistence.create(id);
	}
	...
	public void deleteInterfaceRequest(long id)
		...
		InterfaceRequest interfaceRequest = interfaceRequestPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(interfaceRequest);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteInterfaceRequest(InterfaceRequest interfaceRequest)
		throws SystemException {
		interfaceRequestPersistence.remove(interfaceRequest);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return interfaceRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return interfaceRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public InterfaceRequest fetchInterfaceRequest(long id)
		throws SystemException {
		return interfaceRequestPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InterfaceRequest getInterfaceRequest(long id)
		throws PortalException, SystemException {
		return interfaceRequestPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return interfaceRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<InterfaceRequest> getInterfaceRequests(int start, int end)
		throws SystemException {
		return interfaceRequestPersistence.findAll(start, end);
	}
	...
	public int getInterfaceRequestsCount() throws SystemException {
		return interfaceRequestPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InterfaceRequest updateInterfaceRequest(
		InterfaceRequest interfaceRequest) throws SystemException {
	 ...
	 */
	public InterfaceRequest updateInterfaceRequest(
		InterfaceRequest interfaceRequest, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.InterfaceRequest",
			interfaceRequestLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.InterfaceRequest");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = interfaceRequestPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(InterfaceRequestLocalServiceBaseImpl.class);
