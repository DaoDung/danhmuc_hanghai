...
public class DmHistoryMinistryClp extends BaseModelImpl<DmHistoryMinistry>
	...
	public DmHistoryMinistry toEscapedModel() {
		return (DmHistoryMinistry)Proxy.newProxyInstance(DmHistoryMinistry.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmHistoryMinistryClp dmHistoryMinistry = null;

		try {
			dmHistoryMinistry = (DmHistoryMinistryClp)obj;
		}
