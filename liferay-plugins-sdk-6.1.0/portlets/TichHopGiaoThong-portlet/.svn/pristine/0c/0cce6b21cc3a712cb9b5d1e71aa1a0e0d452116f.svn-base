...
<%
	...
	if (userTitle.isEmpty() || userTitle== null || userSignDefault.getFileChungThuSoId() == 0 || userSignDefault.getFileConDauId() == 0){
	...
	if (MessageType.LOAT_THU_TUC_CHO_DONG_DAU == message) {
