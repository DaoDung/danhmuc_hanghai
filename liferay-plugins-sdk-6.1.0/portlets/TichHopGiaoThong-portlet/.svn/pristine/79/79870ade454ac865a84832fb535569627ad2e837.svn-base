...
public class ResultCertificateWrapper implements ResultCertificate,
	...
	*/
	...
	/**
	* Returns the description of this result certificate.
	*
	* @return the description of this result certificate
	*/
	public java.lang.String getDescription() {
		return _resultCertificate.getDescription();
	}

	/**
	* Sets the description of this result certificate.
	*
	* @param description the description of this result certificate
	*/
	public void setDescription(java.lang.String description) {
		_resultCertificate.setDescription(description);
	}

	/**
	* Returns the comment of this result certificate.
	*
	* @return the comment of this result certificate
	*/
	public java.lang.String getComment() {
		return _resultCertificate.getComment();
	}

	/**
	* Sets the comment of this result certificate.
	*
	* @param comment the comment of this result certificate
	*/
	public void setComment(java.lang.String comment) {
		_resultCertificate.setComment(comment);
	}
