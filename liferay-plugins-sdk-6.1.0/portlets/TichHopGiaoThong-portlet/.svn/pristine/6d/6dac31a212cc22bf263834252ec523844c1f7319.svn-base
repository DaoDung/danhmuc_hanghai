...
/**
 * The base implementation of the result declaration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultDeclarationServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.result.service.impl.ResultDeclarationServiceImpl
 * @see vn.gt.dao.result.service.ResultDeclarationServiceUtil
 * @generated
 */
public abstract class ResultDeclarationServiceBaseImpl extends PrincipalBean
	implements ResultDeclarationService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.result.service.ResultDeclarationServiceUtil} to access the result declaration remote service.
	 */
