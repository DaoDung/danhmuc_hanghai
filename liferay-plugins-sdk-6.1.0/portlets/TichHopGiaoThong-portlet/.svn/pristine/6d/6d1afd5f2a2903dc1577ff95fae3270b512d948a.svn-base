...
/**
 * The base implementation of the temp declaration for animal quarantine remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDeclarationForAnimalQuarantineServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempDeclarationForAnimalQuarantineServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempDeclarationForAnimalQuarantineServiceUtil
 * @generated
 */
public abstract class TempDeclarationForAnimalQuarantineServiceBaseImpl
	extends PrincipalBean implements TempDeclarationForAnimalQuarantineService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDeclarationForAnimalQuarantineServiceUtil} to access the temp declaration for animal quarantine remote service.
	 */
