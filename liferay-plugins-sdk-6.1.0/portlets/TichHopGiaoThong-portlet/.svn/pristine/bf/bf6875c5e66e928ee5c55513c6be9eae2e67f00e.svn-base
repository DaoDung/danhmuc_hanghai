...
/**
 * The base implementation of the temp no tice ship message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempNoTiceShipMessageLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempNoTiceShipMessageLocalServiceBaseImpl
	implements TempNoTiceShipMessageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempNoTiceShipMessageLocalServiceUtil} to access the temp no tice ship message local service.
	 */
	...
	public TempNoTiceShipMessage addTempNoTiceShipMessage(
		...
		tempNoTiceShipMessage = tempNoTiceShipMessagePersistence.update(tempNoTiceShipMessage,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempNoTiceShipMessage);
			}
	...
	public TempNoTiceShipMessage createTempNoTiceShipMessage(long id) {
		return tempNoTiceShipMessagePersistence.create(id);
	}
	...
	public void deleteTempNoTiceShipMessage(long id)
		...
		TempNoTiceShipMessage tempNoTiceShipMessage = tempNoTiceShipMessagePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempNoTiceShipMessage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempNoTiceShipMessage(
		TempNoTiceShipMessage tempNoTiceShipMessage) throws SystemException {
		tempNoTiceShipMessagePersistence.remove(tempNoTiceShipMessage);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempNoTiceShipMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempNoTiceShipMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempNoTiceShipMessage fetchTempNoTiceShipMessage(long id)
		throws SystemException {
		return tempNoTiceShipMessagePersistence.fetchByPrimaryKey(id);
	}
	...
	public TempNoTiceShipMessage getTempNoTiceShipMessage(long id)
		throws PortalException, SystemException {
		return tempNoTiceShipMessagePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempNoTiceShipMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempNoTiceShipMessage> getTempNoTiceShipMessages(int start,
		...
		return tempNoTiceShipMessagePersistence.findAll(start, end);
	}
	...
	public int getTempNoTiceShipMessagesCount() throws SystemException {
		return tempNoTiceShipMessagePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempNoTiceShipMessage",
			tempNoTiceShipMessageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempNoTiceShipMessage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempNoTiceShipMessagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempNoTiceShipMessageLocalServiceBaseImpl.class);
