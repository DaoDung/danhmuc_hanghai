...
/**
 * The base implementation of the temp goods items remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempGoodsItemsServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempGoodsItemsServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempGoodsItemsServiceUtil
 * @generated
 */
public abstract class TempGoodsItemsServiceBaseImpl extends PrincipalBean
	implements TempGoodsItemsService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempGoodsItemsServiceUtil} to access the temp goods items remote service.
	 */
