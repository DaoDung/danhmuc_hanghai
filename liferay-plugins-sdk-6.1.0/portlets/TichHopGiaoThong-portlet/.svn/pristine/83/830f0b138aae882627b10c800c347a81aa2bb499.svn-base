...
/**
 * The base implementation of the dm history doc type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryDocTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryDocTypeLocalServiceBaseImpl
	implements DmHistoryDocTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryDocType addDmHistoryDocType(
		...
		dmHistoryDocType = dmHistoryDocTypePersistence.update(dmHistoryDocType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryDocType);
			}
	...
	public DmHistoryDocType createDmHistoryDocType(int id) {
		return dmHistoryDocTypePersistence.create(id);
	}
	...
	public void deleteDmHistoryDocType(int id)
		...
		DmHistoryDocType dmHistoryDocType = dmHistoryDocTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryDocType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryDocTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryDocTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryDocType fetchDmHistoryDocType(int id)
		throws SystemException {
		return dmHistoryDocTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryDocType getDmHistoryDocType(int id)
		throws PortalException, SystemException {
		return dmHistoryDocTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryDocTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryDocType> getDmHistoryDocTypes(int start, int end)
		throws SystemException {
		return dmHistoryDocTypePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryDocTypesCount() throws SystemException {
		return dmHistoryDocTypePersistence.countAll();
	}
	 ...
	 *
	 * @param dmHistoryDocType the dm history doc type
	 * @param merge whether to merge the dm history doc type with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm history doc type that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmHistoryDocType updateDmHistoryDocType(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryDocType",
			dmHistoryDocTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryDocType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryDocTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryDocTypeLocalServiceBaseImpl.class);
