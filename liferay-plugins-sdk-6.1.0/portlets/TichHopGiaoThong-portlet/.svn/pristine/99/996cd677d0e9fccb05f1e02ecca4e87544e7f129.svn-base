...
/**
 * The base implementation of the dm history security level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistorySecurityLevelLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistorySecurityLevelLocalServiceBaseImpl
	implements DmHistorySecurityLevelLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistorySecurityLevel addDmHistorySecurityLevel(
		...
		dmHistorySecurityLevel = dmHistorySecurityLevelPersistence.update(dmHistorySecurityLevel,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistorySecurityLevel);
			}
	...
	public DmHistorySecurityLevel createDmHistorySecurityLevel(int id) {
		return dmHistorySecurityLevelPersistence.create(id);
	}
	...
	public void deleteDmHistorySecurityLevel(int id)
		...
		DmHistorySecurityLevel dmHistorySecurityLevel = dmHistorySecurityLevelPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistorySecurityLevel);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistorySecurityLevelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistorySecurityLevelPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistorySecurityLevel fetchDmHistorySecurityLevel(int id)
		throws SystemException {
		return dmHistorySecurityLevelPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistorySecurityLevel getDmHistorySecurityLevel(int id)
		throws PortalException, SystemException {
		return dmHistorySecurityLevelPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistorySecurityLevelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistorySecurityLevel> getDmHistorySecurityLevels(int start,
		...
		return dmHistorySecurityLevelPersistence.findAll(start, end);
	}
	...
	public int getDmHistorySecurityLevelsCount() throws SystemException {
		return dmHistorySecurityLevelPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistorySecurityLevel",
			dmHistorySecurityLevelLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistorySecurityLevel");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistorySecurityLevelPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistorySecurityLevelLocalServiceBaseImpl.class);
