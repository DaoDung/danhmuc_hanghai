...
/**
 * The base implementation of the dm doc type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmDocTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmDocTypeLocalServiceBaseImpl
	implements DmDocTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmDocType addDmDocType(DmDocType dmDocType)
		...
		dmDocType = dmDocTypePersistence.update(dmDocType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmDocType);
			}
	...
	public DmDocType createDmDocType(int id) {
		return dmDocTypePersistence.create(id);
	}
	...
	public void deleteDmDocType(int id) throws PortalException, SystemException {
		DmDocType dmDocType = dmDocTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmDocType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDocTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmDocTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDocTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmDocType fetchDmDocType(int id) throws SystemException {
		return dmDocTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmDocType getDmDocType(int id)
		...
		return dmDocTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmDocTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmDocType> getDmDocTypes(int start, int end)
		throws SystemException {
		return dmDocTypePersistence.findAll(start, end);
	}
	...
	public int getDmDocTypesCount() throws SystemException {
		return dmDocTypePersistence.countAll();
	}
	...
	public DmDocType updateDmDocType(DmDocType dmDocType, boolean merge)
		...
		dmDocType = dmDocTypePersistence.update(dmDocType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmDocType",
			dmDocTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmDocType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmDocTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmDocTypeLocalServiceBaseImpl.class);
