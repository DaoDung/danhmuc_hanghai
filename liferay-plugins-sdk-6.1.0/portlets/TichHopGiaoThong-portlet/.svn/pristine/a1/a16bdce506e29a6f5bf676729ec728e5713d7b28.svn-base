...
public class AswmsgMessageQueueLocalServiceUtil {
	...
	*/
	public static vn.dao.gt.asw.model.AswmsgMessageQueue addAswmsgMessageQueue(
	...
	*/
	public static vn.dao.gt.asw.model.AswmsgMessageQueue createAswmsgMessageQueue(
		long id) {
	...
	*/
	...
	public static vn.dao.gt.asw.model.AswmsgMessageQueue fetchAswmsgMessageQueue(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dao.gt.asw.model.AswmsgMessageQueue getAswmsgMessageQueue(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dao.gt.asw.model.AswmsgMessageQueue> getAswmsgMessageQueues(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dao.gt.asw.model.AswmsgMessageQueue updateAswmsgMessageQueue(
		vn.dao.gt.asw.model.AswmsgMessageQueue aswmsgMessageQueue)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AswmsgMessageQueueLocalService getService() {
		if (_service == null) {
			...
			_service = new AswmsgMessageQueueLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(AswmsgMessageQueueLocalServiceUtil.class,
				"_service");
			MethodCache.remove(AswmsgMessageQueueLocalService.class);
		}
