...
public class TempNoTiceShipMessageCacheModel implements CacheModel<TempNoTiceShipMessage>,
	...
	public String toString() {
		...
		sb.append(numberPassengerList);
		sb.append(", numberCrewEffectsDeclaration=");
		sb.append(numberCrewEffectsDeclaration);
		sb.append(", numberHealthMaritimeDeclaration=");
		sb.append(numberHealthMaritimeDeclaration);
	...
	public TempNoTiceShipMessage toEntityModel() {
		...
		tempNoTiceShipMessageImpl.setDocumentReference(documentReference);
		tempNoTiceShipMessageImpl.setIsArrival(isArrival);

		if (voyageNumber == null) {
			tempNoTiceShipMessageImpl.setVoyageNumber(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setVoyageNumber(voyageNumber);
		}

		tempNoTiceShipMessageImpl.setNetTonnage(netTonnage);

		if (netTonnageUnit == null) {
			tempNoTiceShipMessageImpl.setNetTonnageUnit(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setNetTonnageUnit(netTonnageUnit);
		}

		if (positionOfShipInPort == null) {
			tempNoTiceShipMessageImpl.setPositionOfShipInPort(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setPositionOfShipInPort(positionOfShipInPort);
		}

		if (briefParticularsOfVoyage == null) {
			tempNoTiceShipMessageImpl.setBriefParticularsOfVoyage(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setBriefParticularsOfVoyage(briefParticularsOfVoyage);
		}

		if (previousPortsOfCall == null) {
			tempNoTiceShipMessageImpl.setPreviousPortsOfCall(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setPreviousPortsOfCall(previousPortsOfCall);
		}

		if (subsequentPortsOfCall == null) {
			tempNoTiceShipMessageImpl.setSubsequentPortsOfCall(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setSubsequentPortsOfCall(subsequentPortsOfCall);
		}

		if (dischargedPorts == null) {
			tempNoTiceShipMessageImpl.setDischargedPorts(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setDischargedPorts(dischargedPorts);
		}

		if (remainingCargo == null) {
			tempNoTiceShipMessageImpl.setRemainingCargo(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setRemainingCargo(remainingCargo);
		}

		if (shipRequirementsInTermsOfWaste == null) {
			tempNoTiceShipMessageImpl.setShipRequirementsInTermsOfWaste(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setShipRequirementsInTermsOfWaste(shipRequirementsInTermsOfWaste);
		}

		tempNoTiceShipMessageImpl.setNumberCargoDeclaration(numberCargoDeclaration);
		tempNoTiceShipMessageImpl.setNumberShipStoreDeclaration(numberShipStoreDeclaration);
		tempNoTiceShipMessageImpl.setNumberCrewList(numberCrewList);
		tempNoTiceShipMessageImpl.setNumberPassengerList(numberPassengerList);
		tempNoTiceShipMessageImpl.setNumberCrewEffectsDeclaration(numberCrewEffectsDeclaration);
		tempNoTiceShipMessageImpl.setNumberHealthMaritimeDeclaration(numberHealthMaritimeDeclaration);

		if (portClearanceNo == null) {
			tempNoTiceShipMessageImpl.setPortClearanceNo(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setPortClearanceNo(portClearanceNo);
		}

		if (timeOfPORTArrival == Long.MIN_VALUE) {
			tempNoTiceShipMessageImpl.setTimeOfPORTArrival(null);
		}
		else {
			tempNoTiceShipMessageImpl.setTimeOfPORTArrival(new Date(
					timeOfPORTArrival));
		}

		if (timeOfPilotOnBoard == Long.MIN_VALUE) {
			tempNoTiceShipMessageImpl.setTimeOfPilotOnBoard(null);
		}
		else {
			tempNoTiceShipMessageImpl.setTimeOfPilotOnBoard(new Date(
					timeOfPilotOnBoard));
		}

		if (tugBoat == null) {
			tempNoTiceShipMessageImpl.setTugBoat(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setTugBoat(tugBoat);
		}

		if (do_ == null) {
			tempNoTiceShipMessageImpl.setDo_(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setDo_(do_);
		}

		if (fo == null) {
			tempNoTiceShipMessageImpl.setFo(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setFo(fo);
		}

		if (fw == null) {
			tempNoTiceShipMessageImpl.setFw(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setFw(fw);
		}

		if (placeOfReception == null) {
			tempNoTiceShipMessageImpl.setPlaceOfReception(StringPool.BLANK);
		}
		else {
			tempNoTiceShipMessageImpl.setPlaceOfReception(placeOfReception);
		}
	...
	public String previousPortsOfCall;
	public String subsequentPortsOfCall;
	public String dischargedPorts;
	public String remainingCargo;
	public String shipRequirementsInTermsOfWaste;
	public int numberCargoDeclaration;
	public int numberShipStoreDeclaration;
	public int numberCrewList;
	public int numberPassengerList;
	public int numberCrewEffectsDeclaration;
	public int numberHealthMaritimeDeclaration;
	public String portClearanceNo;
	public long timeOfPORTArrival;
	public long timeOfPilotOnBoard;
	public String tugBoat;
	public String do_;
	public String fo;
	public String fw;
	public String placeOfReception;
}