...
/**
 * The base implementation of the temp crew effects items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCrewEffectsItemsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCrewEffectsItemsLocalServiceBaseImpl
	implements TempCrewEffectsItemsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCrewEffectsItemsLocalServiceUtil} to access the temp crew effects items local service.
	 */
	 ...
	 */
	public TempCrewEffectsItems addTempCrewEffectsItems(
		TempCrewEffectsItems tempCrewEffectsItems) throws SystemException {
		tempCrewEffectsItems.setNew(true);

		tempCrewEffectsItems = tempCrewEffectsItemsPersistence.update(tempCrewEffectsItems,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempCrewEffectsItems);
			}
	...
	public TempCrewEffectsItems createTempCrewEffectsItems(long id) {
		return tempCrewEffectsItemsPersistence.create(id);
	}
	...
	public void deleteTempCrewEffectsItems(long id)
		...
		TempCrewEffectsItems tempCrewEffectsItems = tempCrewEffectsItemsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCrewEffectsItems);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempCrewEffectsItems(
		TempCrewEffectsItems tempCrewEffectsItems) throws SystemException {
		tempCrewEffectsItemsPersistence.remove(tempCrewEffectsItems);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempCrewEffectsItemsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewEffectsItemsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCrewEffectsItems fetchTempCrewEffectsItems(long id)
		throws SystemException {
		return tempCrewEffectsItemsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewEffectsItems getTempCrewEffectsItems(long id)
		throws PortalException, SystemException {
		return tempCrewEffectsItemsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCrewEffectsItemsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempCrewEffectsItems> getTempCrewEffectsItemses(int start,
		int end) throws SystemException {
		return tempCrewEffectsItemsPersistence.findAll(start, end);
	}
	...
	public int getTempCrewEffectsItemsesCount() throws SystemException {
		return tempCrewEffectsItemsPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewEffectsItems updateTempCrewEffectsItems(
		TempCrewEffectsItems tempCrewEffectsItems) throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCrewEffectsItems",
			tempCrewEffectsItemsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCrewEffectsItems");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCrewEffectsItemsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCrewEffectsItemsLocalServiceBaseImpl.class);
