...
public class DmHistoryRepresentativeWrapper implements DmHistoryRepresentative,
	...
	*/
	...
	/**
	* Returns the rep level of this dm history representative.
	*
	* @return the rep level of this dm history representative
	*/
	public int getRepLevel() {
		return _dmHistoryRepresentative.getRepLevel();
	}

	/**
	* Sets the rep level of this dm history representative.
	*
	* @param repLevel the rep level of this dm history representative
	*/
	public void setRepLevel(int repLevel) {
		_dmHistoryRepresentative.setRepLevel(repLevel);
	}
