...
/**
 * The extended model implementation for the TempGeneralDeclaration service. Represents a row in the &quot;TEMP_GENERAL_DECLARATION&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration} interface.
 * </p>
 *
 * @author win_64
 */
public class TempGeneralDeclarationImpl extends TempGeneralDeclarationBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a temp general declaration model instance should use the {@link vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration} interface instead.
	 */
	public TempGeneralDeclarationImpl() {
	}
