...
/**
 * The base implementation of the temp document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDocumentLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDocumentLocalServiceBaseImpl
	implements TempDocumentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDocumentLocalServiceUtil} to access the temp document local service.
	 */
	 ...
	 */
	public TempDocument addTempDocument(TempDocument tempDocument)
		throws SystemException {
		tempDocument.setNew(true);

		tempDocument = tempDocumentPersistence.update(tempDocument, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempDocument);
			}
	...
	public TempDocument createTempDocument(long id) {
		return tempDocumentPersistence.create(id);
	}
	...
	public void deleteTempDocument(long id)
		...
		TempDocument tempDocument = tempDocumentPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDocument);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempDocument(TempDocument tempDocument)
		throws SystemException {
		tempDocumentPersistence.remove(tempDocument);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDocument fetchTempDocument(long id) throws SystemException {
		return tempDocumentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDocument getTempDocument(long id)
		throws PortalException, SystemException {
		return tempDocumentPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempDocument> getTempDocuments(int start, int end)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDocument updateTempDocument(TempDocument tempDocument)
		throws SystemException {
	...
	public TempDocument updateTempDocument(TempDocument tempDocument,
		...
		tempDocument = tempDocumentPersistence.update(tempDocument, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempDocument",
			tempDocumentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempDocument");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDocumentPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDocumentLocalServiceBaseImpl.class);
