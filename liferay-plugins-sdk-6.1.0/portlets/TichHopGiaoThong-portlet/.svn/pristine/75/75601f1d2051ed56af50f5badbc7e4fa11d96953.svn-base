...
/**
 * The base implementation of the temp ship security message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempShipSecurityMessageLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempShipSecurityMessageLocalServiceBaseImpl
	implements TempShipSecurityMessageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempShipSecurityMessage addTempShipSecurityMessage(
		...
		tempShipSecurityMessage = tempShipSecurityMessagePersistence.update(tempShipSecurityMessage,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempShipSecurityMessage);
			}
	...
	public TempShipSecurityMessage createTempShipSecurityMessage(long id) {
		return tempShipSecurityMessagePersistence.create(id);
	}
	...
	public void deleteTempShipSecurityMessage(long id)
		...
		TempShipSecurityMessage tempShipSecurityMessage = tempShipSecurityMessagePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempShipSecurityMessage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempShipSecurityMessage(
		TempShipSecurityMessage tempShipSecurityMessage)
		throws SystemException {
		tempShipSecurityMessagePersistence.remove(tempShipSecurityMessage);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipSecurityMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipSecurityMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempShipSecurityMessage fetchTempShipSecurityMessage(long id)
		throws SystemException {
		return tempShipSecurityMessagePersistence.fetchByPrimaryKey(id);
	}
	...
	public TempShipSecurityMessage getTempShipSecurityMessage(long id)
		throws PortalException, SystemException {
		return tempShipSecurityMessagePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempShipSecurityMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempShipSecurityMessage> getTempShipSecurityMessages(
		...
		return tempShipSecurityMessagePersistence.findAll(start, end);
	}
	...
	public int getTempShipSecurityMessagesCount() throws SystemException {
		return tempShipSecurityMessagePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempShipSecurityMessage",
			tempShipSecurityMessageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempShipSecurityMessage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempShipSecurityMessagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempShipSecurityMessageLocalServiceBaseImpl.class);
