...
/**
 * The base implementation of the dm history goods type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryGoodsTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryGoodsTypeLocalServiceBaseImpl
	implements DmHistoryGoodsTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryGoodsType addDmHistoryGoodsType(
		...
		dmHistoryGoodsType = dmHistoryGoodsTypePersistence.update(dmHistoryGoodsType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryGoodsType);
			}
	...
	public DmHistoryGoodsType createDmHistoryGoodsType(int id) {
		return dmHistoryGoodsTypePersistence.create(id);
	}
	...
	public void deleteDmHistoryGoodsType(int id)
		...
		DmHistoryGoodsType dmHistoryGoodsType = dmHistoryGoodsTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryGoodsType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteDmHistoryGoodsType(DmHistoryGoodsType dmHistoryGoodsType)
		...
		dmHistoryGoodsTypePersistence.remove(dmHistoryGoodsType);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryGoodsTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryGoodsTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryGoodsType fetchDmHistoryGoodsType(int id)
		throws SystemException {
		return dmHistoryGoodsTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryGoodsType getDmHistoryGoodsType(int id)
		throws PortalException, SystemException {
		return dmHistoryGoodsTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryGoodsTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryGoodsType> getDmHistoryGoodsTypes(int start, int end)
		throws SystemException {
		return dmHistoryGoodsTypePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryGoodsTypesCount() throws SystemException {
		return dmHistoryGoodsTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryGoodsType",
			dmHistoryGoodsTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryGoodsType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryGoodsTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryGoodsTypeLocalServiceBaseImpl.class);
