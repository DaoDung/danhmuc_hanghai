...
public class DmPortRegionLocalServiceUtil {
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmPortRegion addDmPortRegion(
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmPortRegion createDmPortRegion(
		int id) {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmPortRegion fetchDmPortRegion(int id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmPortRegion getDmPortRegion(int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmuc.model.DmPortRegion> getDmPortRegions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmPortRegion updateDmPortRegion(
		vn.gt.dao.danhmuc.model.DmPortRegion dmPortRegion)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmPortRegion getByPortRegionCode(
		java.lang.String portRegionCode) {
		return getService().getByPortRegionCode(portRegionCode);
	}

	public static java.util.List<vn.gt.dao.danhmuc.model.DmPortRegion> findPortRegionByPortRegionRef(
		java.lang.String portRegionRef) {
		return getService().findPortRegionByPortRegionRef(portRegionRef);
	}

	public static java.util.List<vn.gt.dao.danhmuc.model.DmPortRegion> findPortRegionByPortCodeName(
	...
	public static DmPortRegionLocalService getService() {
		if (_service == null) {
			...
			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					DmPortRegionLocalService.class.getName(), portletClassLoader);

			_service = new DmPortRegionLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmPortRegionLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmPortRegionLocalService.class);
		}
