...
public class IssuePortClearanceWrapper implements IssuePortClearance,
	...
	*/
	...
	/**
	* Returns the cargo description of this issue port clearance.
	*
	* @return the cargo description of this issue port clearance
	*/
	public java.lang.String getCargoDescription() {
		return _issuePortClearance.getCargoDescription();
	}

	/**
	* Sets the cargo description of this issue port clearance.
	*
	* @param cargoDescription the cargo description of this issue port clearance
	*/
	public void setCargoDescription(java.lang.String cargoDescription) {
		_issuePortClearance.setCargoDescription(cargoDescription);
	}
	...
	*/
	...
	/**
	* Returns the next province code of this issue port clearance.
	*
	* @return the next province code of this issue port clearance
	*/
	public java.lang.String getNextProvinceCode() {
		return _issuePortClearance.getNextProvinceCode();
	}

	/**
	* Sets the next province code of this issue port clearance.
	*
	* @param nextProvinceCode the next province code of this issue port clearance
	*/
	public void setNextProvinceCode(java.lang.String nextProvinceCode) {
		_issuePortClearance.setNextProvinceCode(nextProvinceCode);
	}
	...
	*/
	...
	/**
	* Returns the maritime port code of this issue port clearance.
	*
	* @return the maritime port code of this issue port clearance
	*/
	public java.lang.String getMaritimePortCode() {
		return _issuePortClearance.getMaritimePortCode();
	}

	/**
	* Sets the maritime port code of this issue port clearance.
	*
	* @param maritimePortCode the maritime port code of this issue port clearance
	*/
	public void setMaritimePortCode(java.lang.String maritimePortCode) {
		_issuePortClearance.setMaritimePortCode(maritimePortCode);
	}

	/**
	* Returns the port code of this issue port clearance.
	*
	* @return the port code of this issue port clearance
	*/
	public java.lang.String getPortCode() {
		return _issuePortClearance.getPortCode();
	}

	/**
	* Sets the port code of this issue port clearance.
	*
	* @param portCode the port code of this issue port clearance
	*/
	public void setPortCode(java.lang.String portCode) {
		_issuePortClearance.setPortCode(portCode);
	}

	/**
	* Returns the port harbour code of this issue port clearance.
	*
	* @return the port harbour code of this issue port clearance
	*/
	public java.lang.String getPortHarbourCode() {
		return _issuePortClearance.getPortHarbourCode();
	}

	/**
	* Sets the port harbour code of this issue port clearance.
	*
	* @param portHarbourCode the port harbour code of this issue port clearance
	*/
	public void setPortHarbourCode(java.lang.String portHarbourCode) {
		_issuePortClearance.setPortHarbourCode(portHarbourCode);
	}
	...
	*/
	...
	/**
	* Returns the dwt of this issue port clearance.
	*
	* @return the dwt of this issue port clearance
	*/
	public double getDwt() {
		return _issuePortClearance.getDwt();
	}

	/**
	* Sets the dwt of this issue port clearance.
	*
	* @param dwt the dwt of this issue port clearance
	*/
	public void setDwt(double dwt) {
		_issuePortClearance.setDwt(dwt);
	}

	/**
	* Returns the next maritime port code of this issue port clearance.
	*
	* @return the next maritime port code of this issue port clearance
	*/
	public java.lang.String getNextMaritimePortCode() {
		return _issuePortClearance.getNextMaritimePortCode();
	}

	/**
	* Sets the next maritime port code of this issue port clearance.
	*
	* @param nextMaritimePortCode the next maritime port code of this issue port clearance
	*/
	public void setNextMaritimePortCode(java.lang.String nextMaritimePortCode) {
		_issuePortClearance.setNextMaritimePortCode(nextMaritimePortCode);
	}

	/**
	* Returns the next port region code of this issue port clearance.
	*
	* @return the next port region code of this issue port clearance
	*/
	public java.lang.String getNextPortRegionCode() {
		return _issuePortClearance.getNextPortRegionCode();
	}

	/**
	* Sets the next port region code of this issue port clearance.
	*
	* @param nextPortRegionCode the next port region code of this issue port clearance
	*/
	public void setNextPortRegionCode(java.lang.String nextPortRegionCode) {
		_issuePortClearance.setNextPortRegionCode(nextPortRegionCode);
	}

	/**
	* Returns the next port harbour code of this issue port clearance.
	*
	* @return the next port harbour code of this issue port clearance
	*/
	public java.lang.String getNextPortHarbourCode() {
		return _issuePortClearance.getNextPortHarbourCode();
	}

	/**
	* Sets the next port harbour code of this issue port clearance.
	*
	* @param nextPortHarbourCode the next port harbour code of this issue port clearance
	*/
	public void setNextPortHarbourCode(java.lang.String nextPortHarbourCode) {
		_issuePortClearance.setNextPortHarbourCode(nextPortHarbourCode);
	}

	/**
	* Returns the next port wharf code of this issue port clearance.
	*
	* @return the next port wharf code of this issue port clearance
	*/
	public java.lang.String getNextPortWharfCode() {
		return _issuePortClearance.getNextPortWharfCode();
	}

	/**
	* Sets the next port wharf code of this issue port clearance.
	*
	* @param nextPortWharfCode the next port wharf code of this issue port clearance
	*/
	public void setNextPortWharfCode(java.lang.String nextPortWharfCode) {
		_issuePortClearance.setNextPortWharfCode(nextPortWharfCode);
	}
