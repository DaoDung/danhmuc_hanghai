...
public class IssueShiftingOrderWrapper implements IssueShiftingOrder,
	...
	*/
	...
	/**
	* Returns the shown draftx f of this issue shifting order.
	*
	* @return the shown draftx f of this issue shifting order
	*/
	public double getShownDraftxF() {
		return _issueShiftingOrder.getShownDraftxF();
	}

	/**
	* Sets the shown draftx f of this issue shifting order.
	*
	* @param shownDraftxF the shown draftx f of this issue shifting order
	*/
	public void setShownDraftxF(double shownDraftxF) {
		_issueShiftingOrder.setShownDraftxF(shownDraftxF);
	}

	/**
	* Returns the unit shown draftx f of this issue shifting order.
	*
	* @return the unit shown draftx f of this issue shifting order
	*/
	public java.lang.String getUnitShownDraftxF() {
		return _issueShiftingOrder.getUnitShownDraftxF();
	}

	/**
	* Sets the unit shown draftx f of this issue shifting order.
	*
	* @param unitShownDraftxF the unit shown draftx f of this issue shifting order
	*/
	public void setUnitShownDraftxF(java.lang.String unitShownDraftxF) {
		_issueShiftingOrder.setUnitShownDraftxF(unitShownDraftxF);
	}

	/**
	* Returns the shown draftx a of this issue shifting order.
	*
	* @return the shown draftx a of this issue shifting order
	*/
	public double getShownDraftxA() {
		return _issueShiftingOrder.getShownDraftxA();
	}

	/**
	* Sets the shown draftx a of this issue shifting order.
	*
	* @param shownDraftxA the shown draftx a of this issue shifting order
	*/
	public void setShownDraftxA(double shownDraftxA) {
		_issueShiftingOrder.setShownDraftxA(shownDraftxA);
	}

	/**
	* Returns the unit shown draftx a of this issue shifting order.
	*
	* @return the unit shown draftx a of this issue shifting order
	*/
	public java.lang.String getUnitShownDraftxA() {
		return _issueShiftingOrder.getUnitShownDraftxA();
	}

	/**
	* Sets the unit shown draftx a of this issue shifting order.
	*
	* @param unitShownDraftxA the unit shown draftx a of this issue shifting order
	*/
	public void setUnitShownDraftxA(java.lang.String unitShownDraftxA) {
		_issueShiftingOrder.setUnitShownDraftxA(unitShownDraftxA);
	}

	/**
	* Returns the loa of this issue shifting order.
	*
	* @return the loa of this issue shifting order
	*/
	public double getLoa() {
		return _issueShiftingOrder.getLoa();
	}

	/**
	* Sets the loa of this issue shifting order.
	*
	* @param loa the loa of this issue shifting order
	*/
	public void setLoa(double loa) {
		_issueShiftingOrder.setLoa(loa);
	}

	/**
	* Returns the loa unit of this issue shifting order.
	*
	* @return the loa unit of this issue shifting order
	*/
	public java.lang.String getLoaUnit() {
		return _issueShiftingOrder.getLoaUnit();
	}

	/**
	* Sets the loa unit of this issue shifting order.
	*
	* @param loaUnit the loa unit of this issue shifting order
	*/
	public void setLoaUnit(java.lang.String loaUnit) {
		_issueShiftingOrder.setLoaUnit(loaUnit);
	}

	/**
	* Returns the dwt of this issue shifting order.
	*
	* @return the dwt of this issue shifting order
	*/
	public double getDwt() {
		return _issueShiftingOrder.getDwt();
	}

	/**
	* Sets the dwt of this issue shifting order.
	*
	* @param dwt the dwt of this issue shifting order
	*/
	public void setDwt(double dwt) {
		_issueShiftingOrder.setDwt(dwt);
	}

	/**
	* Returns the dwt unit of this issue shifting order.
	*
	* @return the dwt unit of this issue shifting order
	*/
	public java.lang.String getDwtUnit() {
		return _issueShiftingOrder.getDwtUnit();
	}

	/**
	* Sets the dwt unit of this issue shifting order.
	*
	* @param dwtUnit the dwt unit of this issue shifting order
	*/
	public void setDwtUnit(java.lang.String dwtUnit) {
		_issueShiftingOrder.setDwtUnit(dwtUnit);
	}

	/**
	* Returns the tug boat of this issue shifting order.
	*
	* @return the tug boat of this issue shifting order
	*/
	public java.lang.String getTugBoat() {
		return _issueShiftingOrder.getTugBoat();
	}

	/**
	* Sets the tug boat of this issue shifting order.
	*
	* @param tugBoat the tug boat of this issue shifting order
	*/
	public void setTugBoat(java.lang.String tugBoat) {
		_issueShiftingOrder.setTugBoat(tugBoat);
	}

	/**
	* Returns the from of this issue shifting order.
	*
	* @return the from of this issue shifting order
	*/
	public java.lang.String getFrom() {
		return _issueShiftingOrder.getFrom();
	}

	/**
	* Sets the from of this issue shifting order.
	*
	* @param from the from of this issue shifting order
	*/
	public void setFrom(java.lang.String from) {
		_issueShiftingOrder.setFrom(from);
	}

	/**
	* Returns the to of this issue shifting order.
	*
	* @return the to of this issue shifting order
	*/
	public java.lang.String getTo() {
		return _issueShiftingOrder.getTo();
	}

	/**
	* Sets the to of this issue shifting order.
	*
	* @param to the to of this issue shifting order
	*/
	public void setTo(java.lang.String to) {
		_issueShiftingOrder.setTo(to);
	}

	/**
	* Returns the tax code of shipowners agents of this issue shifting order.
	*
	* @return the tax code of shipowners agents of this issue shifting order
	*/
	public java.lang.String getTaxCodeOfShipownersAgents() {
		return _issueShiftingOrder.getTaxCodeOfShipownersAgents();
	}

	/**
	* Sets the tax code of shipowners agents of this issue shifting order.
	*
	* @param taxCodeOfShipownersAgents the tax code of shipowners agents of this issue shifting order
	*/
	public void setTaxCodeOfShipownersAgents(
		java.lang.String taxCodeOfShipownersAgents) {
		_issueShiftingOrder.setTaxCodeOfShipownersAgents(taxCodeOfShipownersAgents);
	}

	/**
	* Returns the name of shipowners agents of this issue shifting order.
	*
	* @return the name of shipowners agents of this issue shifting order
	*/
	public java.lang.String getNameOfShipownersAgents() {
		return _issueShiftingOrder.getNameOfShipownersAgents();
	}

	/**
	* Sets the name of shipowners agents of this issue shifting order.
	*
	* @param nameOfShipownersAgents the name of shipowners agents of this issue shifting order
	*/
	public void setNameOfShipownersAgents(
		java.lang.String nameOfShipownersAgents) {
		_issueShiftingOrder.setNameOfShipownersAgents(nameOfShipownersAgents);
	}

	/**
	* Returns the ship agency address of this issue shifting order.
	*
	* @return the ship agency address of this issue shifting order
	*/
	public java.lang.String getShipAgencyAddress() {
		return _issueShiftingOrder.getShipAgencyAddress();
	}

	/**
	* Sets the ship agency address of this issue shifting order.
	*
	* @param shipAgencyAddress the ship agency address of this issue shifting order
	*/
	public void setShipAgencyAddress(java.lang.String shipAgencyAddress) {
		_issueShiftingOrder.setShipAgencyAddress(shipAgencyAddress);
	}

	/**
	* Returns the ship agency phone of this issue shifting order.
	*
	* @return the ship agency phone of this issue shifting order
	*/
	public java.lang.String getShipAgencyPhone() {
		return _issueShiftingOrder.getShipAgencyPhone();
	}

	/**
	* Sets the ship agency phone of this issue shifting order.
	*
	* @param shipAgencyPhone the ship agency phone of this issue shifting order
	*/
	public void setShipAgencyPhone(java.lang.String shipAgencyPhone) {
		_issueShiftingOrder.setShipAgencyPhone(shipAgencyPhone);
	}

	/**
	* Returns the ship agency fax of this issue shifting order.
	*
	* @return the ship agency fax of this issue shifting order
	*/
	public java.lang.String getShipAgencyFax() {
		return _issueShiftingOrder.getShipAgencyFax();
	}

	/**
	* Sets the ship agency fax of this issue shifting order.
	*
	* @param shipAgencyFax the ship agency fax of this issue shifting order
	*/
	public void setShipAgencyFax(java.lang.String shipAgencyFax) {
		_issueShiftingOrder.setShipAgencyFax(shipAgencyFax);
	}

	/**
	* Returns the ship agency email of this issue shifting order.
	*
	* @return the ship agency email of this issue shifting order
	*/
	public java.lang.String getShipAgencyEmail() {
		return _issueShiftingOrder.getShipAgencyEmail();
	}

	/**
	* Sets the ship agency email of this issue shifting order.
	*
	* @param shipAgencyEmail the ship agency email of this issue shifting order
	*/
	public void setShipAgencyEmail(java.lang.String shipAgencyEmail) {
		_issueShiftingOrder.setShipAgencyEmail(shipAgencyEmail);
	}
