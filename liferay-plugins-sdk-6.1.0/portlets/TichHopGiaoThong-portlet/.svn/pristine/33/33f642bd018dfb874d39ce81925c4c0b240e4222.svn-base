...
/**
 * The base implementation of the temp crew list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCrewListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCrewListLocalServiceBaseImpl
	implements TempCrewListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCrewListLocalServiceUtil} to access the temp crew list local service.
	 */
	 ...
	 */
	public TempCrewList addTempCrewList(TempCrewList tempCrewList)
		throws SystemException {
		tempCrewList.setNew(true);

		tempCrewList = tempCrewListPersistence.update(tempCrewList, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempCrewList);
			}
	...
	public TempCrewList createTempCrewList(long id) {
		return tempCrewListPersistence.create(id);
	}
	...
	public void deleteTempCrewList(long id)
		...
		TempCrewList tempCrewList = tempCrewListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCrewList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteTempCrewList(TempCrewList tempCrewList)
		throws SystemException {
		tempCrewListPersistence.remove(tempCrewList);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCrewListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCrewList fetchTempCrewList(long id) throws SystemException {
		return tempCrewListPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewList getTempCrewList(long id)
		throws PortalException, SystemException {
		return tempCrewListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCrewListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempCrewList> getTempCrewLists(int start, int end)
		throws SystemException {
		return tempCrewListPersistence.findAll(start, end);
	}
	...
	public int getTempCrewListsCount() throws SystemException {
		return tempCrewListPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCrewList updateTempCrewList(TempCrewList tempCrewList)
		throws SystemException {
	...
	public TempCrewList updateTempCrewList(TempCrewList tempCrewList,
		...
		tempCrewList = tempCrewListPersistence.update(tempCrewList, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCrewList",
			tempCrewListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCrewList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCrewListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCrewListLocalServiceBaseImpl.class);
