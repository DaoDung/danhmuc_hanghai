...
/**
 * The base implementation of the result declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ResultDeclarationLocalServiceBaseImpl
	implements ResultDeclarationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.result.service.ResultDeclarationLocalServiceUtil} to access the result declaration local service.
	 */
	...
	public ResultDeclaration addResultDeclaration(
		...
		resultDeclaration = resultDeclarationPersistence.update(resultDeclaration,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(resultDeclaration);
			}
	...
	public ResultDeclaration createResultDeclaration(long id) {
		return resultDeclarationPersistence.create(id);
	}
	...
	public void deleteResultDeclaration(long id)
		...
		ResultDeclaration resultDeclaration = resultDeclarationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resultDeclaration);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ResultDeclaration fetchResultDeclaration(long id)
		throws SystemException {
		return resultDeclarationPersistence.fetchByPrimaryKey(id);
	}
	...
	public ResultDeclaration getResultDeclaration(long id)
		throws PortalException, SystemException {
		return resultDeclarationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return resultDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ResultDeclaration> getResultDeclarations(int start, int end)
		throws SystemException {
		return resultDeclarationPersistence.findAll(start, end);
	}
	...
	public int getResultDeclarationsCount() throws SystemException {
		return resultDeclarationPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.ResultDeclaration",
			resultDeclarationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.ResultDeclaration");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = resultDeclarationPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ResultDeclarationLocalServiceBaseImpl.class);
