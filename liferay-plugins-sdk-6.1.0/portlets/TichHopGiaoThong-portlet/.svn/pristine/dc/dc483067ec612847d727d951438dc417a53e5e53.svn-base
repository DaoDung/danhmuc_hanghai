...
import vn.gt.dao.danhmuc.service.base.DmHistoryPortWharfLocalServiceBaseImpl;
...
public class DmHistoryPortWharfLocalServiceImpl
	extends DmHistoryPortWharfLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public vn.gt.dao.danhmuc.model.DmHistoryPortWharf findByPortWharfCodeAndSyncVersion(
		...
		try {
			return dmHistoryPortWharfPersistence.findByPortWharfCodeAndSyncVersion(portWharfCode, syncVersion);
