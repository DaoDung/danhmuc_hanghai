...
/**
 * The interface for the user sign local service.
 *
 * <p>
...
public interface UserSignLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserSignLocalServiceUtil} to access the user sign local service. Add custom service methods to {@link vn.gt.dao.common.service.impl.UserSignLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
