 ...
 * @author win_64
 */
public class InterfaceRequestClp extends BaseModelImpl<InterfaceRequest>
	implements InterfaceRequest {
	public InterfaceRequestClp() {
	}
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			InterfaceRequestLocalServiceUtil.addInterfaceRequest(this);
		}
		else {
			InterfaceRequestLocalServiceUtil.updateInterfaceRequest(this);
		}
	}

	@Override
	public InterfaceRequest toEscapedModel() {
		return (InterfaceRequest)Proxy.newProxyInstance(InterfaceRequest.class.getClassLoader(),
			new Class[] { InterfaceRequest.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		InterfaceRequestClp clone = new InterfaceRequestClp();
		...
		clone.setDocumentNameRef(getDocumentNameRef());
	...
	public int compareTo(InterfaceRequest interfaceRequest) {
		...
		if (getId() < interfaceRequest.getId()) {
			value = -1;
		}
		else if (getId() > interfaceRequest.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		InterfaceRequestClp interfaceRequest = null;

		try {
			interfaceRequest = (InterfaceRequestClp)obj;
		}
		catch (ClassCastException cce) {
			return false;
		}

		long primaryKey = interfaceRequest.getPrimaryKey();
	...
	public String toString() {
		...
		sb.append(", documentNameRef=");
		sb.append(getDocumentNameRef());
	...
	public String toXmlString() {
		...
		sb.append("vn.gt.dao.noticeandmessage.model.InterfaceRequest");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>documentNameRef</column-name><column-value><![CDATA[");
		sb.append(getDocumentNameRef());
		sb.append("]]></column-value></column>");
		sb.append(
