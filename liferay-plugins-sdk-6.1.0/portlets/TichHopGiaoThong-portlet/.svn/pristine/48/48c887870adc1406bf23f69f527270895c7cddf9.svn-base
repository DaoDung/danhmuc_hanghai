 ...
 * @author win_64
 */
public class DmDocTypeClp extends BaseModelImpl<DmDocType> implements DmDocType {
	public DmDocTypeClp() {
	}
	...
	public DmDocType toEscapedModel() {
		return (DmDocType)Proxy.newProxyInstance(DmDocType.class.getClassLoader(),
			new Class[] { DmDocType.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DmDocTypeClp clone = new DmDocTypeClp();
	...
	public boolean equals(Object obj) {
		...
		DmDocTypeClp dmDocType = null;

		try {
			dmDocType = (DmDocTypeClp)obj;
		}
