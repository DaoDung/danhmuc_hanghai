...
/**
 * The base implementation of the result competion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultCompetionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ResultCompetionLocalServiceBaseImpl
	implements ResultCompetionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public ResultCompetion addResultCompetion(ResultCompetion resultCompetion)
		throws SystemException {
		resultCompetion.setNew(true);

		resultCompetion = resultCompetionPersistence.update(resultCompetion,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(resultCompetion);
			}
	 ...
	 */
	public ResultCompetion createResultCompetion(long id) {
		return resultCompetionPersistence.create(id);
	}
	...
	public void deleteResultCompetion(long id)
		...
		ResultCompetion resultCompetion = resultCompetionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resultCompetion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteResultCompetion(ResultCompetion resultCompetion)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultCompetionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultCompetionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ResultCompetion fetchResultCompetion(long id)
		throws SystemException {
		return resultCompetionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResultCompetion getResultCompetion(long id)
		throws PortalException, SystemException {
		return resultCompetionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return resultCompetionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResultCompetion> getResultCompetions(int start, int end)
		throws SystemException {
		return resultCompetionPersistence.findAll(start, end);
	}
	...
	public int getResultCompetionsCount() throws SystemException {
		return resultCompetionPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResultCompetion updateResultCompetion(
		ResultCompetion resultCompetion) throws SystemException {
	 ...
	 */
	public ResultCompetion updateResultCompetion(
		ResultCompetion resultCompetion, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.ResultCompetion",
			resultCompetionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.ResultCompetion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = resultCompetionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ResultCompetionLocalServiceBaseImpl.class);
