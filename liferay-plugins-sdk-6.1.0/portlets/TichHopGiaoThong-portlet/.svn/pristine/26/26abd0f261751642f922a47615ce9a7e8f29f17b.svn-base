...
public class DmArrivalPurposeClp extends BaseModelImpl<DmArrivalPurpose>
	...
	public DmArrivalPurpose toEscapedModel() {
		return (DmArrivalPurpose)Proxy.newProxyInstance(DmArrivalPurpose.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmArrivalPurposeClp dmArrivalPurpose = null;

		try {
			dmArrivalPurpose = (DmArrivalPurposeClp)obj;
		}
