...
public class GeneralDeclaration2Temp {
	...
	private static Log log = LogFactoryUtil.getLog(GeneralDeclaration2Temp.class);
	...
	public boolean insert2Temp(GeneralDeclaration generalDeclaration, Header header) throws Exception {
		...
		try {
			...
			object.setDocumentReference(FormatData.convertToLong(generalDeclaration.getDocumentReference()));
			...
			object.setQrCode(generalDeclaration.getQCCode());
			...
			object.setDo_(generalDeclaration.getDO());
