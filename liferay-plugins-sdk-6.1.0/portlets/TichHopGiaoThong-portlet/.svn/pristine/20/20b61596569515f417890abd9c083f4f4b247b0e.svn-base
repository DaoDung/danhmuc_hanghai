...
public class IssueShiftingOrderLocalServiceWrapper
	...
	*/
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.IssueShiftingOrder> findIssueShiftingOrderInfoByCertificateNumber(
		...
		java.lang.String shipDateTo, java.lang.String certificateNumber,
		int start, int end) {
		return _issueShiftingOrderLocalService.findIssueShiftingOrderInfoByCertificateNumber(requestState,
			maritimeCode, portCode, shipName, callSign, shipDateFrom,
			shipDateTo, certificateNumber, start, end);
	}
	...
	public int countIssueShiftingOrderInfoByCertificateNumber(
		...
		java.lang.String callSign, java.lang.String shipDateFrom,
		java.lang.String shipDateTo, java.lang.String certificateNumber) {
		return _issueShiftingOrderLocalService.countIssueShiftingOrderInfoByCertificateNumber(requestState,
			maritimeCode, portCode, shipName, callSign, shipDateFrom,
			shipDateTo, certificateNumber);
	}
