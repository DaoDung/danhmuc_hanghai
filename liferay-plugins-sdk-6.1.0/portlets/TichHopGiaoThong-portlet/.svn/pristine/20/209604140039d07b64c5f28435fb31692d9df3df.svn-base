...
public class TempDocumentWrapper implements TempDocument,
	...
	*/
	...
	/**
	* Returns the upgrade version of this temp document.
	*
	* @return the upgrade version of this temp document
	*/
	public int getUpgradeVersion() {
		return _tempDocument.getUpgradeVersion();
	}

	/**
	* Sets the upgrade version of this temp document.
	*
	* @param upgradeVersion the upgrade version of this temp document
	*/
	public void setUpgradeVersion(int upgradeVersion) {
		_tempDocument.setUpgradeVersion(upgradeVersion);
	}

	/**
	* Returns the name of shipowners agents of this temp document.
	*
	* @return the name of shipowners agents of this temp document
	*/
	public java.lang.String getNameOfShipownersAgents() {
		return _tempDocument.getNameOfShipownersAgents();
	}

	/**
	* Sets the name of shipowners agents of this temp document.
	*
	* @param nameOfShipownersAgents the name of shipowners agents of this temp document
	*/
	public void setNameOfShipownersAgents(
		java.lang.String nameOfShipownersAgents) {
		_tempDocument.setNameOfShipownersAgents(nameOfShipownersAgents);
	}
