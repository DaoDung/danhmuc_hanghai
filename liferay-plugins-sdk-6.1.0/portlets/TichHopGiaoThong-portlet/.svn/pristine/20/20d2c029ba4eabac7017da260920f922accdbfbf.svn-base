...
/**
 * The base implementation of the issue permission for transit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssuePermissionForTransitLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssuePermissionForTransitLocalServiceBaseImpl
	implements IssuePermissionForTransitLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssuePermissionForTransitLocalServiceUtil} to access the issue permission for transit local service.
	 */
	 ...
	 */
	public IssuePermissionForTransit addIssuePermissionForTransit(
		IssuePermissionForTransit issuePermissionForTransit)
		throws SystemException {
		issuePermissionForTransit.setNew(true);

		issuePermissionForTransit = issuePermissionForTransitPersistence.update(issuePermissionForTransit,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issuePermissionForTransit);
			}
	...
	public IssuePermissionForTransit createIssuePermissionForTransit(long id) {
		return issuePermissionForTransitPersistence.create(id);
	}
	...
	public void deleteIssuePermissionForTransit(long id)
		...
		IssuePermissionForTransit issuePermissionForTransit = issuePermissionForTransitPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issuePermissionForTransit);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteIssuePermissionForTransit(
		IssuePermissionForTransit issuePermissionForTransit)
		throws SystemException {
		issuePermissionForTransitPersistence.remove(issuePermissionForTransit);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issuePermissionForTransitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issuePermissionForTransitPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssuePermissionForTransit fetchIssuePermissionForTransit(long id)
		throws SystemException {
		return issuePermissionForTransitPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssuePermissionForTransit getIssuePermissionForTransit(long id)
		throws PortalException, SystemException {
		return issuePermissionForTransitPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issuePermissionForTransitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssuePermissionForTransit> getIssuePermissionForTransits(
		int start, int end) throws SystemException {
		return issuePermissionForTransitPersistence.findAll(start, end);
	}
	...
	public int getIssuePermissionForTransitsCount() throws SystemException {
		return issuePermissionForTransitPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssuePermissionForTransit",
			issuePermissionForTransitLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssuePermissionForTransit");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issuePermissionForTransitPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssuePermissionForTransitLocalServiceBaseImpl.class);
