...
/**
 * The base implementation of the dm history port region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPortRegionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryPortRegionLocalServiceBaseImpl
	implements DmHistoryPortRegionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPortRegion addDmHistoryPortRegion(
		...
		dmHistoryPortRegion = dmHistoryPortRegionPersistence.update(dmHistoryPortRegion,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPortRegion);
			}
	...
	public DmHistoryPortRegion createDmHistoryPortRegion(int id) {
		return dmHistoryPortRegionPersistence.create(id);
	}
	...
	public void deleteDmHistoryPortRegion(int id)
		...
		DmHistoryPortRegion dmHistoryPortRegion = dmHistoryPortRegionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPortRegion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryPortRegionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortRegionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPortRegion fetchDmHistoryPortRegion(int id)
		throws SystemException {
		return dmHistoryPortRegionPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPortRegion getDmHistoryPortRegion(int id)
		throws PortalException, SystemException {
		return dmHistoryPortRegionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPortRegionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPortRegion> getDmHistoryPortRegions(int start, int end)
		throws SystemException {
		return dmHistoryPortRegionPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPortRegionsCount() throws SystemException {
		return dmHistoryPortRegionPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPortRegion",
			dmHistoryPortRegionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPortRegion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPortRegionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPortRegionLocalServiceBaseImpl.class);
