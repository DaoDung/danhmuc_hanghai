...
/**
 * The base implementation of the temp ship stores declaration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempShipStoresDeclarationServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempShipStoresDeclarationServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempShipStoresDeclarationServiceUtil
 * @generated
 */
public abstract class TempShipStoresDeclarationServiceBaseImpl
	extends PrincipalBean implements TempShipStoresDeclarationService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempShipStoresDeclarationServiceUtil} to access the temp ship stores declaration remote service.
	 */
