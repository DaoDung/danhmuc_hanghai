...
<%
	...
	// Sua giay phep roi cang cho tau bien Vietnam
				...
				<tr>
					...
					<td class="text-leftu">
						<input type="text" class="egov-inputfield" readonly="readonly" style="width: 98%"
								name="nameOfship" id="nameOfship" value="<%=tempDoc.getShipName()%>">
					</td>
				</tr>
				...
				<tr>
					...
					<td class="text-leftu" colspan="2">
						...
						<input readonly="readonly" type="text" name="numberOfCrews" id="numberOfCrews" style="width: 48%"
								value="<%= (Validator.isNotNull(lstTempCrewDetails)) ? lstTempCrewDetails.size() : 0%>"/>
				...
				<tr>
					...
					<td class="text-leftu" >
						<input type="text" style="width: 48.7%" readonly="readonly"
								...
								value="<%= (Validator.isNotNull(lstTempPassengerDetails)) ? lstTempPassengerDetails.size() : StringPool.BLANK%>"/>
				...
				<tr hidden="true">
					...
					<td class="text-leftu">
						<input type="text" style="width: 48%" class="egov-inputfield"
								...
								value="<%= (Validator.isNotNull(banKhaiChungLast.getVolumeCargo()) ? banKhaiChungLast.getVolumeCargo() : StringPool.BLANK)%>">
												
						<!-- Cho phep thay doi don vi hang hoa-->
						...
						<%} else {%>
							<select id="cangroi" name="cangroi" style="width: 98%">
								<%for (DmPort port : ports) {%>
									<option <%=port.getPortCode().equalsIgnoreCase(banKhaiChungLast.getPortOfArrivalCode().trim()) ? "selected" : ""%>
