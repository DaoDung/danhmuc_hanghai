...
/**
 * The interface for the dm port harbour local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see DmPortHarbourLocalServiceUtil
...
public interface DmPortHarbourLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DmPortHarbourLocalServiceUtil} to access the dm port harbour local service. Add custom service methods to {@link vn.gt.dao.danhmuc.service.impl.DmPortHarbourLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
