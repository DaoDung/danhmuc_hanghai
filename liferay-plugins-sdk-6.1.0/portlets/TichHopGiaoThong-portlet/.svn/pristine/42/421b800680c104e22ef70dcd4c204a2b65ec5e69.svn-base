...
/**
 * The base implementation of the interface request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.InterfaceRequestServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.InterfaceRequestServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.InterfaceRequestServiceUtil
 * @generated
 */
public abstract class InterfaceRequestServiceBaseImpl extends PrincipalBean
	implements InterfaceRequestService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.InterfaceRequestServiceUtil} to access the interface request remote service.
	 */
