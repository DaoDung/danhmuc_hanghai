...
public class TT5TichHopMessageUtils {

	private static Log _log = LogFactoryUtil.getLog(TT5TichHopMessageUtils.class);
	...
	public static boolean message_99_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.XUAT_CANG_DAU_KHI, function, MessageType.HO_SO,
	...
	public static boolean message_99_30(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.XUAT_CANG_DAU_KHI, function, MessageType.TYPE_THONG_BAO_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_99_31(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.XUAT_CANG_DAU_KHI, function, MessageType.TYPE_THONG_BAO_XAC_NHAN_NOP_PHI,
					userName, interfaceRequest);
	...
	public static boolean message_10_21(String userName, UploadPortletRequest uploadPortletRequest,
		...
		try {
			...
			Header header = BusinessUtils.createHeader(tempDocument, MessageType.XUAT_CANG_DAU_KHI, function,
