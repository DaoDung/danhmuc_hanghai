...
/**
 * The base implementation of the dm ship type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmShipTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmShipTypeLocalServiceBaseImpl
	implements DmShipTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmShipType addDmShipType(DmShipType dmShipType)
		...
		dmShipType = dmShipTypePersistence.update(dmShipType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmShipType);
			}
	...
	public DmShipType createDmShipType(int id) {
		return dmShipTypePersistence.create(id);
	}
	...
	public void deleteDmShipType(int id)
		...
		DmShipType dmShipType = dmShipTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmShipType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteDmShipType(DmShipType dmShipType)
		throws SystemException {
		dmShipTypePersistence.remove(dmShipType);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmShipTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmShipTypePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmShipTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmShipType fetchDmShipType(int id) throws SystemException {
		return dmShipTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmShipType getDmShipType(int id)
		throws PortalException, SystemException {
		return dmShipTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmShipTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmShipType> getDmShipTypes(int start, int end)
		throws SystemException {
		return dmShipTypePersistence.findAll(start, end);
	}
	...
	public int getDmShipTypesCount() throws SystemException {
		return dmShipTypePersistence.countAll();
	}
	 ...
	 *
	 * @param dmShipType the dm ship type
	 * @param merge whether to merge the dm ship type with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm ship type that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmShipType updateDmShipType(DmShipType dmShipType, boolean merge)
		...
		dmShipType = dmShipTypePersistence.update(dmShipType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmShipType",
			dmShipTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmShipType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmShipTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmShipTypeLocalServiceBaseImpl.class);
