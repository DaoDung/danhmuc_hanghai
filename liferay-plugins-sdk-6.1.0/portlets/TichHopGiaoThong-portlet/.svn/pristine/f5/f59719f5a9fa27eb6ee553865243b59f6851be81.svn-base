...
/**
 * The base implementation of the dm history port wharf local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPortWharfLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryPortWharfLocalServiceBaseImpl
	implements DmHistoryPortWharfLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPortWharf addDmHistoryPortWharf(
		...
		dmHistoryPortWharf = dmHistoryPortWharfPersistence.update(dmHistoryPortWharf,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPortWharf);
			}
	...
	public DmHistoryPortWharf createDmHistoryPortWharf(int id) {
		return dmHistoryPortWharfPersistence.create(id);
	}
	...
	public void deleteDmHistoryPortWharf(int id)
		...
		DmHistoryPortWharf dmHistoryPortWharf = dmHistoryPortWharfPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPortWharf);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortWharfPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPortWharfPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPortWharf fetchDmHistoryPortWharf(int id)
		throws SystemException {
		return dmHistoryPortWharfPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPortWharf getDmHistoryPortWharf(int id)
		throws PortalException, SystemException {
		return dmHistoryPortWharfPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPortWharfPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPortWharf> getDmHistoryPortWharfs(int start, int end)
		throws SystemException {
		return dmHistoryPortWharfPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPortWharfsCount() throws SystemException {
		return dmHistoryPortWharfPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPortWharf",
			dmHistoryPortWharfLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPortWharf");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPortWharfPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPortWharfLocalServiceBaseImpl.class);
