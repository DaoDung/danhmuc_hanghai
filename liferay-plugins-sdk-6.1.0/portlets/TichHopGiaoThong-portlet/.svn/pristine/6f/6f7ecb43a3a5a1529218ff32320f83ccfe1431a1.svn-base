...
/**
 * The base implementation of the temp person list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPersonListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempPersonListLocalServiceBaseImpl
	implements TempPersonListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempPersonList addTempPersonList(TempPersonList tempPersonList)
		...
		tempPersonList = tempPersonListPersistence.update(tempPersonList, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(tempPersonList);
			}
	...
	public TempPersonList createTempPersonList(long id) {
		return tempPersonListPersistence.create(id);
	}
	...
	public void deleteTempPersonList(long id)
		...
		TempPersonList tempPersonList = tempPersonListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempPersonList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempPersonList(TempPersonList tempPersonList)
		throws SystemException {
		tempPersonListPersistence.remove(tempPersonList);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPersonListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempPersonListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempPersonList fetchTempPersonList(long id)
		throws SystemException {
		return tempPersonListPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempPersonList getTempPersonList(long id)
		throws PortalException, SystemException {
		return tempPersonListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempPersonListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempPersonList> getTempPersonLists(int start, int end)
		throws SystemException {
		return tempPersonListPersistence.findAll(start, end);
	}
	...
	public int getTempPersonListsCount() throws SystemException {
		return tempPersonListPersistence.countAll();
	}
	...
	public TempPersonList updateTempPersonList(TempPersonList tempPersonList,
		...
		tempPersonList = tempPersonListPersistence.update(tempPersonList, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempPersonList",
			tempPersonListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempPersonList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempPersonListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempPersonListLocalServiceBaseImpl.class);
