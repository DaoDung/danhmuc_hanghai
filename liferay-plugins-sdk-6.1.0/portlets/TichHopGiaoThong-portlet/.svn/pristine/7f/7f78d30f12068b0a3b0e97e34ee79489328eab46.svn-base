...
/**
 * The interface for the dm port local service.
 *
 * <p>
...
public interface DmPortLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DmPortLocalServiceUtil} to access the dm port local service. Add custom service methods to {@link vn.gt.dao.danhmuc.service.impl.DmPortLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
