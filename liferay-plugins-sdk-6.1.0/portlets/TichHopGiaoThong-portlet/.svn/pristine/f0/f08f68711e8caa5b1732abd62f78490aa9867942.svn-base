...
/**
 * The base implementation of the dm history representative local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryRepresentativeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryRepresentativeLocalServiceBaseImpl
	implements DmHistoryRepresentativeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryRepresentative addDmHistoryRepresentative(
		...
		dmHistoryRepresentative = dmHistoryRepresentativePersistence.update(dmHistoryRepresentative,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryRepresentative);
			}
	...
	public DmHistoryRepresentative createDmHistoryRepresentative(int id) {
		return dmHistoryRepresentativePersistence.create(id);
	}
	...
	public void deleteDmHistoryRepresentative(int id)
		...
		DmHistoryRepresentative dmHistoryRepresentative = dmHistoryRepresentativePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryRepresentative);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryRepresentativePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryRepresentativePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryRepresentative fetchDmHistoryRepresentative(int id)
		throws SystemException {
		return dmHistoryRepresentativePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryRepresentative getDmHistoryRepresentative(int id)
		throws PortalException, SystemException {
		return dmHistoryRepresentativePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryRepresentativePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryRepresentative> getDmHistoryRepresentatives(
		...
		return dmHistoryRepresentativePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryRepresentativesCount() throws SystemException {
		return dmHistoryRepresentativePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryRepresentative",
			dmHistoryRepresentativeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryRepresentative");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryRepresentativePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryRepresentativeLocalServiceBaseImpl.class);
