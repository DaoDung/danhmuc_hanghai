...
public class PortClearance {
    ...
    protected List<PortClearance.CargoList> cargoList;
    @XmlElement(name = "AttachedFile", required = true)
    protected PortClearance.AttachedFile attachedFile;
     ...
     * {@link PortClearance.CargoList }
     * 
     * 
     */
    public List<PortClearance.CargoList> getCargoList() {
        if (cargoList == null) {
            cargoList = new ArrayList<PortClearance.CargoList>();
        }
     ...
     * @return
     *     possible object is
     *     {@link PortClearance.AttachedFile }
     *     
     */
    public PortClearance.AttachedFile getAttachedFile() {
        return attachedFile;
    }
     ...
     *     
     */
    public void setAttachedFile(PortClearance.AttachedFile value) {
