...
/**
 * The base implementation of the notice ship message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.NoticeShipMessageLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.NoticeShipMessageLocalServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.NoticeShipMessageLocalServiceUtil
 * @generated
 */
public abstract class NoticeShipMessageLocalServiceBaseImpl
	implements NoticeShipMessageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.NoticeShipMessageLocalServiceUtil} to access the notice ship message local service.
	 */
	 ...
	 */
	public NoticeShipMessage addNoticeShipMessage(
		NoticeShipMessage noticeShipMessage) throws SystemException {
		noticeShipMessage.setNew(true);

		noticeShipMessage = noticeShipMessagePersistence.update(noticeShipMessage,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(noticeShipMessage);
			}
	 ...
	 */
	public NoticeShipMessage createNoticeShipMessage(long id) {
		return noticeShipMessagePersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteNoticeShipMessage(long id)
		throws PortalException, SystemException {
		NoticeShipMessage noticeShipMessage = noticeShipMessagePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(noticeShipMessage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteNoticeShipMessage(NoticeShipMessage noticeShipMessage)
		throws SystemException {
		noticeShipMessagePersistence.remove(noticeShipMessage);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return noticeShipMessagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return noticeShipMessagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public NoticeShipMessage fetchNoticeShipMessage(long id)
		throws SystemException {
		return noticeShipMessagePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NoticeShipMessage getNoticeShipMessage(long id)
		throws PortalException, SystemException {
		return noticeShipMessagePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return noticeShipMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<NoticeShipMessage> getNoticeShipMessages(int start, int end)
		throws SystemException {
		return noticeShipMessagePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getNoticeShipMessagesCount() throws SystemException {
		return noticeShipMessagePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public NoticeShipMessage updateNoticeShipMessage(
		NoticeShipMessage noticeShipMessage) throws SystemException {
		return updateNoticeShipMessage(noticeShipMessage, true);
	}
	 ...
	 *
	 * @param noticeShipMessage the notice ship message
	 * @param merge whether to merge the notice ship message with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the notice ship message that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public NoticeShipMessage updateNoticeShipMessage(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.NoticeShipMessage",
			noticeShipMessageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.NoticeShipMessage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = noticeShipMessagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(NoticeShipMessageLocalServiceBaseImpl.class);
