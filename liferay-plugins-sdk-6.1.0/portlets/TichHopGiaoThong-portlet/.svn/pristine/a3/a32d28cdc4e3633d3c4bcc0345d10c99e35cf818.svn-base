 ...
 * 
 */
public class PTTNDGeneralDeclarationValidation {

	public boolean validation(PTTNDGeneralDeclaration generalDeclaration,
...
//		}
	...
	private void insertShipAgency(PTTNDGeneralDeclaration generalDeclaration)
