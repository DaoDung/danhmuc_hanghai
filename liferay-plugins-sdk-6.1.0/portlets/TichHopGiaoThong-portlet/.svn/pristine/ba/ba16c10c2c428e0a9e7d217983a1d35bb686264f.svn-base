...
/**
 * The base implementation of the dm history package local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryPackageLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.DmHistoryPackageLocalServiceImpl
 * @see vn.gt.dao.danhmuc.service.DmHistoryPackageLocalServiceUtil
 * @generated
 */
public abstract class DmHistoryPackageLocalServiceBaseImpl
	implements DmHistoryPackageLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPackage addDmHistoryPackage(
		...
		dmHistoryPackage = dmHistoryPackagePersistence.update(dmHistoryPackage,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryPackage);
			}
	...
	public DmHistoryPackage createDmHistoryPackage(int id) {
		return dmHistoryPackagePersistence.create(id);
	}
	...
	public void deleteDmHistoryPackage(int id)
		...
		DmHistoryPackage dmHistoryPackage = dmHistoryPackagePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryPackage);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPackagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryPackagePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryPackage fetchDmHistoryPackage(int id)
		throws SystemException {
		return dmHistoryPackagePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryPackage getDmHistoryPackage(int id)
		throws PortalException, SystemException {
		return dmHistoryPackagePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryPackagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryPackage> getDmHistoryPackages(int start, int end)
		throws SystemException {
		return dmHistoryPackagePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryPackagesCount() throws SystemException {
		return dmHistoryPackagePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryPackage",
			dmHistoryPackageLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryPackage");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryPackagePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryPackageLocalServiceBaseImpl.class);
