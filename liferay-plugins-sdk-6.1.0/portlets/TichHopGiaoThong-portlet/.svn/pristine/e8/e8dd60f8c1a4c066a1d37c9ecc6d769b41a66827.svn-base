...
public class DLFolderUtil {
	...
	private static Log _log = LogFactoryUtil.getLog(DLFolderUtil.class.getName());
	...
	public static DLFolder addFolder(long userId, long groupId, long repositoryId, boolean mountPoint,
		...
		try {
			if (hasFolder(groupId, parentFolderId, name)) {
				...
				System.out.println("DLFolderUtil.addFolder(user)"+user);
	...
	public static void setFolderPermissions(Folder folder) throws Exception {
		...
		ResourceAction resourceAction = ResourceActionLocalServiceUtil.getResourceAction(DLFolder.class.getName(),
				ActionKeys.VIEW);
		String[] actionIdsGuest = new String[] { ActionKeys.VIEW, ActionKeys.ACCESS };
		String[] actionIds = new String[] { ActionKeys.VIEW, ActionKeys.ACCESS, ActionKeys.SUBSCRIBE,
				ActionKeys.ADD_DOCUMENT, ActionKeys.UPDATE, ActionKeys.ADD_SHORTCUT, ActionKeys.ADD_SUBFOLDER,
				ActionKeys.PERMISSIONS, ActionKeys.DELETE };
		try {
			ResourcePermissionLocalServiceUtil.setResourcePermissions(folder.getCompanyId(), DLFolder.class.getName(),
					ResourceConstants.SCOPE_INDIVIDUAL, String.valueOf(folder.getPrimaryKey()),
	...
	public static void setFolderPermissions(DLFolder folder) throws Exception {
		...
		ResourceAction resourceAction = ResourceActionLocalServiceUtil.getResourceAction(DLFolder.class.getName(),
				ActionKeys.VIEW);
		String[] actionIdsGuest = new String[] { ActionKeys.VIEW, ActionKeys.ACCESS };
		String[] actionIds = new String[] { ActionKeys.VIEW, ActionKeys.ACCESS,
				ActionKeys.ADD_DOCUMENT, ActionKeys.UPDATE, ActionKeys.ADD_SHORTCUT, ActionKeys.ADD_SUBFOLDER,
				ActionKeys.PERMISSIONS, ActionKeys.DELETE };
		try {
			ResourcePermissionLocalServiceUtil.setResourcePermissions(folder.getCompanyId(), DLFolder.class.getName(),
