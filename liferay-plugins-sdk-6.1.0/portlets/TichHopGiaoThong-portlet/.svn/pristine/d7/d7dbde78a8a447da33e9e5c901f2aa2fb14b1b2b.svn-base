...
/**
 * The base implementation of the issue acceptance local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssueAcceptanceLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssueAcceptanceLocalServiceBaseImpl
	implements IssueAcceptanceLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssueAcceptanceLocalServiceUtil} to access the issue acceptance local service.
	 */
	 ...
	 */
	public IssueAcceptance addIssueAcceptance(IssueAcceptance issueAcceptance)
		throws SystemException {
		issueAcceptance.setNew(true);

		issueAcceptance = issueAcceptancePersistence.update(issueAcceptance,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issueAcceptance);
			}
	...
	public IssueAcceptance createIssueAcceptance(long id) {
		return issueAcceptancePersistence.create(id);
	}
	...
	public void deleteIssueAcceptance(long id)
		...
		IssueAcceptance issueAcceptance = issueAcceptancePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issueAcceptance);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteIssueAcceptance(IssueAcceptance issueAcceptance)
		throws SystemException {
		issueAcceptancePersistence.remove(issueAcceptance);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueAcceptancePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueAcceptancePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssueAcceptance fetchIssueAcceptance(long id)
		throws SystemException {
		return issueAcceptancePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueAcceptance getIssueAcceptance(long id)
		throws PortalException, SystemException {
		return issueAcceptancePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueAcceptancePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssueAcceptance> getIssueAcceptances(int start, int end)
		throws SystemException {
		return issueAcceptancePersistence.findAll(start, end);
	}
	...
	public int getIssueAcceptancesCount() throws SystemException {
		return issueAcceptancePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueAcceptance updateIssueAcceptance(
		IssueAcceptance issueAcceptance) throws SystemException {
	 ...
	 */
	public IssueAcceptance updateIssueAcceptance(
		IssueAcceptance issueAcceptance, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssueAcceptance",
			issueAcceptanceLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssueAcceptance");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueAcceptancePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssueAcceptanceLocalServiceBaseImpl.class);
