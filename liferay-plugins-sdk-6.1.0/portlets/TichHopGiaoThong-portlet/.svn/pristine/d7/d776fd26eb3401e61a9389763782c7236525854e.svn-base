...
/**
 * The base implementation of the dm history unit general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryUnitGeneralLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryUnitGeneralLocalServiceBaseImpl
	implements DmHistoryUnitGeneralLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryUnitGeneral addDmHistoryUnitGeneral(
		...
		dmHistoryUnitGeneral = dmHistoryUnitGeneralPersistence.update(dmHistoryUnitGeneral,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryUnitGeneral);
			}
	...
	public DmHistoryUnitGeneral createDmHistoryUnitGeneral(int id) {
		return dmHistoryUnitGeneralPersistence.create(id);
	}
	...
	public void deleteDmHistoryUnitGeneral(int id)
		...
		DmHistoryUnitGeneral dmHistoryUnitGeneral = dmHistoryUnitGeneralPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryUnitGeneral);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryUnitGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryUnitGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryUnitGeneral fetchDmHistoryUnitGeneral(int id)
		throws SystemException {
		return dmHistoryUnitGeneralPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryUnitGeneral getDmHistoryUnitGeneral(int id)
		throws PortalException, SystemException {
		return dmHistoryUnitGeneralPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryUnitGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryUnitGeneral> getDmHistoryUnitGenerals(int start,
		...
		return dmHistoryUnitGeneralPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryUnitGeneralsCount() throws SystemException {
		return dmHistoryUnitGeneralPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryUnitGeneral",
			dmHistoryUnitGeneralLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryUnitGeneral");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryUnitGeneralPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryUnitGeneralLocalServiceBaseImpl.class);
