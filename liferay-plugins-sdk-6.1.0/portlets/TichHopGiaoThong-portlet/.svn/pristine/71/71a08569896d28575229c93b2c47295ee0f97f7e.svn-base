...
public class DmHistoryGoodsClp extends BaseModelImpl<DmHistoryGoods>
	...
	public DmHistoryGoods toEscapedModel() {
		return (DmHistoryGoods)Proxy.newProxyInstance(DmHistoryGoods.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmHistoryGoodsClp dmHistoryGoods = null;

		try {
			dmHistoryGoods = (DmHistoryGoodsClp)obj;
		}
