...
/**
 * The base implementation of the tham so he thong local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.ThamSoHeThongLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ThamSoHeThongLocalServiceBaseImpl
	implements ThamSoHeThongLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.ThamSoHeThongLocalServiceUtil} to access the tham so he thong local service.
	 */
	 ...
	 */
	public ThamSoHeThong addThamSoHeThong(ThamSoHeThong thamSoHeThong)
		throws SystemException {
		thamSoHeThong.setNew(true);

		thamSoHeThong = thamSoHeThongPersistence.update(thamSoHeThong, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(thamSoHeThong);
			}
	 ...
	 */
	public ThamSoHeThong createThamSoHeThong(long id) {
		return thamSoHeThongPersistence.create(id);
	}
	...
	public void deleteThamSoHeThong(long id)
		...
		ThamSoHeThong thamSoHeThong = thamSoHeThongPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(thamSoHeThong);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteThamSoHeThong(ThamSoHeThong thamSoHeThong)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return thamSoHeThongPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thamSoHeThongPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ThamSoHeThong fetchThamSoHeThong(long id) throws SystemException {
		return thamSoHeThongPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ThamSoHeThong getThamSoHeThong(long id)
		throws PortalException, SystemException {
		return thamSoHeThongPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thamSoHeThongPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ThamSoHeThong> getThamSoHeThongs(int start, int end)
		throws SystemException {
		return thamSoHeThongPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getThamSoHeThongsCount() throws SystemException {
		return thamSoHeThongPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ThamSoHeThong updateThamSoHeThong(ThamSoHeThong thamSoHeThong)
		throws SystemException {
		return updateThamSoHeThong(thamSoHeThong, true);
	}
	...
	public ThamSoHeThong updateThamSoHeThong(ThamSoHeThong thamSoHeThong,
		...
		thamSoHeThong = thamSoHeThongPersistence.update(thamSoHeThong, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.ThamSoHeThong",
			thamSoHeThongLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.ThamSoHeThong");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thamSoHeThongPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ThamSoHeThongLocalServiceBaseImpl.class);
