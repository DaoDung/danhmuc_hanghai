...
/**
 * The interface for the issue shifting order chanel local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see IssueShiftingOrderChanelLocalServiceUtil
...
public interface IssueShiftingOrderChanelLocalService
	extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IssueShiftingOrderChanelLocalServiceUtil} to access the issue shifting order chanel local service. Add custom service methods to {@link vn.gt.dao.noticeandmessage.service.impl.IssueShiftingOrderChanelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
