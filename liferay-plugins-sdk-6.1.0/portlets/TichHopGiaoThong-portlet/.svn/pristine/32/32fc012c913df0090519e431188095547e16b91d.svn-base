 ...
 * @author win_64
 */
public class RmdcShipClp extends BaseModelImpl<RmdcShip> implements RmdcShip {
	public RmdcShipClp() {
	}
	...
	public RmdcShip toEscapedModel() {
		return (RmdcShip)Proxy.newProxyInstance(RmdcShip.class.getClassLoader(),
			new Class[] { RmdcShip.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		RmdcShipClp clone = new RmdcShipClp();
	...
	public boolean equals(Object obj) {
		...
		RmdcShipClp rmdcShip = null;

		try {
			rmdcShip = (RmdcShipClp)obj;
		}
