...
public class InterfaceRequestFieldCacheModel implements CacheModel<InterfaceRequestField>,
	...
	public InterfaceRequestField toEntityModel() {
		...
		if (documentNameRef == null) {
			interfaceRequestFieldImpl.setDocumentNameRef(StringPool.BLANK);
		}
		else {
			interfaceRequestFieldImpl.setDocumentNameRef(documentNameRef);
		}
