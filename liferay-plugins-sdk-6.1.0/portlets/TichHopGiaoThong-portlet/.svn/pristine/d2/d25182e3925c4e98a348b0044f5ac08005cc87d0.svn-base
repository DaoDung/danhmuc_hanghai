...
/**
 * The base implementation of the temp attachment declaration health local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempAttachmentDeclarationHealthLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempAttachmentDeclarationHealthLocalServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempAttachmentDeclarationHealthLocalServiceUtil
 * @generated
 */
public abstract class TempAttachmentDeclarationHealthLocalServiceBaseImpl
	implements TempAttachmentDeclarationHealthLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempAttachmentDeclarationHealthLocalServiceUtil} to access the temp attachment declaration health local service.
	 */
	 ...
	 */
	public TempAttachmentDeclarationHealth addTempAttachmentDeclarationHealth(
		TempAttachmentDeclarationHealth tempAttachmentDeclarationHealth)
		throws SystemException {
		tempAttachmentDeclarationHealth.setNew(true);

		tempAttachmentDeclarationHealth = tempAttachmentDeclarationHealthPersistence.update(tempAttachmentDeclarationHealth,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempAttachmentDeclarationHealth);
			}
	 ...
	 */
	public TempAttachmentDeclarationHealth createTempAttachmentDeclarationHealth(
		long id) {
		return tempAttachmentDeclarationHealthPersistence.create(id);
	}
	...
	public void deleteTempAttachmentDeclarationHealth(long id)
		...
		TempAttachmentDeclarationHealth tempAttachmentDeclarationHealth = tempAttachmentDeclarationHealthPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempAttachmentDeclarationHealth);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempAttachmentDeclarationHealth(
		TempAttachmentDeclarationHealth tempAttachmentDeclarationHealth)
		throws SystemException {
		tempAttachmentDeclarationHealthPersistence.remove(tempAttachmentDeclarationHealth);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempAttachmentDeclarationHealth fetchTempAttachmentDeclarationHealth(
		long id) throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempAttachmentDeclarationHealth getTempAttachmentDeclarationHealth(
		long id) throws PortalException, SystemException {
		return tempAttachmentDeclarationHealthPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempAttachmentDeclarationHealthPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempAttachmentDeclarationHealth> getTempAttachmentDeclarationHealths(
		int start, int end) throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.findAll(start, end);
	}
	...
	public int getTempAttachmentDeclarationHealthsCount()
		throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempAttachmentDeclarationHealth updateTempAttachmentDeclarationHealth(
		TempAttachmentDeclarationHealth tempAttachmentDeclarationHealth)
		throws SystemException {
		return updateTempAttachmentDeclarationHealth(tempAttachmentDeclarationHealth,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempAttachmentDeclarationHealth",
			tempAttachmentDeclarationHealthLocalService);
	}
	...
	private static Log _log = LogFactoryUtil.getLog(TempAttachmentDeclarationHealthLocalServiceBaseImpl.class);
