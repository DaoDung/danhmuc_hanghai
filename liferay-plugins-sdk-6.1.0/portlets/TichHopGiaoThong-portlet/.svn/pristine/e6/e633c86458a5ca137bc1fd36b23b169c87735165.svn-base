 ...
 * @generated
 */
public class DmGtRouteConfigLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmucgt.model.DmGtRouteConfig addDmGtRouteConfig(
	...
	*/
	public static vn.gt.dao.danhmucgt.model.DmGtRouteConfig createDmGtRouteConfig(
		long id) {
	...
	*/
	...
	public static vn.gt.dao.danhmucgt.model.DmGtRouteConfig fetchDmGtRouteConfig(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmucgt.model.DmGtRouteConfig getDmGtRouteConfig(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmucgt.model.DmGtRouteConfig> getDmGtRouteConfigs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmucgt.model.DmGtRouteConfig updateDmGtRouteConfig(
		vn.gt.dao.danhmucgt.model.DmGtRouteConfig dmGtRouteConfig)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DmGtRouteConfigLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmGtRouteConfigLocalService.class.getName());
			...
			_service = new DmGtRouteConfigLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmGtRouteConfigLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmGtRouteConfigLocalService.class);
		}

		return _service;
	}

	public void setService(DmGtRouteConfigLocalService service) {
		MethodCache.remove(DmGtRouteConfigLocalService.class);
	...
	private static DmGtRouteConfigLocalService _service;
}