...
public class TT14XuLyNghiepVuUtils {
	...
	public static int doActionHoSo(long documentName, int documentYear, int actionType, int orginStatus,
		...
		try {
			...
			if (desStatus == ChuyenDichTrangThaiUtils.KE_HOACH_DA_TIEP_NHAN) {
				...
				TT14TichHopMessageUtils.message_99_21(user.getEmailAddress(), uploadPortletRequest, actionRequest,
				...
				boolean resultMethod = TT14TichHopMessageUtils.message_99_22(user.getEmailAddress(),
				...
				if (desStatus == TrangThaiBanKhaiNhapCanh.CHO_TIEP_NHAN
					...
					boolean resultMethod = TT14TichHopMessageUtils.message_99_27(user.getEmailAddress(),
							uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT14TichHopMessageUtils.message_99_28(user.getEmailAddress(),
						uploadPortletRequest, actionRequest, documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT14TichHopMessageUtils.message_99_24(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				// Tich hop send message 99-22
				boolean resultMethod = TT14TichHopMessageUtils.message_99_22(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				boolean resultMethod = TT14TichHopMessageUtils.message_99_25(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
				...
				TT14TichHopMessageUtils.message_99_23(user.getEmailAddress(), uploadPortletRequest, actionRequest,
						documentName, documentYear, yKienReject);
