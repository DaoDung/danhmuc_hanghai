...
/**
 * The base implementation of the dm history goods local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryGoodsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryGoodsLocalServiceBaseImpl
	implements DmHistoryGoodsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryGoods addDmHistoryGoods(DmHistoryGoods dmHistoryGoods)
		...
		dmHistoryGoods = dmHistoryGoodsPersistence.update(dmHistoryGoods, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryGoods);
			}
	...
	public DmHistoryGoods createDmHistoryGoods(int id) {
		return dmHistoryGoodsPersistence.create(id);
	}
	...
	public void deleteDmHistoryGoods(int id)
		...
		DmHistoryGoods dmHistoryGoods = dmHistoryGoodsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryGoods);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryGoodsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryGoodsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryGoods fetchDmHistoryGoods(int id) throws SystemException {
		return dmHistoryGoodsPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryGoods getDmHistoryGoods(int id)
		throws PortalException, SystemException {
		return dmHistoryGoodsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryGoodsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryGoods> getDmHistoryGoodses(int start, int end)
		throws SystemException {
		return dmHistoryGoodsPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryGoodsesCount() throws SystemException {
		return dmHistoryGoodsPersistence.countAll();
	}
	...
	public DmHistoryGoods updateDmHistoryGoods(DmHistoryGoods dmHistoryGoods,
		...
		dmHistoryGoods = dmHistoryGoodsPersistence.update(dmHistoryGoods, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryGoods",
			dmHistoryGoodsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryGoods");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryGoodsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryGoodsLocalServiceBaseImpl.class);
