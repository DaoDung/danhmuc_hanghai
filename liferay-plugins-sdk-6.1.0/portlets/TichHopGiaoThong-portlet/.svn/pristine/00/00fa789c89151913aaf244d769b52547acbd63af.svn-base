...
/**
 * The base implementation of the dm history ship agency local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryShipAgencyLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryShipAgencyLocalServiceBaseImpl
	implements DmHistoryShipAgencyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryShipAgency addDmHistoryShipAgency(
		...
		dmHistoryShipAgency = dmHistoryShipAgencyPersistence.update(dmHistoryShipAgency,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryShipAgency);
			}
	...
	public DmHistoryShipAgency createDmHistoryShipAgency(int id) {
		return dmHistoryShipAgencyPersistence.create(id);
	}
	...
	public void deleteDmHistoryShipAgency(int id)
		...
		DmHistoryShipAgency dmHistoryShipAgency = dmHistoryShipAgencyPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryShipAgency);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmHistoryShipAgencyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryShipAgencyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryShipAgency fetchDmHistoryShipAgency(int id)
		throws SystemException {
		return dmHistoryShipAgencyPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryShipAgency getDmHistoryShipAgency(int id)
		throws PortalException, SystemException {
		return dmHistoryShipAgencyPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryShipAgencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryShipAgency> getDmHistoryShipAgencies(int start, int end)
		throws SystemException {
		return dmHistoryShipAgencyPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryShipAgenciesCount() throws SystemException {
		return dmHistoryShipAgencyPersistence.countAll();
	}
	 ...
	 *
	 * @param dmHistoryShipAgency the dm history ship agency
	 * @param merge whether to merge the dm history ship agency with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm history ship agency that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmHistoryShipAgency updateDmHistoryShipAgency(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryShipAgency",
			dmHistoryShipAgencyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryShipAgency");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryShipAgencyPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryShipAgencyLocalServiceBaseImpl.class);
