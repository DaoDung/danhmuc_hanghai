...
/**
 * The base implementation of the result ministry remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultMinistryServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.result.service.impl.ResultMinistryServiceImpl
 * @see vn.gt.dao.result.service.ResultMinistryServiceUtil
 * @generated
 */
public abstract class ResultMinistryServiceBaseImpl extends PrincipalBean
	implements ResultMinistryService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.result.service.ResultMinistryServiceUtil} to access the result ministry remote service.
	 */
