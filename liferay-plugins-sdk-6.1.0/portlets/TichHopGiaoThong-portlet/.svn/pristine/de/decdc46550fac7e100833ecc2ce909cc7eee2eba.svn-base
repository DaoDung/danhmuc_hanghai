...
public class DmPortWharfLocalServiceWrapper implements DmPortWharfLocalService,
	...
	*/
	...
	public java.util.List<vn.gt.dao.danhmuc.model.DmPortWharf> findDanhSachDmPortWharf(
		...
		return _dmPortWharfLocalService.findDanhSachDmPortWharf(portRegionCode,
	...
	public int countDanhSachDmPortWharf(java.lang.String portRegionCode,
		...
		return _dmPortWharfLocalService.countDanhSachDmPortWharf(portRegionCode,
	...
	public java.util.List<vn.gt.dao.danhmuc.model.DmPortWharf> findDongBoDmPortWharf(
		...
		return _dmPortWharfLocalService.findDongBoDmPortWharf(MaritimeCode,
			portRegionCode, portHarbourCode, PortWharfNameVN, ascOrdesc, start,
			end);
	}
	...
	public int countDongBoDmPortWharf(java.lang.String MaritimeCode,
		...
		return _dmPortWharfLocalService.countDongBoDmPortWharf(MaritimeCode,
			portRegionCode, portHarbourCode, PortWharfNameVN);
	}

	public vn.gt.dao.danhmuc.model.DmPortWharf getFirstPortWharf() {
		return _dmPortWharfLocalService.getFirstPortWharf();
	}

	public vn.gt.dao.danhmuc.model.DmPortWharf getLastPortWharf() {
		return _dmPortWharfLocalService.getLastPortWharf();
	}
