...
/**
 * The interface for the issue port clearance local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see IssuePortClearanceLocalServiceUtil
...
public interface IssuePortClearanceLocalService
	extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IssuePortClearanceLocalServiceUtil} to access the issue port clearance local service. Add custom service methods to {@link vn.gt.dao.noticeandmessage.service.impl.IssuePortClearanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
