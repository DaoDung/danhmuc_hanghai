...
/**
 * The base implementation of the temp plant quarantine remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPlantQuarantineServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempPlantQuarantineServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempPlantQuarantineServiceUtil
 * @generated
 */
public abstract class TempPlantQuarantineServiceBaseImpl extends PrincipalBean
	implements TempPlantQuarantineService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempPlantQuarantineServiceUtil} to access the temp plant quarantine remote service.
	 */
