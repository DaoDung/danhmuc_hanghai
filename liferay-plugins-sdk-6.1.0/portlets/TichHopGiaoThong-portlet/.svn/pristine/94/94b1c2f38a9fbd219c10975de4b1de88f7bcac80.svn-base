 ...
 * 
 */
public class NoticeOfArrivalValidation {

	public boolean validation(NoticeOfArrival noticeOfArrival, Header header,
...
//			}
		...
		// PurposeCode
		if (Validator.isNotNull(noticeOfArrival.getPurposeCode())) {
			if (DmArrivalPurposeLocalServiceUtil
