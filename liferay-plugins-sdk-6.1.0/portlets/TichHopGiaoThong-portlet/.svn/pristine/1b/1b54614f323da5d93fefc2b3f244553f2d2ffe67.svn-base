 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.ModifyLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ModifyLocalServiceBaseImpl implements ModifyLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.ModifyLocalServiceUtil} to access the modify local service.
	 */
	...
	public Modify addModify(Modify modify) throws SystemException {
		...
		modify = modifyPersistence.update(modify, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(modify);
			}
	...
	public Modify createModify(long id) {
		return modifyPersistence.create(id);
	}
	...
	public void deleteModify(long id) throws PortalException, SystemException {
		Modify modify = modifyPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(modify);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteModify(Modify modify) throws SystemException {
		modifyPersistence.remove(modify);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return modifyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return modifyPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return modifyPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Modify fetchModify(long id) throws SystemException {
		return modifyPersistence.fetchByPrimaryKey(id);
	}
	...
	public Modify getModify(long id) throws PortalException, SystemException {
		return modifyPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return modifyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Modify> getModifies(int start, int end)
		throws SystemException {
		return modifyPersistence.findAll(start, end);
	}
	...
	public int getModifiesCount() throws SystemException {
		return modifyPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Modify updateModify(Modify modify, boolean merge)
		throws SystemException {
		modify.setNew(false);

		modify = modifyPersistence.update(modify, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.Modify",
			modifyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.Modify");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = modifyPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ModifyLocalServiceBaseImpl.class);
