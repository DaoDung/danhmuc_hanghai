...
public class DmRepresentativeWrapper implements DmRepresentative,
	...
	*/
	...
	/**
	* Returns the rep level of this dm representative.
	*
	* @return the rep level of this dm representative
	*/
	public int getRepLevel() {
		return _dmRepresentative.getRepLevel();
	}

	/**
	* Sets the rep level of this dm representative.
	*
	* @param repLevel the rep level of this dm representative
	*/
	public void setRepLevel(int repLevel) {
		_dmRepresentative.setRepLevel(repLevel);
	}
