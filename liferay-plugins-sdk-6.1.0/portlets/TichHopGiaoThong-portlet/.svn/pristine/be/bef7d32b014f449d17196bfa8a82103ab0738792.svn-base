...
/**
 * The base implementation of the rmdc ship remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.RmdcShipServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.RmdcShipServiceImpl
 * @see vn.gt.dao.danhmuc.service.RmdcShipServiceUtil
 * @generated
 */
public abstract class RmdcShipServiceBaseImpl extends PrincipalBean
	implements RmdcShipService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.RmdcShipServiceUtil} to access the rmdc ship remote service.
	 */
