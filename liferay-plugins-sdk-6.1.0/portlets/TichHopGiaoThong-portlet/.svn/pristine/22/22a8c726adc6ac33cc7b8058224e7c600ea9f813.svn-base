...
create index IX_A73D5A4 on TEMP_GENERAL_DECLARATION (DocumentName, DocumentYear);
create index IX_744CB77A on TEMP_GENERAL_DECLARATION (DocumentName, DocumentYear, RequestState);
create index IX_406CD5AE on TEMP_GENERAL_DECLARATION (RequestCode);

create index IX_AABCEE2C on TEMP_NOTICE_SHIP_MESSAGE (DocumentName, DocumentYear);
create index IX_A2C432CE on TEMP_NOTICE_SHIP_MESSAGE (DocumentName, DocumentYear, NoticeShipType);
create index IX_1A76BE26 on TEMP_NOTICE_SHIP_MESSAGE (RequestCode);

create index IX_AE3313BA on TEMP_WASTE_LIST (DocumentName, DocumentYear);
create index IX_70A1D8B2 on TEMP_WASTE_LIST (DocumentName, DocumentYear, RequestCode);
create index IX_CF7EE58 on TEMP_WASTE_LIST (RequestCode);
create index IX_BA6465F3 on TEMP_WASTE_LIST (RequestCode, TypeCode);
