...
/**
 * The base implementation of the temp cargo declaration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempCargoDeclarationLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempCargoDeclarationLocalServiceBaseImpl
	implements TempCargoDeclarationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempCargoDeclarationLocalServiceUtil} to access the temp cargo declaration local service.
	 */
	 ...
	 */
	public TempCargoDeclaration addTempCargoDeclaration(
		TempCargoDeclaration tempCargoDeclaration) throws SystemException {
		tempCargoDeclaration.setNew(true);

		tempCargoDeclaration = tempCargoDeclarationPersistence.update(tempCargoDeclaration,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempCargoDeclaration);
			}
	...
	public TempCargoDeclaration createTempCargoDeclaration(long id) {
		return tempCargoDeclarationPersistence.create(id);
	}
	...
	public void deleteTempCargoDeclaration(long id)
		...
		TempCargoDeclaration tempCargoDeclaration = tempCargoDeclarationPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempCargoDeclaration);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempCargoDeclaration(
		TempCargoDeclaration tempCargoDeclaration) throws SystemException {
		tempCargoDeclarationPersistence.remove(tempCargoDeclaration);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tempCargoDeclarationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempCargoDeclarationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempCargoDeclaration fetchTempCargoDeclaration(long id)
		throws SystemException {
		return tempCargoDeclarationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoDeclaration getTempCargoDeclaration(long id)
		throws PortalException, SystemException {
		return tempCargoDeclarationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempCargoDeclarationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempCargoDeclaration> getTempCargoDeclarations(int start,
		int end) throws SystemException {
		return tempCargoDeclarationPersistence.findAll(start, end);
	}
	...
	public int getTempCargoDeclarationsCount() throws SystemException {
		return tempCargoDeclarationPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoDeclaration updateTempCargoDeclaration(
		TempCargoDeclaration tempCargoDeclaration) throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempCargoDeclaration",
			tempCargoDeclarationLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempCargoDeclaration");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempCargoDeclarationPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempCargoDeclarationLocalServiceBaseImpl.class);
