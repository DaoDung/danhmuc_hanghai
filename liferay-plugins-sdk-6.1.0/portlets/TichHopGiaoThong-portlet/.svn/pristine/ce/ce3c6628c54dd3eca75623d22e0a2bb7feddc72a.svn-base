...
/**
 * The base implementation of the temp ship security port items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempShipSecurityPortItemsLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempShipSecurityPortItemsLocalServiceBaseImpl
	implements TempShipSecurityPortItemsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempShipSecurityPortItems addTempShipSecurityPortItems(
		...
		tempShipSecurityPortItems = tempShipSecurityPortItemsPersistence.update(tempShipSecurityPortItems,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempShipSecurityPortItems);
			}
	...
	public TempShipSecurityPortItems createTempShipSecurityPortItems(long id) {
		return tempShipSecurityPortItemsPersistence.create(id);
	}
	...
	public void deleteTempShipSecurityPortItems(long id)
		...
		TempShipSecurityPortItems tempShipSecurityPortItems = tempShipSecurityPortItemsPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempShipSecurityPortItems);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempShipSecurityPortItems(
		TempShipSecurityPortItems tempShipSecurityPortItems)
		throws SystemException {
		tempShipSecurityPortItemsPersistence.remove(tempShipSecurityPortItems);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipSecurityPortItemsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempShipSecurityPortItemsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempShipSecurityPortItems fetchTempShipSecurityPortItems(long id)
		throws SystemException {
		return tempShipSecurityPortItemsPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempShipSecurityPortItems getTempShipSecurityPortItems(long id)
		throws PortalException, SystemException {
		return tempShipSecurityPortItemsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempShipSecurityPortItemsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempShipSecurityPortItems> getTempShipSecurityPortItemses(
		...
		return tempShipSecurityPortItemsPersistence.findAll(start, end);
	}
	...
	public int getTempShipSecurityPortItemsesCount() throws SystemException {
		return tempShipSecurityPortItemsPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems",
			tempShipSecurityPortItemsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempShipSecurityPortItemsPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempShipSecurityPortItemsLocalServiceBaseImpl.class);
