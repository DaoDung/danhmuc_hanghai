...
public class TempDocumentModelImpl extends BaseModelImpl<TempDocument>
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
			...
			true);
	public static long CALLSIGN_COLUMN_BITMASK = 1L;
	...
	public static long REQUESTCODE_COLUMN_BITMASK = 32L;
	public static long REQUESTSTATE_COLUMN_BITMASK = 64L;
	public static long SHIPNAME_COLUMN_BITMASK = 128L;
	public static long SHIPTYPECODE_COLUMN_BITMASK = 256L;
	...
	public static TempDocument toModel(TempDocumentSoap soapModel) {
		...
		model.setUpgradeVersion(soapModel.getUpgradeVersion());
	...
	public void setShipName(String shipName) {
		_columnBitmask |= SHIPNAME_COLUMN_BITMASK;

		if (_originalShipName == null) {
			_originalShipName = _shipName;
		}

		_shipName = shipName;
	}

	public String getOriginalShipName() {
		return GetterUtil.getString(_originalShipName);
	}
	...
	public void setCallSign(String callSign) {
		_columnBitmask |= CALLSIGN_COLUMN_BITMASK;

		if (_originalCallSign == null) {
			_originalCallSign = _callSign;
		}
	...
	public String getOriginalCallSign() {
		return GetterUtil.getString(_originalCallSign);
	}
	...
	public Object clone() {
		...
		tempDocumentImpl.setUpgradeVersion(getUpgradeVersion());
		tempDocumentImpl.setNameOfShipownersAgents(getNameOfShipownersAgents());
	...
	public void resetOriginalValues() {
		...
		tempDocumentModelImpl._originalDocumentTypeCode = tempDocumentModelImpl._documentTypeCode;

		tempDocumentModelImpl._originalShipName = tempDocumentModelImpl._shipName;

		tempDocumentModelImpl._originalShipTypeCode = tempDocumentModelImpl._shipTypeCode;

		tempDocumentModelImpl._originalCallSign = tempDocumentModelImpl._callSign;

		tempDocumentModelImpl._originalMaritimeCode = tempDocumentModelImpl._maritimeCode;
	...
	public CacheModel<TempDocument> toCacheModel() {
		...
		tempDocumentCacheModel.upgradeVersion = getUpgradeVersion();

		tempDocumentCacheModel.nameOfShipownersAgents = getNameOfShipownersAgents();

		String nameOfShipownersAgents = tempDocumentCacheModel.nameOfShipownersAgents;

		if ((nameOfShipownersAgents != null) &&
				(nameOfShipownersAgents.length() == 0)) {
			tempDocumentCacheModel.nameOfShipownersAgents = null;
		}
	...
	private String _originalShipName;
	...
	private String _originalCallSign;
