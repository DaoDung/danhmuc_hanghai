...
/**
 * The base implementation of the temp no tice ship message remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempNoTiceShipMessageServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempNoTiceShipMessageServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempNoTiceShipMessageServiceUtil
 * @generated
 */
public abstract class TempNoTiceShipMessageServiceBaseImpl extends PrincipalBean
	implements TempNoTiceShipMessageService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempNoTiceShipMessageServiceUtil} to access the temp no tice ship message remote service.
	 */
