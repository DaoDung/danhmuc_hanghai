 ...
 * @author win_64
 */
public class DmPortWharfClp extends BaseModelImpl<DmPortWharf>
	implements DmPortWharf {
	public DmPortWharfClp() {
	}
	...
	public DmPortWharf toEscapedModel() {
		return (DmPortWharf)Proxy.newProxyInstance(DmPortWharf.class.getClassLoader(),
			new Class[] { DmPortWharf.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DmPortWharfClp clone = new DmPortWharfClp();
	...
	public boolean equals(Object obj) {
		...
		DmPortWharfClp dmPortWharf = null;

		try {
			dmPortWharf = (DmPortWharfClp)obj;
		}
