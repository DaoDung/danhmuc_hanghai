...
/**
 * The base implementation of the dm port local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPortLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPortLocalServiceBaseImpl implements DmPortLocalService,
	IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmPort addDmPort(DmPort dmPort) throws SystemException {
		...
		dmPort = dmPortPersistence.update(dmPort, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPort);
			}
	...
	public DmPort createDmPort(int id) {
		return dmPortPersistence.create(id);
	}
	...
	public void deleteDmPort(int id) throws PortalException, SystemException {
		DmPort dmPort = dmPortPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPort);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dmPortPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmPortPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPortPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPort fetchDmPort(int id) throws SystemException {
		return dmPortPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPort getDmPort(int id) throws PortalException, SystemException {
		return dmPortPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPortPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public int getDmPortsCount() throws SystemException {
		return dmPortPersistence.countAll();
	}
	...
	public DmPort updateDmPort(DmPort dmPort, boolean merge)
		...
		dmPort = dmPortPersistence.update(dmPort, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPort",
			dmPortLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPort");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPortPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPortLocalServiceBaseImpl.class);
