...
import vn.gt.dao.noticeandmessage.service.base.TempPersonListLocalServiceBaseImpl;
...
public class TempPersonListLocalServiceImpl
	extends TempPersonListLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public List<TempPersonList> findBydocumentNameAnddocumentYearAndRequestCode(int documentName, int documentYear, String requestCode) {
		try {
			return tempPersonListPersistence.findBydocumentNameAnddocumentYearAndRequestCode(documentName, documentYear, requestCode);
