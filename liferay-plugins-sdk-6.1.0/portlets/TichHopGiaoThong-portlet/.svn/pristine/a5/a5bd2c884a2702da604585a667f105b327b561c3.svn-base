...
public class DmHistoryPackageClp extends BaseModelImpl<DmHistoryPackage>
	...
	public DmHistoryPackage toEscapedModel() {
		return (DmHistoryPackage)Proxy.newProxyInstance(DmHistoryPackage.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmHistoryPackageClp dmHistoryPackage = null;

		try {
			dmHistoryPackage = (DmHistoryPackageClp)obj;
		}
