 ...
 *
 */
public class InlandPortClearanceValidation {

	public boolean validation(InlandPortClearance portClearance, Header header, String requestDirection) throws Exception {
