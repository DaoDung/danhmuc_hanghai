...
/**
 * The base implementation of the temp health question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempHealthQuestionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempHealthQuestionLocalServiceBaseImpl
	implements TempHealthQuestionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempHealthQuestion addTempHealthQuestion(
		...
		tempHealthQuestion = tempHealthQuestionPersistence.update(tempHealthQuestion,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempHealthQuestion);
			}
	...
	public TempHealthQuestion createTempHealthQuestion(long id) {
		return tempHealthQuestionPersistence.create(id);
	}
	...
	public void deleteTempHealthQuestion(long id)
		...
		TempHealthQuestion tempHealthQuestion = tempHealthQuestionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempHealthQuestion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempHealthQuestion(TempHealthQuestion tempHealthQuestion)
		...
		tempHealthQuestionPersistence.remove(tempHealthQuestion);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempHealthQuestionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempHealthQuestionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempHealthQuestion fetchTempHealthQuestion(long id)
		throws SystemException {
		return tempHealthQuestionPersistence.fetchByPrimaryKey(id);
	}
	...
	public TempHealthQuestion getTempHealthQuestion(long id)
		throws PortalException, SystemException {
		return tempHealthQuestionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempHealthQuestionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TempHealthQuestion> getTempHealthQuestions(int start, int end)
		throws SystemException {
		return tempHealthQuestionPersistence.findAll(start, end);
	}
	...
	public int getTempHealthQuestionsCount() throws SystemException {
		return tempHealthQuestionPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempHealthQuestion",
			tempHealthQuestionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.TempHealthQuestion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempHealthQuestionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempHealthQuestionLocalServiceBaseImpl.class);
