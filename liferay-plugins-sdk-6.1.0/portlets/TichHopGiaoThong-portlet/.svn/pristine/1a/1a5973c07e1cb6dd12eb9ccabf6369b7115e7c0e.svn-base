...
/**
 * The base implementation of the temp debit note remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.TempDebitNoteServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDebitNoteServiceBaseImpl extends PrincipalBean
	implements TempDebitNoteService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.result.service.TempDebitNoteServiceUtil} to access the temp debit note remote service.
	 */
