...
/**
 * The base implementation of the result ministry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.result.service.impl.ResultMinistryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class ResultMinistryLocalServiceBaseImpl
	implements ResultMinistryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public ResultMinistry addResultMinistry(ResultMinistry resultMinistry)
		...
		resultMinistry = resultMinistryPersistence.update(resultMinistry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(resultMinistry);
			}
	...
	public ResultMinistry createResultMinistry(long id) {
		return resultMinistryPersistence.create(id);
	}
	...
	public void deleteResultMinistry(long id)
		...
		ResultMinistry resultMinistry = resultMinistryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resultMinistry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultMinistryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resultMinistryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ResultMinistry fetchResultMinistry(long id)
		throws SystemException {
		return resultMinistryPersistence.fetchByPrimaryKey(id);
	}
	...
	public ResultMinistry getResultMinistry(long id)
		throws PortalException, SystemException {
		return resultMinistryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return resultMinistryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ResultMinistry> getResultMinistries(int start, int end)
		throws SystemException {
		return resultMinistryPersistence.findAll(start, end);
	}
	...
	public int getResultMinistriesCount() throws SystemException {
		return resultMinistryPersistence.countAll();
	}
	...
	public ResultMinistry updateResultMinistry(ResultMinistry resultMinistry,
		...
		resultMinistry = resultMinistryPersistence.update(resultMinistry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.result.model.ResultMinistry",
			resultMinistryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.result.model.ResultMinistry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = resultMinistryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ResultMinistryLocalServiceBaseImpl.class);
