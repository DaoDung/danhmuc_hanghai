 ...
 * @generated
 */
public class TempCargoItemsLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.TempCargoItems addTempCargoItems(
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.TempCargoItems createTempCargoItems(
		long id) {
	...
	*/
	...
	public static vn.gt.dao.noticeandmessage.model.TempCargoItems fetchTempCargoItems(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.TempCargoItems getTempCargoItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.noticeandmessage.model.TempCargoItems> getTempCargoItemses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.TempCargoItems updateTempCargoItems(
		vn.gt.dao.noticeandmessage.model.TempCargoItems tempCargoItems)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TempCargoItemsLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					TempCargoItemsLocalService.class.getName());
			...
			_service = new TempCargoItemsLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(TempCargoItemsLocalServiceUtil.class,
				"_service");
			MethodCache.remove(TempCargoItemsLocalService.class);
		}

		return _service;
	}

	public void setService(TempCargoItemsLocalService service) {
		MethodCache.remove(TempCargoItemsLocalService.class);
	...
	private static TempCargoItemsLocalService _service;
}