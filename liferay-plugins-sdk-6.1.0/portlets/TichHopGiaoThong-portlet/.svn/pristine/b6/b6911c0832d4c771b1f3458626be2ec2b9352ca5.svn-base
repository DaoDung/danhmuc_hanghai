...
/**
 * The base implementation of the dm history enterrise local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryEnterriseLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.DmHistoryEnterriseLocalServiceImpl
 * @see vn.gt.dao.danhmuc.service.DmHistoryEnterriseLocalServiceUtil
 * @generated
 */
public abstract class DmHistoryEnterriseLocalServiceBaseImpl
	implements DmHistoryEnterriseLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmHistoryEnterriseLocalServiceUtil} to access the dm history enterrise local service.
	 */
	 ...
	 */
	public DmHistoryEnterrise addDmHistoryEnterrise(
		DmHistoryEnterrise dmHistoryEnterrise) throws SystemException {
		dmHistoryEnterrise.setNew(true);

		dmHistoryEnterrise = dmHistoryEnterrisePersistence.update(dmHistoryEnterrise,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryEnterrise);
			}
	 ...
	 */
	public DmHistoryEnterrise createDmHistoryEnterrise(int id) {
		return dmHistoryEnterrisePersistence.create(id);
	}
	...
	public void deleteDmHistoryEnterrise(int id)
		...
		DmHistoryEnterrise dmHistoryEnterrise = dmHistoryEnterrisePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryEnterrise);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmHistoryEnterrise(DmHistoryEnterrise dmHistoryEnterrise)
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryEnterrisePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryEnterrisePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryEnterrise fetchDmHistoryEnterrise(int id)
		throws SystemException {
		return dmHistoryEnterrisePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmHistoryEnterrise getDmHistoryEnterrise(int id)
		throws PortalException, SystemException {
		return dmHistoryEnterrisePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryEnterrisePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DmHistoryEnterrise> getDmHistoryEnterrises(int start, int end)
		throws SystemException {
		return dmHistoryEnterrisePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDmHistoryEnterrisesCount() throws SystemException {
		return dmHistoryEnterrisePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmHistoryEnterrise updateDmHistoryEnterrise(
		DmHistoryEnterrise dmHistoryEnterrise) throws SystemException {
		return updateDmHistoryEnterrise(dmHistoryEnterrise, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryEnterrise",
			dmHistoryEnterriseLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryEnterrise");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryEnterrisePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryEnterriseLocalServiceBaseImpl.class);
