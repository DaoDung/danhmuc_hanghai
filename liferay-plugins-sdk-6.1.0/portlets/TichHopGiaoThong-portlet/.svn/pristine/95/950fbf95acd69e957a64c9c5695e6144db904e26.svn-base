...
public class IssuePermissionForTransitWrapper
	...
	*/
	...
	/**
	* Returns the cargo description of this issue permission for transit.
	*
	* @return the cargo description of this issue permission for transit
	*/
	public java.lang.String getCargoDescription() {
		return _issuePermissionForTransit.getCargoDescription();
	}

	/**
	* Sets the cargo description of this issue permission for transit.
	*
	* @param cargoDescription the cargo description of this issue permission for transit
	*/
	public void setCargoDescription(java.lang.String cargoDescription) {
		_issuePermissionForTransit.setCargoDescription(cargoDescription);
	}
