...
/**
 * The base implementation of the dm representative local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmRepresentativeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmRepresentativeLocalServiceBaseImpl
	implements DmRepresentativeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmRepresentative addDmRepresentative(
		...
		dmRepresentative = dmRepresentativePersistence.update(dmRepresentative,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmRepresentative);
			}
	...
	public DmRepresentative createDmRepresentative(int id) {
		return dmRepresentativePersistence.create(id);
	}
	...
	public void deleteDmRepresentative(int id)
		...
		DmRepresentative dmRepresentative = dmRepresentativePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmRepresentative);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmRepresentativePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmRepresentativePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmRepresentative fetchDmRepresentative(int id)
		throws SystemException {
		return dmRepresentativePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmRepresentative getDmRepresentative(int id)
		throws PortalException, SystemException {
		return dmRepresentativePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmRepresentativePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmRepresentative> getDmRepresentatives(int start, int end)
		throws SystemException {
		return dmRepresentativePersistence.findAll(start, end);
	}
	...
	public int getDmRepresentativesCount() throws SystemException {
		return dmRepresentativePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmRepresentative",
			dmRepresentativeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmRepresentative");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmRepresentativePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmRepresentativeLocalServiceBaseImpl.class);
