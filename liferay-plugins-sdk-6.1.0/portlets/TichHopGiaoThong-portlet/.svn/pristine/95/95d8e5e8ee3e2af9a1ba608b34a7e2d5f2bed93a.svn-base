 ...
 * @generated
 */
public class InterfaceRequestLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest addInterfaceRequest(
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest createInterfaceRequest(
		long id) {
	...
	*/
	...
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest fetchInterfaceRequest(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest getInterfaceRequest(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.noticeandmessage.model.InterfaceRequest> getInterfaceRequests(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest updateInterfaceRequest(
		vn.gt.dao.noticeandmessage.model.InterfaceRequest interfaceRequest)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.noticeandmessage.model.InterfaceRequest fetchByF_BY_documentNameRef(
	...
	public static InterfaceRequestLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					InterfaceRequestLocalService.class.getName());
			...
			_service = new InterfaceRequestLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(InterfaceRequestLocalServiceUtil.class,
				"_service");
			MethodCache.remove(InterfaceRequestLocalService.class);
		}

		return _service;
	}

	public void setService(InterfaceRequestLocalService service) {
		MethodCache.remove(InterfaceRequestLocalService.class);
	...
	private static InterfaceRequestLocalService _service;
}