...
public class DmHistoryDocTypeClp extends BaseModelImpl<DmHistoryDocType>
	...
	public DmHistoryDocType toEscapedModel() {
		return (DmHistoryDocType)Proxy.newProxyInstance(DmHistoryDocType.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmHistoryDocTypeClp dmHistoryDocType = null;

		try {
			dmHistoryDocType = (DmHistoryDocTypeClp)obj;
		}
