...
public class DmGtRouteConfigModelImpl extends BaseModelImpl<DmGtRouteConfig>
	...
	public static long LOCCODE_COLUMN_BITMASK = 2L;
	public static long ROUTECODE_COLUMN_BITMASK = 4L;
	...
	public void resetOriginalValues() {
		...
		dmGtRouteConfigModelImpl._originalLocCode = dmGtRouteConfigModelImpl._locCode;
