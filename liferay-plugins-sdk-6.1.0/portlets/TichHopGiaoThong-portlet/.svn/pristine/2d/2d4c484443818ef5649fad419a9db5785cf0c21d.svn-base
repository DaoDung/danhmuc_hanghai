...
/**
 * The base implementation of the dm security level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmSecurityLevelLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmSecurityLevelLocalServiceBaseImpl
	implements DmSecurityLevelLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmSecurityLevelLocalServiceUtil} to access the dm security level local service.
	 */
	 ...
	 */
	public DmSecurityLevel addDmSecurityLevel(DmSecurityLevel dmSecurityLevel)
		throws SystemException {
		dmSecurityLevel.setNew(true);

		dmSecurityLevel = dmSecurityLevelPersistence.update(dmSecurityLevel,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmSecurityLevel);
			}
	...
	public DmSecurityLevel createDmSecurityLevel(int id) {
		return dmSecurityLevelPersistence.create(id);
	}
	...
	public void deleteDmSecurityLevel(int id)
		...
		DmSecurityLevel dmSecurityLevel = dmSecurityLevelPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmSecurityLevel);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmSecurityLevel(DmSecurityLevel dmSecurityLevel)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmSecurityLevelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmSecurityLevelPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmSecurityLevel fetchDmSecurityLevel(int id)
		throws SystemException {
		return dmSecurityLevelPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmSecurityLevel getDmSecurityLevel(int id)
		throws PortalException, SystemException {
		return dmSecurityLevelPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmSecurityLevelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DmSecurityLevel> getDmSecurityLevels(int start, int end)
		throws SystemException {
		return dmSecurityLevelPersistence.findAll(start, end);
	}
	...
	public int getDmSecurityLevelsCount() throws SystemException {
		return dmSecurityLevelPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmSecurityLevel updateDmSecurityLevel(
		DmSecurityLevel dmSecurityLevel) throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmSecurityLevel",
			dmSecurityLevelLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmSecurityLevel");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmSecurityLevelPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmSecurityLevelLocalServiceBaseImpl.class);
