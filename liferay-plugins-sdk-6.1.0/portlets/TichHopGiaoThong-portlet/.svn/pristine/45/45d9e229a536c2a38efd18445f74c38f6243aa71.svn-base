...
public class InterfaceRequestWrapper implements InterfaceRequest,
	...
	*/
	...
	/**
	* Returns the document name ref of this interface request.
	*
	* @return the document name ref of this interface request
	*/
	public java.lang.String getDocumentNameRef() {
		return _interfaceRequest.getDocumentNameRef();
	}

	/**
	* Sets the document name ref of this interface request.
	*
	* @param documentNameRef the document name ref of this interface request
	*/
	public void setDocumentNameRef(java.lang.String documentNameRef) {
		_interfaceRequest.setDocumentNameRef(documentNameRef);
	}
