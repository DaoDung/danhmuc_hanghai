...
/**
 * The base implementation of the temp declaration for plant quarantine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempDeclarationForPlantQuarantineLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TempDeclarationForPlantQuarantineLocalServiceBaseImpl
	implements TempDeclarationForPlantQuarantineLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempDeclarationForPlantQuarantineLocalServiceUtil} to access the temp declaration for plant quarantine local service.
	 */
	 ...
	 */
	public TempDeclarationForPlantQuarantine addTempDeclarationForPlantQuarantine(
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine)
		throws SystemException {
		tempDeclarationForPlantQuarantine.setNew(true);

		tempDeclarationForPlantQuarantine = tempDeclarationForPlantQuarantinePersistence.update(tempDeclarationForPlantQuarantine,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(tempDeclarationForPlantQuarantine);
			}
	 ...
	 */
	public TempDeclarationForPlantQuarantine createTempDeclarationForPlantQuarantine(
		long id) {
		return tempDeclarationForPlantQuarantinePersistence.create(id);
	}
	...
	public void deleteTempDeclarationForPlantQuarantine(long id)
		...
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine = tempDeclarationForPlantQuarantinePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(tempDeclarationForPlantQuarantine);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public void deleteTempDeclarationForPlantQuarantine(
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine)
		throws SystemException {
		tempDeclarationForPlantQuarantinePersistence.remove(tempDeclarationForPlantQuarantine);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public TempDeclarationForPlantQuarantine fetchTempDeclarationForPlantQuarantine(
		long id) throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDeclarationForPlantQuarantine getTempDeclarationForPlantQuarantine(
		long id) throws PortalException, SystemException {
		return tempDeclarationForPlantQuarantinePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tempDeclarationForPlantQuarantinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<TempDeclarationForPlantQuarantine> getTempDeclarationForPlantQuarantines(
		int start, int end) throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.findAll(start, end);
	}
	...
	public int getTempDeclarationForPlantQuarantinesCount()
		throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempDeclarationForPlantQuarantine updateTempDeclarationForPlantQuarantine(
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine)
		throws SystemException {
		return updateTempDeclarationForPlantQuarantine(tempDeclarationForPlantQuarantine,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.TempDeclarationForPlantQuarantine",
			tempDeclarationForPlantQuarantineLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tempDeclarationForPlantQuarantinePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(TempDeclarationForPlantQuarantineLocalServiceBaseImpl.class);
