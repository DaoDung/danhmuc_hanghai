...
public class DmSecurityLevelClp extends BaseModelImpl<DmSecurityLevel>
	...
	public DmSecurityLevel toEscapedModel() {
		return (DmSecurityLevel)Proxy.newProxyInstance(DmSecurityLevel.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		DmSecurityLevelClp dmSecurityLevel = null;

		try {
			dmSecurityLevel = (DmSecurityLevelClp)obj;
		}
