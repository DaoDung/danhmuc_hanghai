...
/**
 * The base implementation of the dm passport type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmPassportTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmPassportTypeLocalServiceBaseImpl
	implements DmPassportTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmPassportType addDmPassportType(DmPassportType dmPassportType)
		...
		dmPassportType = dmPassportTypePersistence.update(dmPassportType, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmPassportType);
			}
	...
	public DmPassportType createDmPassportType(int id) {
		return dmPassportTypePersistence.create(id);
	}
	...
	public void deleteDmPassportType(int id)
		...
		DmPassportType dmPassportType = dmPassportTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmPassportType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPassportTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmPassportTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmPassportType fetchDmPassportType(int id) throws SystemException {
		return dmPassportTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmPassportType getDmPassportType(int id)
		throws PortalException, SystemException {
		return dmPassportTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmPassportTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmPassportType> getDmPassportTypes(int start, int end)
		throws SystemException {
		return dmPassportTypePersistence.findAll(start, end);
	}
	...
	public int getDmPassportTypesCount() throws SystemException {
		return dmPassportTypePersistence.countAll();
	}
	...
	public DmPassportType updateDmPassportType(DmPassportType dmPassportType,
		...
		dmPassportType = dmPassportTypePersistence.update(dmPassportType, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmPassportType",
			dmPassportTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmPassportType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmPassportTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmPassportTypeLocalServiceBaseImpl.class);
