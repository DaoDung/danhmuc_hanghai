...
/**
 * The base implementation of the dm history arrival purpose local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmHistoryArrivalPurposeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryArrivalPurposeLocalServiceBaseImpl
	implements DmHistoryArrivalPurposeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryArrivalPurpose addDmHistoryArrivalPurpose(
		...
		dmHistoryArrivalPurpose = dmHistoryArrivalPurposePersistence.update(dmHistoryArrivalPurpose,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryArrivalPurpose);
			}
	...
	public DmHistoryArrivalPurpose createDmHistoryArrivalPurpose(int id) {
		return dmHistoryArrivalPurposePersistence.create(id);
	}
	...
	public void deleteDmHistoryArrivalPurpose(int id)
		...
		DmHistoryArrivalPurpose dmHistoryArrivalPurpose = dmHistoryArrivalPurposePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryArrivalPurpose);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryArrivalPurposePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryArrivalPurposePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryArrivalPurpose fetchDmHistoryArrivalPurpose(int id)
		throws SystemException {
		return dmHistoryArrivalPurposePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryArrivalPurpose getDmHistoryArrivalPurpose(int id)
		throws PortalException, SystemException {
		return dmHistoryArrivalPurposePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryArrivalPurposePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryArrivalPurpose> getDmHistoryArrivalPurposes(
		...
		return dmHistoryArrivalPurposePersistence.findAll(start, end);
	}
	...
	public int getDmHistoryArrivalPurposesCount() throws SystemException {
		return dmHistoryArrivalPurposePersistence.countAll();
	}
	 ...
	 *
	 * @param dmHistoryArrivalPurpose the dm history arrival purpose
	 * @param merge whether to merge the dm history arrival purpose with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the dm history arrival purpose that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public DmHistoryArrivalPurpose updateDmHistoryArrivalPurpose(
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose",
			dmHistoryArrivalPurposeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryArrivalPurposePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryArrivalPurposeLocalServiceBaseImpl.class);
