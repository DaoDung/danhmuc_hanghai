...
/**
 * The base implementation of the dm enterrise local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmuc.service.impl.DmEnterriseLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.danhmuc.service.impl.DmEnterriseLocalServiceImpl
 * @see vn.gt.dao.danhmuc.service.DmEnterriseLocalServiceUtil
 * @generated
 */
public abstract class DmEnterriseLocalServiceBaseImpl
	implements DmEnterriseLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmuc.service.DmEnterriseLocalServiceUtil} to access the dm enterrise local service.
	 */
	 ...
	 */
	public DmEnterrise addDmEnterrise(DmEnterrise dmEnterrise)
		throws SystemException {
		dmEnterrise.setNew(true);

		dmEnterrise = dmEnterrisePersistence.update(dmEnterrise, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmEnterrise);
			}
	 ...
	 */
	public DmEnterrise createDmEnterrise(int id) {
		return dmEnterrisePersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmEnterrise(int id)
		throws PortalException, SystemException {
		DmEnterrise dmEnterrise = dmEnterrisePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmEnterrise);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDmEnterrise(DmEnterrise dmEnterrise)
		throws SystemException {
		dmEnterrisePersistence.remove(dmEnterrise);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmEnterrisePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmEnterrisePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmEnterrisePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmEnterrise fetchDmEnterrise(int id) throws SystemException {
		return dmEnterrisePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmEnterrise getDmEnterrise(int id)
		throws PortalException, SystemException {
		return dmEnterrisePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmEnterrisePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DmEnterrise> getDmEnterrises(int start, int end)
		throws SystemException {
		return dmEnterrisePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDmEnterrisesCount() throws SystemException {
		return dmEnterrisePersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmEnterrise updateDmEnterrise(DmEnterrise dmEnterrise)
		throws SystemException {
		return updateDmEnterrise(dmEnterrise, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DmEnterrise updateDmEnterrise(DmEnterrise dmEnterrise, boolean merge)
		throws SystemException {
		dmEnterrise.setNew(false);

		dmEnterrise = dmEnterrisePersistence.update(dmEnterrise, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmuc.model.DmEnterrise",
			dmEnterriseLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmuc.model.DmEnterrise");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmEnterrisePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmEnterriseLocalServiceBaseImpl.class);
