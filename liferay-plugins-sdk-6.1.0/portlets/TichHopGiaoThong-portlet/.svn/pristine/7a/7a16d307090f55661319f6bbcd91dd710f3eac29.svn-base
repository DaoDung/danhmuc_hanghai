...
public class ResultHistoryMinistryClp extends BaseModelImpl<ResultHistoryMinistry>
	...
	public ResultHistoryMinistry toEscapedModel() {
		return (ResultHistoryMinistry)Proxy.newProxyInstance(ResultHistoryMinistry.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		ResultHistoryMinistryClp resultHistoryMinistry = null;

		try {
			resultHistoryMinistry = (ResultHistoryMinistryClp)obj;
		}
