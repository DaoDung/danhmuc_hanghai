...
/**
 * The interface for the issue shifting order local service.
 *
 * <p>
 ...
 *
 * @author win_64
 * @see IssueShiftingOrderLocalServiceUtil
...
public interface IssueShiftingOrderLocalService
	extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IssueShiftingOrderLocalServiceUtil} to access the issue shifting order local service. Add custom service methods to {@link vn.gt.dao.noticeandmessage.service.impl.IssueShiftingOrderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
