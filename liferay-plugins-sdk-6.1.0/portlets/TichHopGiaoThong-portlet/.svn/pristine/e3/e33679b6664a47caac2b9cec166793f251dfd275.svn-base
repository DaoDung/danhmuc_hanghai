 ...
 * 
 */
public class GeneralDeclarationValidation {

	public boolean validation(GeneralDeclaration generalDeclaration,
...
//			}
		...
		if (generalDeclaration.getGrossTonnage() == null) {
			...
			logMessageValidation.setDataValidation("N50128: " + ConfigurationManager.getStrProp("vn.gt.logMessageValidation.N001", ""));
			ValidationUtils.addLogMessageValidation(logMessageValidation);
			
		} else if (!ActionUtils.checkIfIsDouble(generalDeclaration.getGrossTonnage())) {
			status = false;
			logMessageValidation.setTagProperty("GrossTonnage");
			logMessageValidation.setDataValidation("N50328: " + ConfigurationManager.getStrProp("vn.gt.logMessageValidation.N003", ""));
			ValidationUtils.addLogMessageValidation(logMessageValidation);
			
		} else if (!ActionUtils.checkFormatDouble(generalDeclaration.getGrossTonnage(), 6, 2)) {
			status = false;
			logMessageValidation.setTagProperty("GrossTonnage");
			logMessageValidation.setDataValidation("N50428: " + ConfigurationManager.getStrProp("vn.gt.logMessageValidation.N004", ""));
			ValidationUtils.addLogMessageValidation(logMessageValidation);
		}
		...
		if (generalDeclaration.getGrossTonnageUnit() != null && generalDeclaration.getGrossTonnageUnit().length() > 0) {
			if (generalDeclaration.getGrossTonnageUnit().length() > 4) {
				...
				logMessageValidation.setDataValidation("N50529: " + ConfigurationManager.getStrProp("vn.gt.logMessageValidation.N005", ""));
				ValidationUtils.addLogMessageValidation(logMessageValidation);
				
			} else if (!ActionUtils.checkIfIsAValidSpecialCharacters(generalDeclaration.getGrossTonnageUnit())) {
				status = false;
				logMessageValidation.setTagProperty("GrossTonnageUnit");
				logMessageValidation.setDataValidation("N50629: " + ConfigurationManager.getStrProp("vn.gt.logMessageValidation.N006", ""));
				ValidationUtils.addLogMessageValidation(logMessageValidation);
			}
		}
		...
		if (generalDeclaration.getBriefDescriptionOfTheCargo() != null
				&& generalDeclaration.getBriefDescriptionOfTheCargo().length() > 0) {
			if (generalDeclaration.getBriefDescriptionOfTheCargo().length() > 500) {
				status = false;
	...
	private void insertShipAgency(GeneralDeclaration generalDeclaration)
