...
public class ViewHoanThanhThuTucFinderImpl extends BasePersistenceImpl<ViewHoanThanhThuTuc> implements ViewHoanThanhThuTucFinder {
	
	private Log log = LogFactoryUtil.getLog(ViewHoanThanhThuTucFinderImpl.class);
	...
	public List<ViewHoanThanhThuTuc> findByKetQuaHoanThanhThuTuc(String maritimeCode, String dateFrom, String dateTo) {
		...
		try {
			...
			q.addEntity("ViewHoanThanhThuTuc", ViewHoanThanhThuTucImpl.class);
			QueryPos qPos = QueryPos.getInstance(q);

			
			// execute the query and return a list from the db
			return (List<ViewHoanThanhThuTuc>) QueryUtil.list(q, getDialect(), QueryUtil.ALL_POS, QueryUtil.ALL_POS);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
