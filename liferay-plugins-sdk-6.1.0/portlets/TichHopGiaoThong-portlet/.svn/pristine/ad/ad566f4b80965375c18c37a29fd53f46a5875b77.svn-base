...
<%
	...
	int k = 0;//so giay toi xuat trinh
	int docCount = 0;
			...
			<table class="wd-table">
				<thead>
					<tr>
						...
						<th class="text-left"><liferay-ui:message key="vn.dtt.thutuc.tenthuyenvien" /></th>
				                	 ...
				                	 for (int j=0; j < resultCertificates.size(); j++) {
				        				...
				        				<tr>
													...
													<td class="text-left" width="70px">
														<input type="text" class="egov-inputfield" style="width: 98%" name="comment_<%=k %>"
															value=<%=resultCertificate.getComment()%>>
													</td>
													<td class="text-left" width="70px">
				                		...
				                		<% if(resultCertificate.getCertificateCode().equalsIgnoreCase(dmCertificate1.getCertificateCode()) && rcCode >= 59 && rcCode <= 62){
				                	 		 isExist = true;
				                	 		 k++;
				                	 ...
				                	 if(tempDocument.getDocumentTypeCode().equals("4") || tempDocument.getDocumentTypeCode().equals("5")) { %>
			            				...
			            				%> 
											...
											<tr>
												...
												<td class="text-left" width="70px">
													<input type="text" class="egov-inputfield" style="width: 98%" name="comment_<%=k %>"></td>
												<td class="text-left" width="70px">
				                	 ...
				                	 for (int i=0; i < resultCertificates.size(); i++) {
				                		 ...
				                		 <%  if(resultCertificate.getCertificateCode().equalsIgnoreCase(dmCertificate1.getCertificateCode()) && rcCode >= 37 && rcCode <= 53){	
											...
											<tr>
												...
												<td class="text-left" width="70px"><%=resultCertificate.getComment()%></td>
