...
/**
 * The base implementation of the temp passenger list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.TempPassengerListServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.gt.dao.noticeandmessage.service.impl.TempPassengerListServiceImpl
 * @see vn.gt.dao.noticeandmessage.service.TempPassengerListServiceUtil
 * @generated
 */
public abstract class TempPassengerListServiceBaseImpl extends PrincipalBean
	implements TempPassengerListService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.TempPassengerListServiceUtil} to access the temp passenger list remote service.
	 */
