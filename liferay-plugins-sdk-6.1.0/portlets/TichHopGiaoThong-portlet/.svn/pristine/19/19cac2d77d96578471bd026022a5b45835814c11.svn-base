...
/**
 * The base implementation of the issue shifting order local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.noticeandmessage.service.impl.IssueShiftingOrderLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class IssueShiftingOrderLocalServiceBaseImpl
	implements IssueShiftingOrderLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.noticeandmessage.service.IssueShiftingOrderLocalServiceUtil} to access the issue shifting order local service.
	 */
	 ...
	 */
	public IssueShiftingOrder addIssueShiftingOrder(
		IssueShiftingOrder issueShiftingOrder) throws SystemException {
		issueShiftingOrder.setNew(true);

		issueShiftingOrder = issueShiftingOrderPersistence.update(issueShiftingOrder,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(issueShiftingOrder);
			}
	...
	public IssueShiftingOrder createIssueShiftingOrder(long id) {
		return issueShiftingOrderPersistence.create(id);
	}
	...
	public void deleteIssueShiftingOrder(long id)
		...
		IssueShiftingOrder issueShiftingOrder = issueShiftingOrderPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(issueShiftingOrder);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteIssueShiftingOrder(IssueShiftingOrder issueShiftingOrder)
		throws SystemException {
		issueShiftingOrderPersistence.remove(issueShiftingOrder);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueShiftingOrderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return issueShiftingOrderPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public IssueShiftingOrder fetchIssueShiftingOrder(long id)
		throws SystemException {
		return issueShiftingOrderPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueShiftingOrder getIssueShiftingOrder(long id)
		throws PortalException, SystemException {
		return issueShiftingOrderPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return issueShiftingOrderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<IssueShiftingOrder> getIssueShiftingOrders(int start, int end)
		throws SystemException {
		return issueShiftingOrderPersistence.findAll(start, end);
	}
	...
	public int getIssueShiftingOrdersCount() throws SystemException {
		return issueShiftingOrderPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public IssueShiftingOrder updateIssueShiftingOrder(
		IssueShiftingOrder issueShiftingOrder) throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.noticeandmessage.model.IssueShiftingOrder",
			issueShiftingOrderLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.noticeandmessage.model.IssueShiftingOrder");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = issueShiftingOrderPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(IssueShiftingOrderLocalServiceBaseImpl.class);
