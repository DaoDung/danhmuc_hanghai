...
import vn.gt.dao.danhmuc.model.impl.DmHistoryGoodsTypeImpl;
import vn.gt.dao.danhmuc.model.impl.DmHistoryGoodsTypeModelImpl;
...
public class DmHistoryGoodsTypePersistenceImpl extends BasePersistenceImpl<DmHistoryGoodsType>
	 ...
	 * @throws com.liferay.portal.NoSuchModelException if a dm history goods type with the primary key could not be found
	...
	public DmHistoryGoodsType remove(int id)
		...
		try {
			...
			return dmHistoryGoodsTypePersistence.remove(dmHistoryGoodsType);
		}
	...
	/**
	 * Removes the dm history goods type from the database. Also notifies the appropriate model listeners.
	 *
	 * @param dmHistoryGoodsType the dm history goods type
	 * @return the dm history goods type that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public DmHistoryGoodsType remove(DmHistoryGoodsType dmHistoryGoodsType)
		throws SystemException {
		return super.remove(dmHistoryGoodsType);
	}
	...
	protected DmHistoryGoodsType removeImpl(
		...
		try {
			...
			BatchSessionUtil.delete(session, dmHistoryGoodsType);
		}
		catch (Exception e) {
			throw processException(e);
		}
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_GOODSTYPECODEANDSYNCVERSION,
			...
			dmHistoryGoodsTypeModelImpl.getSyncVersion()
			});
	...
	public DmHistoryGoodsType updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, dmHistoryGoodsType, merge);
	...
	public DmHistoryGoodsType fetchByPrimaryKey(int id)
		...
		DmHistoryGoodsType dmHistoryGoodsType = (DmHistoryGoodsType)EntityCacheUtil.getResult(DmHistoryGoodsTypeModelImpl.ENTITY_CACHE_ENABLED,
				DmHistoryGoodsTypeImpl.class, id);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByGoodsTypeCodeAndSyncVersion(String goodsTypeCode,
		String syncVersion)
		throws NoSuchDmHistoryGoodsTypeException, SystemException {
	...
	public int countByGoodsTypeCodeAndSyncVersion(String goodsTypeCode,
		...
		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_GOODSTYPECODEANDSYNCVERSION,
				finderArgs, this);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.gt.dao.danhmuc.model.DmHistoryGoodsType")));
