 ...
 * @author win_64
 */
public class DmPortClp extends BaseModelImpl<DmPort> implements DmPort {
	public DmPortClp() {
	}
	...
	public DmPort toEscapedModel() {
		return (DmPort)Proxy.newProxyInstance(DmPort.class.getClassLoader(),
			new Class[] { DmPort.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		DmPortClp clone = new DmPortClp();
	...
	public boolean equals(Object obj) {
		...
		DmPortClp dmPort = null;

		try {
			dmPort = (DmPortClp)obj;
		}
