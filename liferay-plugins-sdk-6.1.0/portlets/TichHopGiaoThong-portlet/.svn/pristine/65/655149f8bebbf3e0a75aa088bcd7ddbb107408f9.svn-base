...
public class IssuePortClearanceClp extends BaseModelImpl<IssuePortClearance>
	...
	public Object clone() {
		...
		clone.setNextProvinceCode(getNextProvinceCode());
		clone.setNextPortOfCallCode(getNextPortOfCallCode());
		clone.setMaritimePortCode(getMaritimePortCode());
		...
		clone.setGt(getGt());
		clone.setDwt(getDwt());
		clone.setNextMaritimePortCode(getNextMaritimePortCode());
		clone.setNextPortRegionCode(getNextPortRegionCode());
		clone.setNextPortHarbourCode(getNextPortHarbourCode());
		clone.setNextPortWharfCode(getNextPortWharfCode());
