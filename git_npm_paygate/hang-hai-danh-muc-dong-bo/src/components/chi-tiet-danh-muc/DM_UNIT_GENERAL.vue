      ...
      <v-layout row wrap>
        <v-flex xs12>
          <div class="title-chitiet">
            <strong class="title-chitiet-danh-muc">Thông tin Đơn vị tính</strong>
          </div>
        </v-flex>
        <v-flex xs12>
          <form class="form-chi-tiet-danh-muc">
            <v-flex xs12>
              <v-layout align-center>
                ...
                <v-flex xs12 md3>
                  <v-text-field
                    v-model="categoryModel.unitCode"
            ...
            <v-flex xs12>
              <v-layout align-center>
                ...
                <v-flex xs12 md8>
                  <v-text-field
                    v-model="categoryModel.unitName"
                    :readonly="this.$route.query.aticon === 'chi-tiet-danh-muc'"
                    height="25"
                  ></v-text-field>
                </v-flex>
    ...
    getDetailCategory() {
      ...
      if (this.$route.query.aticon !== "them-danh-muc") {
        ...
        this.$store.dispatch("category/getDetailCategory", params).then(
          res => {
            vm.categoryModel.unitCode = res.unitCode;
            vm.categoryModel.unitName = res.unitName;
        ...
        vm.categoryModel.unitCode = "";
        vm.categoryModel.unitName = "";
        vm.categoryModel.id = "";
        let date = new Date();
        vm.categoryModel.modifiedDate =
          date.getDate() +
