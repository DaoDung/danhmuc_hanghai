        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <!-- <v-flex xs3>
              <v-layout align-center>
                <v-flex xs5>
                  <label>chủ hàng/ cá nhân khác(MST):</label>
                </v-flex>
                <v-flex xs7>
                  <v-text-field
            ...
            <v-flex xs4>
              <v-layout align-center>
                <v-flex xs6>
                  <label>Chủ hàng/cá nhân khác:</label>
                </v-flex>
                <v-flex xs7>
                <v-text-field
  ...
  data () {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: 'Mã chủ hàng/ cá nhân khác',
          value: 'name',
          align: 'center'
        },
        {
          sortable: false,
          text: 'Tên chủ hàng / cá nhân khác' ,
          value: 'city',
          align: 'center'
        },
        {
