          ...
          <v-layout row wrap>
            <v-flex xs3>
              <v-layout align-center>
                ...
                <v-flex xs7>
                  <v-text-field v-model="passportTypeNameVN" height="15" @change="search"></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.passportType }}</td>
                <td class="text-xs-center">{{ props.item.passportTypeNameVN }}</td>
  ...
  computed: {
    ...
    link () {
      ...
      let params = {
        ...
        passportTypeNameVN: this.passportTypeNameVN
      };
