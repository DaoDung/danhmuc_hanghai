          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.rankCode }}</td>
                <td class="text-xs-center">{{ props.item.rankNameVN}}</td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: "Mã chức danh thuyền viên",
          align: "center"
        },
        {
          sortable: false,
          text: "Tên chức danh thuyền viên",
          align: "center"
        },
        {
          sortable: false,
          text: "Tên chức danh thuyền viên( Tiếng Anh)",
          align: "center"
        },
        {
          sortable: false,
