          ...
          <v-layout row wrap>
            <v-flex xs3>
              <v-layout align-center>
                ...
                <v-flex xs8>
                  <v-text-field v-model="repNameVN" height="15" @change="search"></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.repCode }}</td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: "Mã đại diện cảng vụ",
          align: "center"
        },
        {
          sortable: false,
          text: "Tên đại diện cảng vụ",
          align: "center"
        },
        {
          sortable: false,
