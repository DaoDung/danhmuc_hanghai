          ...
          <v-layout row wrap>
            <v-flex xs3>
              <v-layout align-center>
                ...
                <v-flex xs7>
                  <v-text-field v-model="goodsItemName" height="15"  @change="search"></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.goodsItemCode }}</td>
                <td class="text-xs-center">{{ props.item.goodsItemName }}</td>
