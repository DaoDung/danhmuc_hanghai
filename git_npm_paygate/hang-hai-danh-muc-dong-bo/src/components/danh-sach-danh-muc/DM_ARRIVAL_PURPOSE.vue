          ...
          <v-layout row wrap>
            <v-flex xs3>
              <v-layout align-center>
                <v-flex xs5>
                  <label>Mục đích đến cảng:</label>
                </v-flex>
                <v-flex xs7>
                  <v-text-field v-model="purposeName" height="15" @change="search"></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.purposeCode }}</td>
                <td class="text-xs-center">{{ props.item.purposeName }}</td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: "Mã mục đích đến cảng",
          align: "center"
        },
        {
          sortable: false,
          text: "Mục đích đến cảng",
          align: "center"
        },
        {
          sortable: false,
