        ...
        <v-container fluid grid-list-md>
          <v-layout row wrap>
            ...
            <!-- <v-flex xs3>
              <v-layout align-center>
                <v-flex xs5>
                  <label>Mã công ty hao tiêu:</label>
                </v-flex>
                <v-flex xs7>
                <v-text-field
...
export default {
  ...
  methods: {
    editCategory (item) {
      ...
      this.$router.push({name: 'chi_tiet_danh_muc', query: {categoryId: this.$route.query.categoryId, aticon: 'sua-danh-muc', id: item.pilotCompanyCode}})
    },
    delCategory (item) {
      this.$store.dispatch('category/setCategoryModel', item)
      this.$router.push({name: 'chi_tiet_danh_muc', query: {categoryId: this.$route.query.categoryId, aticon: 'xoa-danh-muc', id: item.pilotCompanyCode}})
    },
    addCategory () {
    ...
    infoCategory (item) {
      this.$router.push({name: 'chi_tiet_danh_muc', query: {categoryId: this.$route.query.categoryId, aticon: 'chi-tiet-danh-muc', id: item.pilotCompanyCode}})
    },
    reportExel () {
      let params = {
