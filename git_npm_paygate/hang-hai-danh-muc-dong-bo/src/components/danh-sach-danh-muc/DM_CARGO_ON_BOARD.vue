          ...
          <v-layout row wrap>
            <v-flex xs4>
              <v-layout align-center>
                <v-flex xs5>
                  <label>Tên hàng hóa xếp dỡ:</label>
                </v-flex>
                <v-flex xs7>
                  <v-text-field v-model="goodsTypeNameVN" height="15" @change="search"  ></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
          ...
          >
            <template slot="items" slot-scope="props">
              <tr>
                ...
                <td class="text-xs-center">{{ props.item.goodsTypeCode }}</td>
                <td class="text-xs-center">{{ props.item.goodsTypeNameVN }}</td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: "Mã hàng hóa xếp dỡ",
          align: "center"
        },
        {
          sortable: false,
          text: "Tên hàng hóa xếp dỡ",
          align: "center"
        },
        {
          sortable: false,
  ...
  computed: {
    ...
    link () {
      ...
      let params = {
        ...
        goodsTypeNameVN: this.goodsTypeNameVN
      };
