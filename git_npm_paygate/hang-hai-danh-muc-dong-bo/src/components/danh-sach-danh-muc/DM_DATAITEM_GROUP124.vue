          ...
          <v-layout row wrap>
            <v-flex xs4>
              <v-layout align-center>
                <v-flex xs5>
                  <label>Tên hàng hóa vận chuyển:</label>
                </v-flex>
                <v-flex xs7>
                  <v-text-field v-model="name" height="15" @change="search"  ></v-text-field>
                </v-flex>
              </v-layout>
            </v-flex>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          sortable: false,
          text: "Mã hàng hóa vận chuyển",
          align: "center"
        },
        {
          sortable: false,
          text: "Tên hàng hóa vận chuyển",
          align: "center"
        },
        {
          sortable: false,
