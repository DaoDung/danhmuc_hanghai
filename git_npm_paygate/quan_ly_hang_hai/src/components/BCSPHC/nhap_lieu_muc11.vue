...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: 'Vi phạm quy định về hoạt động ứng phó sự cố tràn dầu, quản lý tiếp nhận và xử lý chất thải lỏng có dầu từ tàu biển tại cảng biển',
        value: 'calories',
        align: 'center',
        sortable: true,
        width: '50%'
