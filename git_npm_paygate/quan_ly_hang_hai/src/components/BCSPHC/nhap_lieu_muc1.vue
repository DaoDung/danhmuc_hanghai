  ...
  <div >
    ...
    >
      ...
      <template v-slot:body="{ items }">
        <tbody v-if="isHide">
          <tr v-for="item in muc1" :key="item.id">
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: 'Vi phạm quy định về xây dựng, quản lý và khai thác kết cấu hạ tầng hàng hải',
        value: 'calories',
        align: 'center',
        sortable: true,
        width: '50%'
...
<style>
.btn-hanhchinh{
  text-transform: none; font-weight: 700!important;width: 75px; font-size: 7px!important;
}
.hide-hanhchinh{
  font-size: 13px;
  color: blue;
