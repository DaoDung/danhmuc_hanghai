<template>
    <div class="input-group px-0 py-0 mx-0 my-0 date" style="border-bottom: 1px solid #949494;">
        <masked-input class="px-0 py-0 mx-0 my-0" v-model="value" mask="11/11/1111 11:11" @input="selectStringToDate(value)" />
