          ...
          <thead>
            <tr>
              ...
              <td class="text-xs-left font-weight-regular" style="width:60%;">
               Vi phạm quy định về đăng ký tàu thuyền và bố trí thuyền viên; sử dụng chứng chỉ chuyên môn, sổ thuyền viên
              </td>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {
        text: 'Vi phạm quy định về đăng ký tàu thuyền và bố trí thuyền viên; sử dụng chứng chỉ chuyên môn, sổ thuyền viên',
        value: 'calories',
        align: 'center',
        sortable: false
      }
