          ...
          <thead>
            <tr>
              ...
              <td class="text-xs-left font-weight-regular" style="width:60%;">
                Vi phạm quy định về hoạt động kinh doanh vận tải biển, vận tải đa phương thức, dịch vụ hỗ trợ vận tải biển và cung cấp dịch vụ bảo đảm an toàn hàng hải
              </td>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: 'Vi phạm quy định về hoạt động kinh doanh vận tải biển, vận tải đa phương thức, dịch vụ hỗ trợ vận tải biển và cung cấp dịch vụ bảo đảm an toàn hàng hải',
        value: 'calories',
        align: 'center',
        sortable: true,
        width: '50%'
